...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    /// </summary>
    public class InvoiceExportPdfContentApiObject : BunqModel
    {
        /// <summary>
        /// Endpoint constants.
        /// </summary>
        ...
        /// <summary>
        /// </summary>
        public static BunqResponse<byte[]> List(long invoiceId, IDictionary<string, string> customHeaders = null)
        {
        ...
        /// <summary>
        /// </summary>
        public static InvoiceExportPdfContentApiObject CreateFromJsonString(string json)
        {
            return BunqModel.CreateFromJsonString<InvoiceExportPdfContentApiObject>(json);
        }
    }
}
