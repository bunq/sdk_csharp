...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    {FIELD_DETAIL, detail},
        ...
        /// <summary>
        /// </summary>
        public static BunqResponse<List<TransferwiseAccountRequirement>> List(int transferwiseQuoteId, IDictionary<string, string> urlParams = null, IDictionary<string, string> customHeaders = null)
        {
        ...
        {
            return BunqModel.CreateFromJsonString<TransferwiseAccountRequirement>(json);
        }
    }
}
