...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    public class OauthClient : BunqModel
    {
        ...
        public static BunqResponse<OauthClient> Get(int oauthClientId, IDictionary<string, string> customHeaders = null)
        {
            ...
            var responseRaw = apiClient.Get(string.Format(ENDPOINT_URL_READ, DetermineUserId(), oauthClientId),
        ...
        /// </summary>
        /// <param name="status">The status of the Oauth Client, can be ACTIVE or CANCELLED.</param>
        public static BunqResponse<int> Update(int oauthClientId, string status = null,
            IDictionary<string, string> customHeaders = null)
        {
            ...
            var requestBytes = Encoding.UTF8.GetBytes(BunqJsonConvert.SerializeObject(requestMap));
            var responseRaw = apiClient.Put(string.Format(ENDPOINT_URL_UPDATE, DetermineUserId(), oauthClientId),
        ...
        /// <summary>
        /// </summary>
        public static BunqResponse<List<OauthClient>> List(IDictionary<string, string> urlParams = null,
            IDictionary<string, string> customHeaders = null)
        {
