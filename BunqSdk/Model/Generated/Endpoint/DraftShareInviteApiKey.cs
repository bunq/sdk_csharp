...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    public class DraftShareInviteApiKey : BunqModel
    {
        ...
        public static BunqResponse<int> Create(string expiration, string status = null, string subStatus = null, IDictionary<string, string> customHeaders = null)
        {
    ...
    {FIELD_EXPIRATION, expiration},
        ...
        /// </summary>
        public static BunqResponse<DraftShareInviteApiKey> Get(int draftShareInviteApiKeyId, IDictionary<string, string> customHeaders = null)
        {
            if (customHeaders == null) customHeaders = new Dictionary<string, string>();
    
            var apiClient = new ApiClient(GetApiContext());
            var responseRaw = apiClient.Get(string.Format(ENDPOINT_URL_READ, DetermineUserId(), draftShareInviteApiKeyId), new Dictionary<string, string>(), customHeaders);
        ...
        /// <param name="subStatus">The sub-status of the draft share invite. Can be NONE, ACCEPTED or REJECTED.</param>
        /// <param name="expiration">The moment when this draft share invite expires.</param>
        public static BunqResponse<DraftShareInviteApiKey> Update(int draftShareInviteApiKeyId, string status = null, string subStatus = null, string expiration = null, IDictionary<string, string> customHeaders = null)
        {
            if (customHeaders == null) customHeaders = new Dictionary<string, string>();
    ...
    {FIELD_EXPIRATION, expiration},
            ...
            var requestBytes = Encoding.UTF8.GetBytes(BunqJsonConvert.SerializeObject(requestMap));
            var responseRaw = apiClient.Put(string.Format(ENDPOINT_URL_UPDATE, DetermineUserId(), draftShareInviteApiKeyId), requestBytes, customHeaders);
        ...
        /// <summary>
        /// </summary>
        public static BunqResponse<List<DraftShareInviteApiKey>> List( IDictionary<string, string> urlParams = null, IDictionary<string, string> customHeaders = null)
        {
