...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    /// </summary>
    public class PaymentServiceProviderCredentialApiObject : BunqModel
    {
        /// <summary>
        /// Endpoint constants.
        /// </summary>
        ...
        /// Field constants.
        /// </summary>
        public const string FIELD_CLIENT_PAYMENT_SERVICE_PROVIDER_CERTIFICATE = "client_payment_service_provider_certificate";
        public const string FIELD_CLIENT_PAYMENT_SERVICE_PROVIDER_CERTIFICATE_CHAIN = "client_payment_service_provider_certificate_chain";
        ...
        public static BunqResponse<PaymentServiceProviderCredentialApiObject> Get(long paymentServiceProviderCredentialId, IDictionary<string, string> customHeaders = null)
        {
            ...
            var responseRaw = apiClient.Get(string.Format(ENDPOINT_URL_READ, paymentServiceProviderCredentialId), new Dictionary<string, string>(), customHeaders);
    ...
    {FIELD_CLIENT_PUBLIC_KEY_SIGNATURE, clientPublicKeySignature},
        ...
        /// <summary>
        /// </summary>
        public static PaymentServiceProviderCredentialApiObject CreateFromJsonString(string json)
        {
            return BunqModel.CreateFromJsonString<PaymentServiceProviderCredentialApiObject>(json);
        }
    }
}
