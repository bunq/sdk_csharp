...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    public class ShareInviteMonetaryAccountResponse : BunqModel
    {
            ...
            IDictionary<string, string> customHeaders = null)
        {
            ...
            var responseRaw =
                apiClient.Get(string.Format(ENDPOINT_URL_READ, DetermineUserId(), shareInviteMonetaryAccountResponseId),
            ...
            int? cardId = null, IDictionary<string, string> customHeaders = null)
        {
            ...
            var responseRaw =
                apiClient.Put(
                    string.Format(ENDPOINT_URL_UPDATE, DetermineUserId(), shareInviteMonetaryAccountResponseId),
        ...
        {
            return CreateFromJsonString<ShareInviteMonetaryAccountResponse>(json);
        }
    }
}