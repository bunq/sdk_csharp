...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    /// </summary>
    public class ExportStatementPaymentContentApiObject : BunqModel
    {
        /// <summary>
        /// Endpoint constants.
        /// </summary>
        ...
        public static BunqResponse<byte[]> List(long eventId, long statementId, long? monetaryAccountId= null, IDictionary<string, string> customHeaders = null)
        {
            ...
            var responseRaw = apiClient.Get(string.Format(ENDPOINT_URL_LISTING, DetermineUserId(), DetermineMonetaryAccountId(monetaryAccountId), eventId, statementId), new Dictionary<string, string>(), customHeaders);
        ...
        /// <summary>
        /// </summary>
        public static ExportStatementPaymentContentApiObject CreateFromJsonString(string json)
        {
            return BunqModel.CreateFromJsonString<ExportStatementPaymentContentApiObject>(json);
        }
    }
}
