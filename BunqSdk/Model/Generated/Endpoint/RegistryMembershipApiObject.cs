...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    /// </summary>
    public class RegistryMembershipApiObject : BunqModel
    {
        /// <summary>
        /// Field constants.
        /// </summary>
        ...
        public RegistryMembershipSettingObject Setting { get; set; }
        /// <summary>
        ...
        public long? MembershipTicountId { get; set; }
        /// <summary>
        ...
        /// <summary>
        /// </summary>
        public static RegistryMembershipApiObject CreateFromJsonString(string json)
        {
            return BunqModel.CreateFromJsonString<RegistryMembershipApiObject>(json);
        }
    }
}
