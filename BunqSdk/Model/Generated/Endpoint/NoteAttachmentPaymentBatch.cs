...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    public class NoteAttachmentPaymentBatch : BunqModel
    {
        ...
        protected const string ENDPOINT_URL_UPDATE =
            "user/{0}/monetary-account/{1}/payment-batch/{2}/note-attachment/{3}";
        ...
        public static BunqResponse<int> Create(int paymentBatchId, int? attachmentId, int? monetaryAccountId = null,
        ...
        /// </summary>
        /// <param name="description">Optional description of the attachment.</param>
        public static BunqResponse<int> Update(int paymentBatchId, int noteAttachmentPaymentBatchId,
            ...
            var responseRaw =
                apiClient.Put(
                    string.Format(ENDPOINT_URL_UPDATE, DetermineUserId(), DetermineMonetaryAccountId(monetaryAccountId),
                        paymentBatchId, noteAttachmentPaymentBatchId), requestBytes, customHeaders);
        ...
        /// <summary>
        /// </summary>
        public static BunqResponse<object> Delete(int paymentBatchId, int noteAttachmentPaymentBatchId,
            ...
            var responseRaw =
                apiClient.Delete(
                    string.Format(ENDPOINT_URL_DELETE, DetermineUserId(), DetermineMonetaryAccountId(monetaryAccountId),
                        paymentBatchId, noteAttachmentPaymentBatchId), customHeaders);
        ...
        /// </summary>
        public static BunqResponse<List<NoteAttachmentPaymentBatch>> List(int paymentBatchId,
            ...
            var responseRaw =
                apiClient.Get(
                    string.Format(ENDPOINT_URL_LISTING, DetermineUserId(),
                        DetermineMonetaryAccountId(monetaryAccountId), paymentBatchId), urlParams, customHeaders);
        ...
        /// <summary>
        /// </summary>
        public static BunqResponse<NoteAttachmentPaymentBatch> Get(int paymentBatchId, int noteAttachmentPaymentBatchId,
            int? monetaryAccountId = null, IDictionary<string, string> customHeaders = null)
        {
            if (customHeaders == null) customHeaders = new Dictionary<string, string>();
            ...
            var responseRaw =
                apiClient.Get(
                    string.Format(ENDPOINT_URL_READ, DetermineUserId(), DetermineMonetaryAccountId(monetaryAccountId),
                        paymentBatchId, noteAttachmentPaymentBatchId), new Dictionary<string, string>(), customHeaders);
