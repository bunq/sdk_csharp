...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    public class PermittedIp : BunqModel
    {
        ...
        /// <summary>
        /// </summary>
        public static BunqResponse<PermittedIp> Get(int credentialPasswordIpId, int permittedIpId, IDictionary<string, string> customHeaders = null)
        {
    ...
    {FIELD_STATUS, status},
        ...
        /// <summary>
        /// </summary>
        public static BunqResponse<List<PermittedIp>> List(int credentialPasswordIpId, IDictionary<string, string> urlParams = null, IDictionary<string, string> customHeaders = null)
        {
