...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    /// </summary>
    public class MonetaryAccountExternalSavings : BunqModel
    {
        /// <summary>
        /// Endpoint constants.
        /// </summary>
        ...
        /// <summary>
        /// The optional free-form reason for voluntarily cancelling (closing) the MonetaryAccountExternalSavings. Can
    ...
    {FIELD_SAVINGS_GOAL, savingsGoal},
        ...
        /// <summary>
        /// </summary>
        public static BunqResponse<MonetaryAccountExternalSavings> Get(int monetaryAccountExternalSavingsId, IDictionary<string, string> customHeaders = null)
        {
            if (customHeaders == null) customHeaders = new Dictionary<string, string>();
            ...
            return FromJson<MonetaryAccountExternalSavings>(responseRaw, OBJECT_TYPE_GET);
        }
        ...
        /// <param name="setting">The settings of the MonetaryAccountExternalSavings.</param>
        /// <param name="savingsGoal">The Savings Goal set for this MonetaryAccountSavings.</param>
        public static BunqResponse<int> Update(int monetaryAccountExternalSavingsId, string description = null, Amount dailyLimit = null, string avatarUuid = null, string status = null, string subStatus = null, string reason = null, string reasonDescription = null, string displayName = null, MonetaryAccountSetting setting = null, Amount savingsGoal = null, IDictionary<string, string> customHeaders = null)
        {
            if (customHeaders == null) customHeaders = new Dictionary<string, string>();
    ...
    {FIELD_SAVINGS_GOAL, savingsGoal},
        ...
        /// <summary>
        /// </summary>
        public static BunqResponse<List<MonetaryAccountExternalSavings>> List( IDictionary<string, string> urlParams = null, IDictionary<string, string> customHeaders = null)
        {
            ...
            return FromJsonList<MonetaryAccountExternalSavings>(responseRaw, OBJECT_TYPE_GET);
        }
        ...
        /// <summary>
        /// </summary>
        public static MonetaryAccountExternalSavings CreateFromJsonString(string json)
        {
            return BunqModel.CreateFromJsonString<MonetaryAccountExternalSavings>(json);
        }
    }
}
