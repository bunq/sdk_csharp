...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    /// </summary>
    public class FulfillmentApiObject : BunqModel
    {
        /// <summary>
        ...
        /// <summary>
        /// </summary>
        public static FulfillmentApiObject CreateFromJsonString(string json)
        {
            return BunqModel.CreateFromJsonString<FulfillmentApiObject>(json);
        }
    }
}
