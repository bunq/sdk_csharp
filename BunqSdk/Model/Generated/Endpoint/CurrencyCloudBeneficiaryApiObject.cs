...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    /// </summary>
    public class CurrencyCloudBeneficiaryApiObject : BunqModel
    {
        /// <summary>
        /// Endpoint constants.
        /// </summary>
    ...
    {FIELD_ALL_FIELD, allField},
        ...
        public static BunqResponse<CurrencyCloudBeneficiaryApiObject> Get(long currencyCloudBeneficiaryId, IDictionary<string, string> customHeaders = null)
        {
            ...
            return FromJson<CurrencyCloudBeneficiaryApiObject>(responseRaw, OBJECT_TYPE_GET);
        }
    
        /// <summary>
        /// </summary>
        public static BunqResponse<List<CurrencyCloudBeneficiaryApiObject>> List( IDictionary<string, string> urlParams = null, IDictionary<string, string> customHeaders = null)
        {
            ...
            return FromJsonList<CurrencyCloudBeneficiaryApiObject>(responseRaw, OBJECT_TYPE_GET);
        }
        ...
        /// <summary>
        /// </summary>
        public static CurrencyCloudBeneficiaryApiObject CreateFromJsonString(string json)
        {
            return BunqModel.CreateFromJsonString<CurrencyCloudBeneficiaryApiObject>(json);
        }
    }
}
