...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    /// </summary>
    public class WhitelistSddRecurringApiObject : BunqModel
    {
        /// <summary>
        /// Endpoint constants.
        /// </summary>
        ...
        public AmountObject MaximumAmountPerMonth { get; set; }
        /// <summary>
        ...
        public AmountObject MaximumAmountPerPayment { get; set; }
        /// <summary>
        ...
        public static BunqResponse<WhitelistSddRecurringApiObject> Get(long whitelistSddRecurringId, IDictionary<string, string> customHeaders = null)
        {
            ...
            return FromJson<WhitelistSddRecurringApiObject>(responseRaw, OBJECT_TYPE_GET);
        }
    ...
    {FIELD_ROUTING_TYPE, routingType},
        ...
        /// </summary>
        public static BunqResponse<List<WhitelistSddRecurringApiObject>> List( IDictionary<string, string> urlParams = null, IDictionary<string, string> customHeaders = null)
        {
            ...
            return FromJsonList<WhitelistSddRecurringApiObject>(responseRaw, OBJECT_TYPE_GET);
        }
        ...
        /// <summary>
        /// </summary>
        public static WhitelistSddRecurringApiObject CreateFromJsonString(string json)
        {
            return BunqModel.CreateFromJsonString<WhitelistSddRecurringApiObject>(json);
        }
    }
}
