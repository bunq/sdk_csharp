...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    public class NoteAttachmentDraftPayment : BunqModel
    {
        ...
        protected const string ENDPOINT_URL_UPDATE =
            "user/{0}/monetary-account/{1}/draft-payment/{2}/note-attachment/{3}";
        ...
        public static BunqResponse<int> Create(int draftPaymentId, int? attachmentId, int? monetaryAccountId = null,
        ...
        /// </summary>
        /// <param name="description">Optional description of the attachment.</param>
        public static BunqResponse<int> Update(int draftPaymentId, int noteAttachmentDraftPaymentId,
            ...
            var responseRaw =
                apiClient.Put(
                    string.Format(ENDPOINT_URL_UPDATE, DetermineUserId(), DetermineMonetaryAccountId(monetaryAccountId),
                        draftPaymentId, noteAttachmentDraftPaymentId), requestBytes, customHeaders);
        ...
        /// <summary>
        /// </summary>
        public static BunqResponse<object> Delete(int draftPaymentId, int noteAttachmentDraftPaymentId,
            ...
            var responseRaw =
                apiClient.Delete(
                    string.Format(ENDPOINT_URL_DELETE, DetermineUserId(), DetermineMonetaryAccountId(monetaryAccountId),
                        draftPaymentId, noteAttachmentDraftPaymentId), customHeaders);
        ...
        /// </summary>
        public static BunqResponse<List<NoteAttachmentDraftPayment>> List(int draftPaymentId,
        ...
        /// <summary>
        /// </summary>
        public static BunqResponse<NoteAttachmentDraftPayment> Get(int draftPaymentId, int noteAttachmentDraftPaymentId,
            int? monetaryAccountId = null, IDictionary<string, string> customHeaders = null)
        {
            if (customHeaders == null) customHeaders = new Dictionary<string, string>();
            ...
            var responseRaw =
                apiClient.Get(
                    string.Format(ENDPOINT_URL_READ, DetermineUserId(), DetermineMonetaryAccountId(monetaryAccountId),
                        draftPaymentId, noteAttachmentDraftPaymentId), new Dictionary<string, string>(), customHeaders);
