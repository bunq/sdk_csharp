...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    public class TransferwiseAccountQuote : BunqModel
    {
        ...
        /// <summary>
        /// </summary>
        public static BunqResponse<TransferwiseAccountQuote> Get(int transferwiseQuoteId,
            int transferwiseAccountQuoteId, IDictionary<string, string> customHeaders = null)
        {
            if (customHeaders == null) customHeaders = new Dictionary<string, string>();
            ...
            var responseRaw =
                apiClient.Get(
                    string.Format(ENDPOINT_URL_READ, DetermineUserId(), transferwiseQuoteId,
                        transferwiseAccountQuoteId), new Dictionary<string, string>(), customHeaders);
        ...
        /// <summary>
        /// </summary>
        public static BunqResponse<List<TransferwiseAccountQuote>> List(int transferwiseQuoteId,
        ...
        /// <summary>
        /// </summary>
        public static BunqResponse<object> Delete(int transferwiseQuoteId, int transferwiseAccountQuoteId,
            IDictionary<string, string> customHeaders = null)
        {
            if (customHeaders == null) customHeaders = new Dictionary<string, string>();
            ...
            var responseRaw =
                apiClient.Delete(
                    string.Format(ENDPOINT_URL_DELETE, DetermineUserId(), transferwiseQuoteId,
                        transferwiseAccountQuoteId), customHeaders);
        ...
        {
            return CreateFromJsonString<TransferwiseAccountQuote>(json);
        }
    }
}