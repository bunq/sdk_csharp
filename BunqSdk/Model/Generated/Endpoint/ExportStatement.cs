...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    {FIELD_INCLUDE_ATTACHMENT, includeAttachment},
        ...
        /// <summary>
        /// </summary>
        public static BunqResponse<ExportStatement> Get(int exportStatementId, int? monetaryAccountId= null, IDictionary<string, string> customHeaders = null)
        {
            if (customHeaders == null) customHeaders = new Dictionary<string, string>();
        ...
        /// <summary>
        /// </summary>
        public static BunqResponse<List<ExportStatement>> List(int? monetaryAccountId= null, IDictionary<string, string> urlParams = null, IDictionary<string, string> customHeaders = null)
        {
