...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    public class Payment : BunqModel
    {
        ...
        ///     The Alias of the party we are transferring the money to. Can be an Alias of type EMAIL
        ///     or PHONE_NUMBER (for bunq MonetaryAccounts or bunq.to payments) or IBAN (for external bank account).
        /// </param>
        ...
        /// </summary>
        public static BunqResponse<Payment> Get(int paymentId, int? monetaryAccountId = null,
            ...
            var responseRaw =
                apiClient.Get(
                    string.Format(ENDPOINT_URL_READ, DetermineUserId(), DetermineMonetaryAccountId(monetaryAccountId),
                        paymentId), new Dictionary<string, string>(), customHeaders);
        ...
        /// </summary>
        public static BunqResponse<List<Payment>> List(int? monetaryAccountId = null,
        ...
        public override bool IsAllFieldNull()
        {
            ...
            if (BunqtoStatus != null) return false;

            if (BunqtoSubStatus != null) return false;

            if (BunqtoShareUrl != null) return false;

            if (BunqtoExpiry != null) return false;

            if (BunqtoTimeResponded != null) return false;
            ...
            if (BalanceAfterMutation != null) return false;

            if (PaymentAutoAllocateInstance != null) return false;
        ...
        {
            return CreateFromJsonString<Payment>(json);
        }
    }
}