...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    /// </summary>
    public class TransferwiseUserApiObject : BunqModel
    {
        /// <summary>
        /// Endpoint constants.
        /// </summary>
    ...
    {FIELD_OAUTH_CODE, oauthCode},
        ...
        /// <summary>
        /// </summary>
        public static BunqResponse<List<TransferwiseUserApiObject>> List( IDictionary<string, string> urlParams = null, IDictionary<string, string> customHeaders = null)
        {
            ...
            return FromJsonList<TransferwiseUserApiObject>(responseRaw, OBJECT_TYPE_GET);
        }
        ...
        /// <summary>
        /// </summary>
        public static TransferwiseUserApiObject CreateFromJsonString(string json)
        {
            return BunqModel.CreateFromJsonString<TransferwiseUserApiObject>(json);
        }
    }
}
