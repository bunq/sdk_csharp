...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    public class NoteTextPaymentBatch : BunqModel
    {
        ...
        public static BunqResponse<int> Create(int paymentBatchId, int? monetaryAccountId = null, string content = null,
        ...
        /// </summary>
        /// <param name="content">The content of the note.</param>
        public static BunqResponse<int> Update(int paymentBatchId, int noteTextPaymentBatchId,
            ...
            var responseRaw =
                apiClient.Put(
                    string.Format(ENDPOINT_URL_UPDATE, DetermineUserId(), DetermineMonetaryAccountId(monetaryAccountId),
                        paymentBatchId, noteTextPaymentBatchId), requestBytes, customHeaders);
        ...
        /// <summary>
        /// </summary>
        public static BunqResponse<object> Delete(int paymentBatchId, int noteTextPaymentBatchId,
            ...
            var responseRaw =
                apiClient.Delete(
                    string.Format(ENDPOINT_URL_DELETE, DetermineUserId(), DetermineMonetaryAccountId(monetaryAccountId),
                        paymentBatchId, noteTextPaymentBatchId), customHeaders);
        ...
        /// </summary>
        public static BunqResponse<List<NoteTextPaymentBatch>> List(int paymentBatchId, int? monetaryAccountId = null,
        ...
        /// <summary>
        /// </summary>
        public static BunqResponse<NoteTextPaymentBatch> Get(int paymentBatchId, int noteTextPaymentBatchId,
            int? monetaryAccountId = null, IDictionary<string, string> customHeaders = null)
        {
            if (customHeaders == null) customHeaders = new Dictionary<string, string>();
            ...
            var responseRaw =
                apiClient.Get(
                    string.Format(ENDPOINT_URL_READ, DetermineUserId(), DetermineMonetaryAccountId(monetaryAccountId),
                        paymentBatchId, noteTextPaymentBatchId), new Dictionary<string, string>(), customHeaders);
        ...
        {
            return CreateFromJsonString<NoteTextPaymentBatch>(json);
        }
    }
}