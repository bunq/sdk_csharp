...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    /// </summary>
    public class WhitelistSddRecurring : BunqModel
    {
        /// <summary>
        /// Endpoint constants.
        /// </summary>
        protected const string ENDPOINT_URL_READ = "user/{0}/whitelist-sdd-recurring/{1}";
        protected const string ENDPOINT_URL_CREATE = "user/{0}/whitelist-sdd-recurring";
        protected const string ENDPOINT_URL_UPDATE = "user/{0}/whitelist-sdd-recurring/{1}";
        protected const string ENDPOINT_URL_DELETE = "user/{0}/whitelist-sdd-recurring/{1}";
        protected const string ENDPOINT_URL_LISTING = "user/{0}/whitelist-sdd-recurring";
        ...
        /// Object type.
        /// </summary>
        private const string OBJECT_TYPE_GET = "WhitelistSddRecurring";
        ...
        /// </summary>
        public static BunqResponse<WhitelistSddRecurring> Get(int whitelistSddRecurringId, IDictionary<string, string> customHeaders = null)
        {
            if (customHeaders == null) customHeaders = new Dictionary<string, string>();
    
            var apiClient = new ApiClient(GetApiContext());
            var responseRaw = apiClient.Get(string.Format(ENDPOINT_URL_READ, DetermineUserId(), whitelistSddRecurringId), new Dictionary<string, string>(), customHeaders);
    
            return FromJson<WhitelistSddRecurring>(responseRaw, OBJECT_TYPE_GET);
        }
    ...
    {FIELD_MAXIMUM_AMOUNT_PER_MONTH, maximumAmountPerMonth},
        ...
        /// <param name="monetaryAccountPayingId">ID of the monetary account of which you want to pay from.</param>
        /// <param name="maximumAmountPerMonth">The maximum amount of money that is allowed to be deducted based on the whitelist.</param>
        public static BunqResponse<int> Update(int whitelistSddRecurringId, int? monetaryAccountPayingId = null, Amount maximumAmountPerMonth = null, IDictionary<string, string> customHeaders = null)
        {
            if (customHeaders == null) customHeaders = new Dictionary<string, string>();
    ...
    {FIELD_MAXIMUM_AMOUNT_PER_MONTH, maximumAmountPerMonth},
            ...
            var requestBytes = Encoding.UTF8.GetBytes(BunqJsonConvert.SerializeObject(requestMap));
            var responseRaw = apiClient.Put(string.Format(ENDPOINT_URL_UPDATE, DetermineUserId(), whitelistSddRecurringId), requestBytes, customHeaders);
        ...
        public static BunqResponse<object> Delete(int whitelistSddRecurringId, IDictionary<string, string> customHeaders = null)
        {
            ...
            var apiClient = new ApiClient(GetApiContext());
            var responseRaw = apiClient.Delete(string.Format(ENDPOINT_URL_DELETE, DetermineUserId(), whitelistSddRecurringId), customHeaders);
        ...
        /// </summary>
        public static BunqResponse<List<WhitelistSddRecurring>> List( IDictionary<string, string> urlParams = null, IDictionary<string, string> customHeaders = null)
        {
            ...
            return FromJsonList<WhitelistSddRecurring>(responseRaw, OBJECT_TYPE_GET);
        }
        ...
        /// <summary>
        /// </summary>
        public static WhitelistSddRecurring CreateFromJsonString(string json)
        {
            return BunqModel.CreateFromJsonString<WhitelistSddRecurring>(json);
        }
    }
}
