...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    public class ShareInviteBankInquiry : BunqModel
    {
        ...
        public static BunqResponse<int> Create(Pointer counterUserAlias, ShareDetail shareDetail, string status, int? monetaryAccountId= null, int? draftShareInviteBankId = null, string shareType = null, string startDate = null, string endDate = null, IDictionary<string, string> customHeaders = null)
        {
    ...
    {FIELD_END_DATE, endDate},
        ...
        /// </summary>
        public static BunqResponse<ShareInviteBankInquiry> Get(int shareInviteBankInquiryId, int? monetaryAccountId= null, IDictionary<string, string> customHeaders = null)
        {
            if (customHeaders == null) customHeaders = new Dictionary<string, string>();
    
            var apiClient = new ApiClient(GetApiContext());
            var responseRaw = apiClient.Get(string.Format(ENDPOINT_URL_READ, DetermineUserId(), DetermineMonetaryAccountId(monetaryAccountId), shareInviteBankInquiryId), new Dictionary<string, string>(), customHeaders);
        ...
        /// <param name="startDate">The start date of this share.</param>
        /// <param name="endDate">The expiration date of this share.</param>
        public static BunqResponse<int> Update(int shareInviteBankInquiryId, int? monetaryAccountId= null, ShareDetail shareDetail = null, string status = null, string startDate = null, string endDate = null, IDictionary<string, string> customHeaders = null)
        {
            if (customHeaders == null) customHeaders = new Dictionary<string, string>();
    ...
    {FIELD_END_DATE, endDate},
            ...
            var requestBytes = Encoding.UTF8.GetBytes(BunqJsonConvert.SerializeObject(requestMap));
            var responseRaw = apiClient.Put(string.Format(ENDPOINT_URL_UPDATE, DetermineUserId(), DetermineMonetaryAccountId(monetaryAccountId), shareInviteBankInquiryId), requestBytes, customHeaders);
        ...
        /// </summary>
        public static BunqResponse<List<ShareInviteBankInquiry>> List(int? monetaryAccountId= null, IDictionary<string, string> urlParams = null, IDictionary<string, string> customHeaders = null)
        {
