...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    /// </summary>
    public class MasterCardIdentityCheckChallengeRequestUserApiObject : BunqModel
    {
        /// <summary>
        /// Endpoint constants.
        /// </summary>
        ...
        public static BunqResponse<MasterCardIdentityCheckChallengeRequestUserApiObject> Get(long masterCardIdentityCheckChallengeRequestUserId, IDictionary<string, string> customHeaders = null)
        {
            ...
            return FromJson<MasterCardIdentityCheckChallengeRequestUserApiObject>(responseRaw, OBJECT_TYPE_GET);
        }
    ...
    {FIELD_STATUS, status},
        ...
        /// <summary>
        /// </summary>
        public static MasterCardIdentityCheckChallengeRequestUserApiObject CreateFromJsonString(string json)
        {
            return BunqModel.CreateFromJsonString<MasterCardIdentityCheckChallengeRequestUserApiObject>(json);
        }
    }
}
