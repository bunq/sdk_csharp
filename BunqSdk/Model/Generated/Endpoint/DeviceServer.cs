...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    {FIELD_PERMITTED_IPS, permittedIps},
        ...
        /// </summary>
        public static BunqResponse<DeviceServer> Get(int deviceServerId, IDictionary<string, string> customHeaders = null)
        {
            if (customHeaders == null) customHeaders = new Dictionary<string, string>();
        ...
        /// </summary>
        public static BunqResponse<List<DeviceServer>> List( IDictionary<string, string> urlParams = null, IDictionary<string, string> customHeaders = null)
        {
