...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    public class UserPerson : BunqModel
    {
        ...
        /// <param name="documentCountryOfIssuance">
        ///     The country which issued the identification document the person registered
        ///     with.
        /// </param>
        /// <param name="documentFrontAttachmentId">
        ///     The reference to the uploaded picture/scan of the front side of the
        ///     identification document.
        /// </param>
        /// <param name="documentBackAttachmentId">
        ...
        public override bool IsAllFieldNull()
        {
            ...
            if (TaxResident != null) return false;
            ...
            if (PlaceOfBirth != null) return false;

            if (CountryOfBirth != null) return false;
