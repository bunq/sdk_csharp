...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    {FIELD_TYPE, type},
        ...
        /// </summary>
        public static BunqResponse<CardGeneratedCvc2> Get(int cardId, int cardGeneratedCvc2Id, IDictionary<string, string> customHeaders = null)
        {
            if (customHeaders == null) customHeaders = new Dictionary<string, string>();
    ...
    {FIELD_TYPE, type},
        ...
        /// </summary>
        public static BunqResponse<List<CardGeneratedCvc2>> List(int cardId, IDictionary<string, string> urlParams = null, IDictionary<string, string> customHeaders = null)
        {
