...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    /// </summary>
    public class GinmonTransactionApiObject : BunqModel
    {
        /// <summary>
        ...
        public AmountObject AmountBillingOriginal { get; set; }
        /// <summary>
        ...
        /// <summary>
        /// </summary>
        public static GinmonTransactionApiObject CreateFromJsonString(string json)
        {
            return BunqModel.CreateFromJsonString<GinmonTransactionApiObject>(json);
        }
    }
}
