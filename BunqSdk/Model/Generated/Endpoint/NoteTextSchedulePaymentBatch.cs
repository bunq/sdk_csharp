...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    public class NoteTextSchedulePaymentBatch : BunqModel
    {
        ...
        protected const string ENDPOINT_URL_CREATE =
            "user/{0}/monetary-account/{1}/schedule-payment-batch/{2}/note-text";

        protected const string ENDPOINT_URL_UPDATE =
            "user/{0}/monetary-account/{1}/schedule-payment-batch/{2}/note-text/{3}";
        ...
        public static BunqResponse<int> Create(int schedulePaymentBatchId, int? monetaryAccountId = null,
        ...
        /// </summary>
        /// <param name="content">The content of the note.</param>
        public static BunqResponse<int> Update(int schedulePaymentBatchId, int noteTextSchedulePaymentBatchId,
            ...
            var responseRaw =
                apiClient.Put(
                    string.Format(ENDPOINT_URL_UPDATE, DetermineUserId(), DetermineMonetaryAccountId(monetaryAccountId),
                        schedulePaymentBatchId, noteTextSchedulePaymentBatchId), requestBytes, customHeaders);
        ...
        /// <summary>
        /// </summary>
        public static BunqResponse<object> Delete(int schedulePaymentBatchId, int noteTextSchedulePaymentBatchId,
            ...
            var responseRaw =
                apiClient.Delete(
                    string.Format(ENDPOINT_URL_DELETE, DetermineUserId(), DetermineMonetaryAccountId(monetaryAccountId),
                        schedulePaymentBatchId, noteTextSchedulePaymentBatchId), customHeaders);
        ...
        /// </summary>
        public static BunqResponse<List<NoteTextSchedulePaymentBatch>> List(int schedulePaymentBatchId,
        ...
        /// <summary>
        /// </summary>
        public static BunqResponse<NoteTextSchedulePaymentBatch> Get(int schedulePaymentBatchId,
            int noteTextSchedulePaymentBatchId, int? monetaryAccountId = null,
            IDictionary<string, string> customHeaders = null)
        {
            if (customHeaders == null) customHeaders = new Dictionary<string, string>();
            ...
            var responseRaw =
                apiClient.Get(
                    string.Format(ENDPOINT_URL_READ, DetermineUserId(), DetermineMonetaryAccountId(monetaryAccountId),
                        schedulePaymentBatchId, noteTextSchedulePaymentBatchId), new Dictionary<string, string>(),
                    customHeaders);
        ...
        {
            return CreateFromJsonString<NoteTextSchedulePaymentBatch>(json);
        }
    }
}