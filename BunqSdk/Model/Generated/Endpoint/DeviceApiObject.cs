...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    /// </summary>
    public class DeviceApiObject : BunqModel, IAnchorObjectInterface
    {
        /// <summary>
        /// Error constants.
        /// </summary>
        ...
        public DeviceServerApiObject DeviceServer { get; set; }
        ...
        public static BunqResponse<DeviceApiObject> Get(long deviceId, IDictionary<string, string> customHeaders = null)
        {
            ...
            return FromJson<DeviceApiObject>(responseRaw);
        }
    
        /// <summary>
        /// Get a collection of Devices. A Device is either a DevicePhone or a DeviceServer.
        /// </summary>
        public static BunqResponse<List<DeviceApiObject>> List( IDictionary<string, string> urlParams = null, IDictionary<string, string> customHeaders = null)
        {
            ...
            return FromJsonList<DeviceApiObject>(responseRaw);
        }
        ...
        /// <summary>
        /// </summary>
        public static DeviceApiObject CreateFromJsonString(string json)
        {
            return BunqModel.CreateFromJsonString<DeviceApiObject>(json);
        }
    }
}
