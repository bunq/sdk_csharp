...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    public class PaymentAutoAllocate : BunqModel
    {
        ...
        public static BunqResponse<int> Create(int? paymentId, string type, List<PaymentAutoAllocateDefinition> definition, int? monetaryAccountId= null, IDictionary<string, string> customHeaders = null)
        {
    ...
    {FIELD_DEFINITION, definition},
        ...
        /// <summary>
        /// </summary>
        public static BunqResponse<PaymentAutoAllocate> Get(int paymentAutoAllocateId, int? monetaryAccountId= null, IDictionary<string, string> customHeaders = null)
        {
            if (customHeaders == null) customHeaders = new Dictionary<string, string>();
    
            var apiClient = new ApiClient(GetApiContext());
            var responseRaw = apiClient.Get(string.Format(ENDPOINT_URL_READ, DetermineUserId(), DetermineMonetaryAccountId(monetaryAccountId), paymentAutoAllocateId), new Dictionary<string, string>(), customHeaders);
        ...
        /// <summary>
        /// </summary>
        public static BunqResponse<List<PaymentAutoAllocate>> List(int? monetaryAccountId= null, IDictionary<string, string> urlParams = null, IDictionary<string, string> customHeaders = null)
        {
        ...
        /// </summary>
        /// <param name="definition">The definition of how the money should be allocated.</param>
        public static BunqResponse<int> Update(int paymentAutoAllocateId, int? monetaryAccountId= null, List<PaymentAutoAllocateDefinition> definition = null, IDictionary<string, string> customHeaders = null)
        {
            if (customHeaders == null) customHeaders = new Dictionary<string, string>();
    ...
    {FIELD_DEFINITION, definition},
            ...
            var requestBytes = Encoding.UTF8.GetBytes(BunqJsonConvert.SerializeObject(requestMap));
            var responseRaw = apiClient.Put(string.Format(ENDPOINT_URL_UPDATE, DetermineUserId(), DetermineMonetaryAccountId(monetaryAccountId), paymentAutoAllocateId), requestBytes, customHeaders);
