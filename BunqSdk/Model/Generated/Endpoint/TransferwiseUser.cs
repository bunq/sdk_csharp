...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    {FIELD_OAUTH_CODE, oauthCode},
        ...
        /// <summary>
        /// </summary>
        public static BunqResponse<List<TransferwiseUser>> List( IDictionary<string, string> urlParams = null, IDictionary<string, string> customHeaders = null)
        {
        ...
        {
            return BunqModel.CreateFromJsonString<TransferwiseUser>(json);
        }
    }
}
