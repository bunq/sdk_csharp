...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    /// </summary>
    public class InstallationServerPublicKeyApiObject : BunqModel
    {
        /// <summary>
        /// Endpoint constants.
        /// </summary>
        ...
        public static BunqResponse<List<InstallationServerPublicKeyApiObject>> List(long installationId, IDictionary<string, string> urlParams = null, IDictionary<string, string> customHeaders = null)
        {
            ...
            return FromJsonList<InstallationServerPublicKeyApiObject>(responseRaw, OBJECT_TYPE_GET);
        }
        ...
        /// <summary>
        /// </summary>
        public static InstallationServerPublicKeyApiObject CreateFromJsonString(string json)
        {
            return BunqModel.CreateFromJsonString<InstallationServerPublicKeyApiObject>(json);
        }
    }
}
