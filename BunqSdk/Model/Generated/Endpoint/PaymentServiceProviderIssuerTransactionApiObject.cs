...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    /// </summary>
    public class PaymentServiceProviderIssuerTransactionApiObject : BunqModel
    {
        /// <summary>
        /// Endpoint constants.
        /// </summary>
    ...
    {FIELD_STATUS, status},
        ...
        public static BunqResponse<PaymentServiceProviderIssuerTransactionApiObject> Get(long paymentServiceProviderIssuerTransactionId, IDictionary<string, string> customHeaders = null)
        {
            ...
            return FromJson<PaymentServiceProviderIssuerTransactionApiObject>(responseRaw, OBJECT_TYPE_GET);
        }
    ...
    {FIELD_STATUS, status},
        ...
        /// <summary>
        /// </summary>
        public static BunqResponse<List<PaymentServiceProviderIssuerTransactionApiObject>> List( IDictionary<string, string> urlParams = null, IDictionary<string, string> customHeaders = null)
        {
            ...
            return FromJsonList<PaymentServiceProviderIssuerTransactionApiObject>(responseRaw, OBJECT_TYPE_GET);
        }
        ...
        /// <summary>
        /// </summary>
        public static PaymentServiceProviderIssuerTransactionApiObject CreateFromJsonString(string json)
        {
            return BunqModel.CreateFromJsonString<PaymentServiceProviderIssuerTransactionApiObject>(json);
        }
    }
}
