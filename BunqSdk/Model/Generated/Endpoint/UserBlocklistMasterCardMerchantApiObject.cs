...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    /// </summary>
    public class UserBlocklistMasterCardMerchantApiObject : BunqModel
    {
        /// <summary>
        /// Field constants.
        /// </summary>
        ...
        public AvatarApiObject MerchantAvatar { get; set; }
        ...
        /// <summary>
        /// </summary>
        public static UserBlocklistMasterCardMerchantApiObject CreateFromJsonString(string json)
        {
            return BunqModel.CreateFromJsonString<UserBlocklistMasterCardMerchantApiObject>(json);
        }
    }
}
