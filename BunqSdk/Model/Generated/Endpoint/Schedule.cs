...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    public class Schedule : BunqModel
    {
        ...
        /// </summary>
        public static BunqResponse<Schedule> Get(int scheduleId, int? monetaryAccountId= null, IDictionary<string, string> customHeaders = null)
        {
        ...
        /// </summary>
        public static BunqResponse<List<Schedule>> List(int? monetaryAccountId= null, IDictionary<string, string> urlParams = null, IDictionary<string, string> customHeaders = null)
        {
