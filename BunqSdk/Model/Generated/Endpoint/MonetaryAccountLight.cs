...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    public class MonetaryAccountLight : BunqModel
    {
        ...
        public override bool IsAllFieldNull()
        {
            ...
            if (BalanceMaximum != null) return false;

            if (BudgetMonthUsed != null) return false;

            if (BudgetMonthMaximum != null) return false;

            if (BudgetYearUsed != null) return false;

            if (BudgetYearMaximum != null) return false;

            if (BudgetWithdrawalYearUsed != null) return false;

            if (BudgetWithdrawalYearMaximum != null) return false;
        ...
        {
            return CreateFromJsonString<MonetaryAccountLight>(json);
        }
    }
}