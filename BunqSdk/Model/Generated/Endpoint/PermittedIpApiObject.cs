...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    /// </summary>
    public class PermittedIpApiObject : BunqModel
    {
        /// <summary>
        /// Endpoint constants.
        /// </summary>
        ...
        public static BunqResponse<PermittedIpApiObject> Get(long credentialPasswordIpId, long permittedIpId, IDictionary<string, string> customHeaders = null)
        {
            ...
            var responseRaw = apiClient.Get(string.Format(ENDPOINT_URL_READ, DetermineUserId(), credentialPasswordIpId, permittedIpId), new Dictionary<string, string>(), customHeaders);
    
            return FromJson<PermittedIpApiObject>(responseRaw, OBJECT_TYPE_GET);
        }
    ...
    {FIELD_STATUS, status},
        ...
        public static BunqResponse<List<PermittedIpApiObject>> List(long credentialPasswordIpId, IDictionary<string, string> urlParams = null, IDictionary<string, string> customHeaders = null)
        {
            ...
            var apiClient = new ApiClient(GetApiContext());
            var responseRaw = apiClient.Get(string.Format(ENDPOINT_URL_LISTING, DetermineUserId(), credentialPasswordIpId), urlParams, customHeaders);
    
            return FromJsonList<PermittedIpApiObject>(responseRaw, OBJECT_TYPE_GET);
        }
    ...
    {FIELD_STATUS, status},
            ...
            var requestBytes = Encoding.UTF8.GetBytes(BunqJsonConvert.SerializeObject(requestMap));
            var responseRaw = apiClient.Put(string.Format(ENDPOINT_URL_UPDATE, DetermineUserId(), credentialPasswordIpId, permittedIpId), requestBytes, customHeaders);
        ...
        /// <summary>
        /// </summary>
        public static PermittedIpApiObject CreateFromJsonString(string json)
        {
            return BunqModel.CreateFromJsonString<PermittedIpApiObject>(json);
        }
    }
}
