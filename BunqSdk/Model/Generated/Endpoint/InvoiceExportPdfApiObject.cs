...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    /// </summary>
    public class InvoiceExportPdfApiObject : BunqModel
    {
        /// <summary>
        /// Endpoint constants.
        /// </summary>
        ...
        public static BunqResponse<InvoiceExportPdfApiObject> Get(long invoiceId, long invoiceExportPdfId, IDictionary<string, string> customHeaders = null)
        {
            ...
            return FromJson<InvoiceExportPdfApiObject>(responseRaw, OBJECT_TYPE_GET);
        }
            ...
            var requestMap = new Dictionary<string, object>
    {
        ...
        /// <summary>
        /// </summary>
        public static InvoiceExportPdfApiObject CreateFromJsonString(string json)
        {
            return BunqModel.CreateFromJsonString<InvoiceExportPdfApiObject>(json);
        }
    }
}
