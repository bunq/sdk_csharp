...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    /// </summary>
    public class ShareInviteMonetaryAccountResponseApiObject : BunqModel
    {
        /// <summary>
        /// Endpoint constants.
        /// </summary>
        ...
        public ShareDetailObject ShareDetail { get; set; }
        /// <summary>
        ...
        public static BunqResponse<ShareInviteMonetaryAccountResponseApiObject> Get(long shareInviteMonetaryAccountResponseId, IDictionary<string, string> customHeaders = null)
        {
            ...
            return FromJson<ShareInviteMonetaryAccountResponseApiObject>(responseRaw, OBJECT_TYPE_GET);
        }
    ...
    {FIELD_CARD_ID, cardId},
        ...
        /// </summary>
        public static BunqResponse<List<ShareInviteMonetaryAccountResponseApiObject>> List( IDictionary<string, string> urlParams = null, IDictionary<string, string> customHeaders = null)
        {
            ...
            return FromJsonList<ShareInviteMonetaryAccountResponseApiObject>(responseRaw, OBJECT_TYPE_GET);
        }
        ...
        /// <summary>
        /// </summary>
        public static ShareInviteMonetaryAccountResponseApiObject CreateFromJsonString(string json)
        {
            return BunqModel.CreateFromJsonString<ShareInviteMonetaryAccountResponseApiObject>(json);
        }
    }
}
