...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    public class DraftPayment : BunqModel
    {
        ...
        public static BunqResponse<int> Create(List<DraftPaymentEntry> entries, int? numberOfRequiredAccepts, int? monetaryAccountId= null, string status = null, string previousUpdatedTimestamp = null, Schedule schedule = null, IDictionary<string, string> customHeaders = null)
        {
    ...
    {FIELD_SCHEDULE, schedule},
        ...
        /// <param name="previousUpdatedTimestamp">The last updated_timestamp that you received for this DraftPayment. This needs to be provided to prevent race conditions.</param>
        /// <param name="schedule">The schedule details when creating or updating a scheduled payment.</param>
        public static BunqResponse<int> Update(int draftPaymentId, int? monetaryAccountId= null, string status = null, List<DraftPaymentEntry> entries = null, string previousUpdatedTimestamp = null, Schedule schedule = null, IDictionary<string, string> customHeaders = null)
        {
            if (customHeaders == null) customHeaders = new Dictionary<string, string>();
    ...
    {FIELD_SCHEDULE, schedule},
        ...
        /// </summary>
        public static BunqResponse<List<DraftPayment>> List(int? monetaryAccountId= null, IDictionary<string, string> urlParams = null, IDictionary<string, string> customHeaders = null)
        {
        ...
        /// </summary>
        public static BunqResponse<DraftPayment> Get(int draftPaymentId, int? monetaryAccountId= null, IDictionary<string, string> customHeaders = null)
        {
            if (customHeaders == null) customHeaders = new Dictionary<string, string>();
