...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    public class DraftPayment : BunqModel
    {
        ...
        /// Endpoint constants.
        /// </summary>
        private const string EndpointUrlCreate = "user/{0}/monetary-account/{1}/draft-payment";
        private const string EndpointUrlUpdate = "user/{0}/monetary-account/{1}/draft-payment/{2}";
        private const string EndpointUrlListing = "user/{0}/monetary-account/{1}/draft-payment";
        private const string EndpointUrlRead = "user/{0}/monetary-account/{1}/draft-payment/{2}";
        ...
        public const string FieldPreviousUpdatedTimestamp = "previous_updated_timestamp";
        public const string FieldNumberOfRequiredAccepts = "number_of_required_accepts";
    
        /// <summary>
        /// Object type.
        /// </summary>
        private const string ObjectType = "DraftPayment";
        ...
        public static BunqResponse<int> Update(ApiContext apiContext, IDictionary<string, object> requestMap, int userId, int monetaryAccountId, int draftPaymentId, IDictionary<string, string> customHeaders = null)
        {
            ...
            var apiClient = new ApiClient(apiContext);
            var requestBytes = Encoding.UTF8.GetBytes(BunqJsonConvert.SerializeObject(requestMap));
            var responseRaw = apiClient.Put(string.Format(EndpointUrlUpdate, userId, monetaryAccountId, draftPaymentId), requestBytes, customHeaders);
        ...
        public static BunqResponse<List<DraftPayment>> List(ApiContext apiContext, int userId, int monetaryAccountId, IDictionary<string, string> urlParams = null, IDictionary<string, string> customHeaders = null)
        {
            ...
            return FromJsonList<DraftPayment>(responseRaw, ObjectType);
        }
        ...
        public static BunqResponse<DraftPayment> Get(ApiContext apiContext, int userId, int monetaryAccountId, int draftPaymentId, IDictionary<string, string> customHeaders = null)
        {
            ...
            var apiClient = new ApiClient(apiContext);
            var responseRaw = apiClient.Get(string.Format(EndpointUrlRead, userId, monetaryAccountId, draftPaymentId), new Dictionary<string, string>(), customHeaders);
    
            return FromJson<DraftPayment>(responseRaw, ObjectType);
        }
