...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    public class NoteTextBankSwitchServiceNetherlandsIncomingPayment : BunqModel
    {
        ...
        public static BunqResponse<int> Create(int switchServicePaymentId, int? monetaryAccountId = null,
        ...
        public static BunqResponse<int> Update(int switchServicePaymentId,
            int noteTextBankSwitchServiceNetherlandsIncomingPaymentId, int? monetaryAccountId = null,
            string content = null, IDictionary<string, string> customHeaders = null)
        {
            if (customHeaders == null) customHeaders = new Dictionary<string, string>();
            ...
            var responseRaw =
                apiClient.Put(
                    string.Format(ENDPOINT_URL_UPDATE, DetermineUserId(), DetermineMonetaryAccountId(monetaryAccountId),
                        switchServicePaymentId, noteTextBankSwitchServiceNetherlandsIncomingPaymentId), requestBytes,
                    customHeaders);
            ...
            var responseRaw =
                apiClient.Delete(
                    string.Format(ENDPOINT_URL_DELETE, DetermineUserId(), DetermineMonetaryAccountId(monetaryAccountId),
                        switchServicePaymentId, noteTextBankSwitchServiceNetherlandsIncomingPaymentId), customHeaders);
        ...
        /// <summary>
        /// </summary>
        public static BunqResponse<NoteTextBankSwitchServiceNetherlandsIncomingPayment> Get(int switchServicePaymentId,
            int noteTextBankSwitchServiceNetherlandsIncomingPaymentId, int? monetaryAccountId = null,
            IDictionary<string, string> customHeaders = null)
        {
            if (customHeaders == null) customHeaders = new Dictionary<string, string>();
            ...
            var responseRaw = apiClient.Get(
                string.Format(ENDPOINT_URL_READ, DetermineUserId(), DetermineMonetaryAccountId(monetaryAccountId),
                    switchServicePaymentId, noteTextBankSwitchServiceNetherlandsIncomingPaymentId),
