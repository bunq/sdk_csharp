...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    /// </summary>
    public class CardReplaceApiObject : BunqModel
    {
        /// <summary>
        /// Endpoint constants.
        /// </summary>
    ...
    {FIELD_SECOND_LINE, secondLine},
        ...
        /// <summary>
        /// </summary>
        public static CardReplaceApiObject CreateFromJsonString(string json)
        {
            return BunqModel.CreateFromJsonString<CardReplaceApiObject>(json);
        }
    }
}
