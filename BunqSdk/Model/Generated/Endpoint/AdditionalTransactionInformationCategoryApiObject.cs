...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    /// </summary>
    public class AdditionalTransactionInformationCategoryApiObject : BunqModel
    {
        /// <summary>
        /// Endpoint constants.
        /// </summary>
        ...
        /// <summary>
        /// </summary>
        public static BunqResponse<List<AdditionalTransactionInformationCategoryApiObject>> List( IDictionary<string, string> urlParams = null, IDictionary<string, string> customHeaders = null)
        {
            ...
            return FromJsonList<AdditionalTransactionInformationCategoryApiObject>(responseRaw, OBJECT_TYPE_GET);
        }
        ...
        /// <summary>
        /// </summary>
        public static AdditionalTransactionInformationCategoryApiObject CreateFromJsonString(string json)
        {
            return BunqModel.CreateFromJsonString<AdditionalTransactionInformationCategoryApiObject>(json);
        }
    }
}
