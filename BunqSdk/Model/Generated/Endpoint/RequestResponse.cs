...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    public class RequestResponse : BunqModel
    {
        ...
        /// </param>
        public static BunqResponse<RequestResponse> Update(int requestResponseId, int? monetaryAccountId = null,
            Amount amountResponded = null, string status = null, Address addressShipping = null,
            Address addressBilling = null, IDictionary<string, string> customHeaders = null)
        {
        ...
        /// </summary>
        public static BunqResponse<List<RequestResponse>> List(int? monetaryAccountId = null,
        ...
        /// </summary>
        public static BunqResponse<RequestResponse> Get(int requestResponseId, int? monetaryAccountId = null,
            ...
            var responseRaw =
                apiClient.Get(
                    string.Format(ENDPOINT_URL_READ, DetermineUserId(), DetermineMonetaryAccountId(monetaryAccountId),
                        requestResponseId), new Dictionary<string, string>(), customHeaders);
        ...
        public override bool IsAllFieldNull()
        {
            ...
            if (TimeRefundRequested != null) return false;

            if (TimeRefunded != null) return false;

            if (UserRefundRequested != null) return false;
            ...
            if (EligibleWhitelistId != null) return false;
        ...
        {
            return CreateFromJsonString<RequestResponse>(json);
        }
    }
}