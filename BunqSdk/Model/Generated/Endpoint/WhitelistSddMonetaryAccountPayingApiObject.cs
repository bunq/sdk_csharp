...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    /// </summary>
    public class WhitelistSddMonetaryAccountPayingApiObject : BunqModel
    {
        /// <summary>
        /// Endpoint constants.
        /// </summary>
        ...
        public static BunqResponse<WhitelistSddMonetaryAccountPayingApiObject> Get(long whitelistSddMonetaryAccountPayingId, long? monetaryAccountId= null, IDictionary<string, string> customHeaders = null)
        {
            ...
            return FromJson<WhitelistSddMonetaryAccountPayingApiObject>(responseRaw, OBJECT_TYPE_GET);
        }
        ...
        public static BunqResponse<List<WhitelistSddMonetaryAccountPayingApiObject>> List(long? monetaryAccountId= null, IDictionary<string, string> urlParams = null, IDictionary<string, string> customHeaders = null)
        {
            ...
            return FromJsonList<WhitelistSddMonetaryAccountPayingApiObject>(responseRaw, OBJECT_TYPE_GET);
        }
        ...
        /// <summary>
        /// </summary>
        public static WhitelistSddMonetaryAccountPayingApiObject CreateFromJsonString(string json)
        {
            return BunqModel.CreateFromJsonString<WhitelistSddMonetaryAccountPayingApiObject>(json);
        }
    }
}
