...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    /// </summary>
    public class OauthClientApiObject : BunqModel
    {
        /// <summary>
        /// Endpoint constants.
        /// </summary>
        ...
        public List<OauthCallbackUrlObject> CallbackUrl { get; set; }
        ...
        public static BunqResponse<OauthClientApiObject> Get(long oauthClientId, IDictionary<string, string> customHeaders = null)
        {
            ...
            return FromJson<OauthClientApiObject>(responseRaw, OBJECT_TYPE_GET);
        }
    ...
    {FIELD_STATUS, status},
        ...
        /// <summary>
        /// </summary>
        public static BunqResponse<List<OauthClientApiObject>> List( IDictionary<string, string> urlParams = null, IDictionary<string, string> customHeaders = null)
        {
            ...
            return FromJsonList<OauthClientApiObject>(responseRaw, OBJECT_TYPE_GET);
        }
        ...
        /// <summary>
        /// </summary>
        public static OauthClientApiObject CreateFromJsonString(string json)
        {
            return BunqModel.CreateFromJsonString<OauthClientApiObject>(json);
        }
    }
}
