...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    /// </summary>
    public class BirdeeInvestmentPortfolioApiObject : BunqModel
    {
        /// <summary>
        /// Field constants.
        /// </summary>
        ...
        public BirdeeInvestmentPortfolioGoalObject Goal { get; set; }
        /// <summary>
        ...
        public BirdeeInvestmentPortfolioBalanceApiObject Balance { get; set; }
        /// <summary>
        /// The allocations of the investment portfolio.
        /// </summary>
        [JsonProperty(PropertyName = "allocations")]
        public List<BirdeePortfolioAllocationApiObject> Allocations { get; set; }
        ...
        /// <summary>
        /// </summary>
        public static BirdeeInvestmentPortfolioApiObject CreateFromJsonString(string json)
        {
            return BunqModel.CreateFromJsonString<BirdeeInvestmentPortfolioApiObject>(json);
        }
    }
}
