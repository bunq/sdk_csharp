...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    public class NoteAttachmentRequestInquiryBatch : BunqModel
    {
        ...
        protected const string ENDPOINT_URL_CREATE =
            "user/{0}/monetary-account/{1}/request-inquiry-batch/{2}/note-attachment";

        protected const string ENDPOINT_URL_UPDATE =
            "user/{0}/monetary-account/{1}/request-inquiry-batch/{2}/note-attachment/{3}";
        ...
        public static BunqResponse<int> Create(int requestInquiryBatchId, int? attachmentId,
            ...
            var responseRaw =
                apiClient.Post(
                    string.Format(ENDPOINT_URL_CREATE, DetermineUserId(), DetermineMonetaryAccountId(monetaryAccountId),
                        requestInquiryBatchId), requestBytes, customHeaders);
        ...
        /// </summary>
        /// <param name="description">Optional description of the attachment.</param>
        public static BunqResponse<int> Update(int requestInquiryBatchId, int noteAttachmentRequestInquiryBatchId,
            int? monetaryAccountId = null, string description = null, IDictionary<string, string> customHeaders = null)
        {
            if (customHeaders == null) customHeaders = new Dictionary<string, string>();
            ...
            var responseRaw =
                apiClient.Put(
                    string.Format(ENDPOINT_URL_UPDATE, DetermineUserId(), DetermineMonetaryAccountId(monetaryAccountId),
                        requestInquiryBatchId, noteAttachmentRequestInquiryBatchId), requestBytes, customHeaders);
        ...
        /// <summary>
        /// </summary>
        public static BunqResponse<object> Delete(int requestInquiryBatchId, int noteAttachmentRequestInquiryBatchId,
            ...
            var responseRaw =
                apiClient.Delete(
                    string.Format(ENDPOINT_URL_DELETE, DetermineUserId(), DetermineMonetaryAccountId(monetaryAccountId),
                        requestInquiryBatchId, noteAttachmentRequestInquiryBatchId), customHeaders);
        ...
        /// </summary>
        public static BunqResponse<List<NoteAttachmentRequestInquiryBatch>> List(int requestInquiryBatchId,
            ...
            var responseRaw =
                apiClient.Get(
                    string.Format(ENDPOINT_URL_LISTING, DetermineUserId(),
                        DetermineMonetaryAccountId(monetaryAccountId), requestInquiryBatchId), urlParams,
                    customHeaders);
        ...
        /// <summary>
        /// </summary>
        public static BunqResponse<NoteAttachmentRequestInquiryBatch> Get(int requestInquiryBatchId,
            int noteAttachmentRequestInquiryBatchId, int? monetaryAccountId = null,
            IDictionary<string, string> customHeaders = null)
        {
            if (customHeaders == null) customHeaders = new Dictionary<string, string>();
            ...
            var responseRaw =
                apiClient.Get(
                    string.Format(ENDPOINT_URL_READ, DetermineUserId(), DetermineMonetaryAccountId(monetaryAccountId),
                        requestInquiryBatchId, noteAttachmentRequestInquiryBatchId), new Dictionary<string, string>(),
                    customHeaders);
