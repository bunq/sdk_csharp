...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    public class ShareInviteBankResponse : BunqModel
    {
        ...
        /// </summary>
        public static BunqResponse<ShareInviteBankResponse> Get(int shareInviteBankResponseId,
            IDictionary<string, string> customHeaders = null)
        {
            ...
            var responseRaw =
                apiClient.Get(string.Format(ENDPOINT_URL_READ, DetermineUserId(), shareInviteBankResponseId),
        ...
        public static BunqResponse<int> Update(int shareInviteBankResponseId, string status = null,
            IDictionary<string, string> customHeaders = null)
        {
            if (customHeaders == null) customHeaders = new Dictionary<string, string>();
            ...
            var responseRaw =
                apiClient.Put(string.Format(ENDPOINT_URL_UPDATE, DetermineUserId(), shareInviteBankResponseId),
        ...
        /// </summary>
        public static BunqResponse<List<ShareInviteBankResponse>> List(IDictionary<string, string> urlParams = null,
            IDictionary<string, string> customHeaders = null)
        {
