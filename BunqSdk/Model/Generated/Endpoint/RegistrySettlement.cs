...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    public class RegistrySettlement : BunqModel
    {
        ...
        /// </summary>
        public static BunqResponse<RegistrySettlement> Get(int registryId, int registrySettlementId,
            IDictionary<string, string> customHeaders = null)
        {
            ...
            var apiClient = new ApiClient(GetApiContext());
            var responseRaw =
                apiClient.Get(string.Format(ENDPOINT_URL_READ, DetermineUserId(), registryId, registrySettlementId),
        ...
        /// </summary>
        public static BunqResponse<List<RegistrySettlement>> List(int registryId,
        ...
        public override bool IsAllFieldNull()
        {
            ...
            if (SettlementTime != null) return false;

            if (TotalAmountSpent != null) return false;

            if (NumberOfEntries != null) return false;

            if (SettledByAlias != null) return false;

            if (MembershipSettled != null) return false;
        ...
        {
            return CreateFromJsonString<RegistrySettlement>(json);
        }
    }
}