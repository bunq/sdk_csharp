...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    /// </summary>
    public class ExportStatementCardCsv : BunqModel
    {
        /// <summary>
        /// Endpoint constants.
        /// </summary>
    ...
    {FIELD_REGIONAL_FORMAT, regionalFormat},
        ...
        /// <summary>
        /// </summary>
        public static BunqResponse<ExportStatementCardCsv> Get(int cardId, int exportStatementCardCsvId, IDictionary<string, string> customHeaders = null)
        {
            if (customHeaders == null) customHeaders = new Dictionary<string, string>();
            ...
            return FromJson<ExportStatementCardCsv>(responseRaw, OBJECT_TYPE_GET);
        }
    
        /// <summary>
        /// </summary>
        public static BunqResponse<List<ExportStatementCardCsv>> List(int cardId, IDictionary<string, string> urlParams = null, IDictionary<string, string> customHeaders = null)
        {
            ...
            return FromJsonList<ExportStatementCardCsv>(responseRaw, OBJECT_TYPE_GET);
        }
        ...
        /// <summary>
        /// </summary>
        public static ExportStatementCardCsv CreateFromJsonString(string json)
        {
            return BunqModel.CreateFromJsonString<ExportStatementCardCsv>(json);
        }
    }
}
