...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    /// </summary>
    public class TokenQrRequestIdealApiObject : BunqModel
    {
        /// <summary>
        /// Endpoint constants.
        /// </summary>
        ...
        public static BunqResponse<TokenQrRequestIdealApiObject> Create(string token, IDictionary<string, string> customHeaders = null)
        {
    ...
    {FIELD_TOKEN, token},
            ...
            return FromJson<TokenQrRequestIdealApiObject>(responseRaw, OBJECT_TYPE_POST);
        }
        ...
        /// <summary>
        /// </summary>
        public static TokenQrRequestIdealApiObject CreateFromJsonString(string json)
        {
            return BunqModel.CreateFromJsonString<TokenQrRequestIdealApiObject>(json);
        }
    }
}
