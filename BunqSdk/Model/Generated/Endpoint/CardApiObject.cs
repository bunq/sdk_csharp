...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    /// </summary>
    public class CardApiObject : BunqModel
    {
        /// <summary>
        /// Endpoint constants.
        /// </summary>
    ...
    {FIELD_CANCELLATION_REASON, cancellationReason},
            ...
            return FromJson<CardApiObject>(responseRaw, OBJECT_TYPE_PUT);
        }
        ...
        public static BunqResponse<CardApiObject> Get(long cardId, IDictionary<string, string> customHeaders = null)
        {
            ...
            return FromJson<CardApiObject>(responseRaw, OBJECT_TYPE_GET);
        }
    
        /// <summary>
        /// Return all the cards available to the user.
        /// </summary>
        public static BunqResponse<List<CardApiObject>> List( IDictionary<string, string> urlParams = null, IDictionary<string, string> customHeaders = null)
        {
            ...
            return FromJsonList<CardApiObject>(responseRaw, OBJECT_TYPE_GET);
        }
        ...
        /// <summary>
        /// </summary>
        public static CardApiObject CreateFromJsonString(string json)
        {
            return BunqModel.CreateFromJsonString<CardApiObject>(json);
        }
    }
}
