...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    public class DraftShareInviteBank : BunqModel
    {
        ...
        public static BunqResponse<int> Create(string expiration, DraftShareInviteEntry draftShareSettings, string status = null, IDictionary<string, string> customHeaders = null)
        {
    ...
    {FIELD_DRAFT_SHARE_SETTINGS, draftShareSettings},
        ...
        /// </summary>
        public static BunqResponse<DraftShareInviteBank> Get(int draftShareInviteBankId, IDictionary<string, string> customHeaders = null)
        {
            if (customHeaders == null) customHeaders = new Dictionary<string, string>();
    
            var apiClient = new ApiClient(GetApiContext());
            var responseRaw = apiClient.Get(string.Format(ENDPOINT_URL_READ, DetermineUserId(), draftShareInviteBankId), new Dictionary<string, string>(), customHeaders);
        ...
        /// <param name="expiration">The moment when this draft share invite expires.</param>
        /// <param name="draftShareSettings">The draft share invite details.</param>
        public static BunqResponse<int> Update(int draftShareInviteBankId, string status = null, string expiration = null, DraftShareInviteEntry draftShareSettings = null, IDictionary<string, string> customHeaders = null)
        {
            if (customHeaders == null) customHeaders = new Dictionary<string, string>();
    ...
    {FIELD_DRAFT_SHARE_SETTINGS, draftShareSettings},
            ...
            var requestBytes = Encoding.UTF8.GetBytes(BunqJsonConvert.SerializeObject(requestMap));
            var responseRaw = apiClient.Put(string.Format(ENDPOINT_URL_UPDATE, DetermineUserId(), draftShareInviteBankId), requestBytes, customHeaders);
        ...
        /// <summary>
        /// </summary>
        public static BunqResponse<List<DraftShareInviteBank>> List( IDictionary<string, string> urlParams = null, IDictionary<string, string> customHeaders = null)
        {
