...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    /// </summary>
    public class CardGeneratedCvc2ApiObject : BunqModel
    {
        /// <summary>
        /// Endpoint constants.
        /// </summary>
    ...
    {FIELD_TYPE, type},
        ...
        public static BunqResponse<CardGeneratedCvc2ApiObject> Get(long cardId, long cardGeneratedCvc2Id, IDictionary<string, string> customHeaders = null)
        {
            ...
            var apiClient = new ApiClient(GetApiContext());
            var responseRaw = apiClient.Get(string.Format(ENDPOINT_URL_READ, DetermineUserId(), cardId, cardGeneratedCvc2Id), new Dictionary<string, string>(), customHeaders);
    
            return FromJson<CardGeneratedCvc2ApiObject>(responseRaw, OBJECT_TYPE_GET);
        }
    ...
    {FIELD_TYPE, type},
            ...
            var requestBytes = Encoding.UTF8.GetBytes(BunqJsonConvert.SerializeObject(requestMap));
            var responseRaw = apiClient.Put(string.Format(ENDPOINT_URL_UPDATE, DetermineUserId(), cardId, cardGeneratedCvc2Id), requestBytes, customHeaders);
        ...
        public static BunqResponse<List<CardGeneratedCvc2ApiObject>> List(long cardId, IDictionary<string, string> urlParams = null, IDictionary<string, string> customHeaders = null)
        {
            ...
            return FromJsonList<CardGeneratedCvc2ApiObject>(responseRaw, OBJECT_TYPE_GET);
        }
        ...
        /// <summary>
        /// </summary>
        public static CardGeneratedCvc2ApiObject CreateFromJsonString(string json)
        {
            return BunqModel.CreateFromJsonString<CardGeneratedCvc2ApiObject>(json);
        }
    }
}
