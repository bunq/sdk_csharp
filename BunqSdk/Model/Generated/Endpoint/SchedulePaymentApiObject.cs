...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    /// </summary>
    public class SchedulePaymentApiObject : BunqModel
    {
        /// <summary>
        /// Endpoint constants.
        /// </summary>
        ...
        public SchedulePaymentEntryObject Payment { get; set; }
        /// <summary>
    ...
    {FIELD_PURPOSE, purpose},
        ...
        public static BunqResponse<SchedulePaymentApiObject> Get(long schedulePaymentId, long? monetaryAccountId= null, IDictionary<string, string> customHeaders = null)
        {
            ...
            return FromJson<SchedulePaymentApiObject>(responseRaw, OBJECT_TYPE_GET);
        }
        ...
        public static BunqResponse<List<SchedulePaymentApiObject>> List(long? monetaryAccountId= null, IDictionary<string, string> urlParams = null, IDictionary<string, string> customHeaders = null)
        {
            ...
            return FromJsonList<SchedulePaymentApiObject>(responseRaw, OBJECT_TYPE_GET);
        }
    ...
    {FIELD_SCHEDULE, schedule},
            ...
            return FromJson<SchedulePaymentApiObject>(responseRaw, OBJECT_TYPE_PUT);
        }
        ...
        /// <summary>
        /// </summary>
        public static SchedulePaymentApiObject CreateFromJsonString(string json)
        {
            return BunqModel.CreateFromJsonString<SchedulePaymentApiObject>(json);
        }
    }
}
