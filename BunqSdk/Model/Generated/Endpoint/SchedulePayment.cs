...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    {FIELD_SCHEDULE, schedule},
        ...
        public static BunqResponse<object> Delete(int schedulePaymentId, int? monetaryAccountId= null, IDictionary<string, string> customHeaders = null)
        {
            ...
            var apiClient = new ApiClient(GetApiContext());
            var responseRaw = apiClient.Delete(string.Format(ENDPOINT_URL_DELETE, DetermineUserId(), DetermineMonetaryAccountId(monetaryAccountId), schedulePaymentId), customHeaders);
        ...
        /// <summary>
        /// </summary>
        public static BunqResponse<SchedulePayment> Get(int schedulePaymentId, int? monetaryAccountId= null, IDictionary<string, string> customHeaders = null)
        {
            if (customHeaders == null) customHeaders = new Dictionary<string, string>();
    
            var apiClient = new ApiClient(GetApiContext());
            var responseRaw = apiClient.Get(string.Format(ENDPOINT_URL_READ, DetermineUserId(), DetermineMonetaryAccountId(monetaryAccountId), schedulePaymentId), new Dictionary<string, string>(), customHeaders);
        ...
        /// <summary>
        /// </summary>
        public static BunqResponse<List<SchedulePayment>> List(int? monetaryAccountId= null, IDictionary<string, string> urlParams = null, IDictionary<string, string> customHeaders = null)
        {
        ...
        /// <param name="payment">The payment details.</param>
        /// <param name="schedule">The schedule details when creating or updating a scheduled payment.</param>
        public static BunqResponse<SchedulePayment> Update(int schedulePaymentId, int? monetaryAccountId= null, SchedulePaymentEntry payment = null, Schedule schedule = null, IDictionary<string, string> customHeaders = null)
        {
            if (customHeaders == null) customHeaders = new Dictionary<string, string>();
    ...
    {FIELD_SCHEDULE, schedule},
            ...
            var requestBytes = Encoding.UTF8.GetBytes(BunqJsonConvert.SerializeObject(requestMap));
            var responseRaw = apiClient.Put(string.Format(ENDPOINT_URL_UPDATE, DetermineUserId(), DetermineMonetaryAccountId(monetaryAccountId), schedulePaymentId), requestBytes, customHeaders);
