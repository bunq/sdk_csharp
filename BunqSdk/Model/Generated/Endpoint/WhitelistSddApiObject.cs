...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    /// </summary>
    public class WhitelistSddApiObject : BunqModel
    {
        /// <summary>
        /// Endpoint constants.
        /// </summary>
        ...
        /// Object type.
        /// </summary>
        private const string OBJECT_TYPE_GET = "Whitelist";
        ...
        /// </summary>
        public static BunqResponse<WhitelistSddApiObject> Get(long whitelistSddId, IDictionary<string, string> customHeaders = null)
        {
            ...
            return FromJson<WhitelistSddApiObject>(responseRaw);
        }
    
        /// <summary>
        /// Get a listing of all recurring SDD whitelist entries for a target monetary account.
        /// </summary>
        public static BunqResponse<List<WhitelistSddApiObject>> List( IDictionary<string, string> urlParams = null, IDictionary<string, string> customHeaders = null)
        {
            ...
            return FromJsonList<WhitelistSddApiObject>(responseRaw);
        }
        ...
        /// <summary>
        /// </summary>
        public static WhitelistSddApiObject CreateFromJsonString(string json)
        {
            return BunqModel.CreateFromJsonString<WhitelistSddApiObject>(json);
        }
    }
}
