...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    public class ShareInviteMonetaryAccountInquiry : BunqModel
    {
        ...
        public static BunqResponse<int> Create(Pointer counterUserAlias, ShareDetail shareDetail, string status,
            int? monetaryAccountId = null, int? draftShareInviteBankId = null, string relationship = null,
            string shareType = null, string startDate = null, string endDate = null,
        ...
        public override bool IsAllFieldNull()
        {
            ...
            if (CounterUserAlias != null) return false;
        ...
        {
            return CreateFromJsonString<ShareInviteMonetaryAccountInquiry>(json);
        }
    }
}