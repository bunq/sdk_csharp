...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    /// </summary>
    public class TransferwiseTransferApiObject : BunqModel
    {
        /// <summary>
        /// Endpoint constants.
        /// </summary>
        ...
        public TransferwiseQuoteApiObject Quote { get; set; }
    ...
    {FIELD_RECIPIENT_ID, recipientId},
        ...
        public static BunqResponse<TransferwiseTransferApiObject> Get(long transferwiseQuoteId, long transferwiseTransferId, IDictionary<string, string> customHeaders = null)
        {
            ...
            var apiClient = new ApiClient(GetApiContext());
            var responseRaw = apiClient.Get(string.Format(ENDPOINT_URL_READ, DetermineUserId(), transferwiseQuoteId, transferwiseTransferId), new Dictionary<string, string>(), customHeaders);
    
            return FromJson<TransferwiseTransferApiObject>(responseRaw, OBJECT_TYPE_GET);
        }
        ...
        public static BunqResponse<List<TransferwiseTransferApiObject>> List(long transferwiseQuoteId, IDictionary<string, string> urlParams = null, IDictionary<string, string> customHeaders = null)
        {
            ...
            return FromJsonList<TransferwiseTransferApiObject>(responseRaw, OBJECT_TYPE_GET);
        }
        ...
        /// <summary>
        /// </summary>
        public static TransferwiseTransferApiObject CreateFromJsonString(string json)
        {
            return BunqModel.CreateFromJsonString<TransferwiseTransferApiObject>(json);
        }
    }
}
