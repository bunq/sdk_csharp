...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    /// </summary>
    public class ExportAnnualOverviewContentApiObject : BunqModel
    {
        /// <summary>
        /// Endpoint constants.
        /// </summary>
        ...
        public static BunqResponse<byte[]> List(long exportAnnualOverviewId, IDictionary<string, string> customHeaders = null)
        {
            ...
            var responseRaw = apiClient.Get(string.Format(ENDPOINT_URL_LISTING, DetermineUserId(), exportAnnualOverviewId), new Dictionary<string, string>(), customHeaders);
        ...
        /// <summary>
        /// </summary>
        public static ExportAnnualOverviewContentApiObject CreateFromJsonString(string json)
        {
            return BunqModel.CreateFromJsonString<ExportAnnualOverviewContentApiObject>(json);
        }
    }
}
