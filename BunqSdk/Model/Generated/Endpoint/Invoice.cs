...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    public class Invoice : BunqModel
    {
        ...
        /// <summary>
        /// </summary>
        public static BunqResponse<List<Invoice>> List(int? monetaryAccountId= null, IDictionary<string, string> urlParams = null, IDictionary<string, string> customHeaders = null)
        {
        ...
        /// <summary>
        /// </summary>
        public static BunqResponse<Invoice> Get(int invoiceId, int? monetaryAccountId= null, IDictionary<string, string> customHeaders = null)
        {
            if (customHeaders == null) customHeaders = new Dictionary<string, string>();
