...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    /// </summary>
    public class NoteTextSchedulePaymentBatchApiObject : BunqModel
    {
        /// <summary>
        /// Endpoint constants.
        /// </summary>
        ...
        public static BunqResponse<long> Create(long schedulePaymentBatchId, long? monetaryAccountId= null, string content = null, IDictionary<string, string> customHeaders = null)
        {
    ...
    {FIELD_CONTENT, content},
        ...
        /// </summary>
        /// <param name="content">The content of the note.</param>
        public static BunqResponse<long> Update(long schedulePaymentBatchId, long noteTextSchedulePaymentBatchId, long? monetaryAccountId= null, string content = null, IDictionary<string, string> customHeaders = null)
        {
            if (customHeaders == null) customHeaders = new Dictionary<string, string>();
    ...
    {FIELD_CONTENT, content},
        ...
        /// <summary>
        /// </summary>
        public static BunqResponse<object> Delete(long schedulePaymentBatchId, long noteTextSchedulePaymentBatchId, long? monetaryAccountId= null, IDictionary<string, string> customHeaders = null)
        {
            if (customHeaders == null) customHeaders = new Dictionary<string, string>();
        ...
        /// </summary>
        public static BunqResponse<List<NoteTextSchedulePaymentBatchApiObject>> List(long schedulePaymentBatchId, long? monetaryAccountId= null, IDictionary<string, string> urlParams = null, IDictionary<string, string> customHeaders = null)
        {
            ...
            return FromJsonList<NoteTextSchedulePaymentBatchApiObject>(responseRaw, OBJECT_TYPE_GET);
        }
    
        /// <summary>
        /// </summary>
        public static BunqResponse<NoteTextSchedulePaymentBatchApiObject> Get(long schedulePaymentBatchId, long noteTextSchedulePaymentBatchId, long? monetaryAccountId= null, IDictionary<string, string> customHeaders = null)
        {
            if (customHeaders == null) customHeaders = new Dictionary<string, string>();
            ...
            return FromJson<NoteTextSchedulePaymentBatchApiObject>(responseRaw, OBJECT_TYPE_GET);
        }
        ...
        /// <summary>
        /// </summary>
        public static NoteTextSchedulePaymentBatchApiObject CreateFromJsonString(string json)
        {
            return BunqModel.CreateFromJsonString<NoteTextSchedulePaymentBatchApiObject>(json);
        }
    }
}
