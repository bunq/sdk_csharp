...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    public class SofortMerchantTransaction : BunqModel
    {
        ...
        /// <summary>
        /// </summary>
        public static BunqResponse<SofortMerchantTransaction> Get(int sofortMerchantTransactionId, int? monetaryAccountId= null, IDictionary<string, string> customHeaders = null)
        {
        ...
        /// <summary>
        /// </summary>
        public static BunqResponse<List<SofortMerchantTransaction>> List(int? monetaryAccountId= null, IDictionary<string, string> urlParams = null, IDictionary<string, string> customHeaders = null)
        {
