...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    /// PDF file format.
    /// </summary>
    public class ExportStatementCardApiObject : BunqModel
    {
        /// <summary>
        /// Endpoint constants.
        /// </summary>
        ...
        public static BunqResponse<ExportStatementCardApiObject> Get(long cardId, long exportStatementCardId, IDictionary<string, string> customHeaders = null)
        {
            ...
            return FromJson<ExportStatementCardApiObject>(responseRaw, OBJECT_TYPE_GET);
        }
        ...
        public static BunqResponse<List<ExportStatementCardApiObject>> List(long cardId, IDictionary<string, string> urlParams = null, IDictionary<string, string> customHeaders = null)
        {
            ...
            return FromJsonList<ExportStatementCardApiObject>(responseRaw, OBJECT_TYPE_GET);
        }
        ...
        /// <summary>
        /// </summary>
        public static ExportStatementCardApiObject CreateFromJsonString(string json)
        {
            return BunqModel.CreateFromJsonString<ExportStatementCardApiObject>(json);
        }
    }
}
