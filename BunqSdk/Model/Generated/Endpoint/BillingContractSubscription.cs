...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    public class BillingContractSubscription : BunqModel
    {
        ...
        public override bool IsAllFieldNull()
        {
            ...
            if (ContractDateStart != null) return false;

            if (ContractDateEnd != null) return false;

            if (ContractVersion != null) return false;

            if (SubscriptionType != null) return false;

            if (SubscriptionTypeDowngrade != null) return false;
        ...
        {
            return CreateFromJsonString<BillingContractSubscription>(json);
        }
    }
}