...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    /// </summary>
    public class BunqMeTabResultResponseApiObject : BunqModel
    {
        /// <summary>
        /// Endpoint constants.
        /// </summary>
        ...
        public static BunqResponse<BunqMeTabResultResponseApiObject> Get(long bunqMeTabResultResponseId, long? monetaryAccountId= null, IDictionary<string, string> customHeaders = null)
        {
            ...
            var responseRaw = apiClient.Get(string.Format(ENDPOINT_URL_READ, DetermineUserId(), DetermineMonetaryAccountId(monetaryAccountId), bunqMeTabResultResponseId), new Dictionary<string, string>(), customHeaders);
    
            return FromJson<BunqMeTabResultResponseApiObject>(responseRaw, OBJECT_TYPE_GET);
        }
        ...
        /// <summary>
        /// </summary>
        public static BunqMeTabResultResponseApiObject CreateFromJsonString(string json)
        {
            return BunqModel.CreateFromJsonString<BunqMeTabResultResponseApiObject>(json);
        }
    }
}
