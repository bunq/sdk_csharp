...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    /// </summary>
    public class OauthCallbackUrlApiObject : BunqModel
    {
        /// <summary>
        /// Endpoint constants.
        /// </summary>
        ...
        public static BunqResponse<OauthCallbackUrlApiObject> Get(long oauthClientId, long oauthCallbackUrlId, IDictionary<string, string> customHeaders = null)
        {
            ...
            var responseRaw = apiClient.Get(string.Format(ENDPOINT_URL_READ, DetermineUserId(), oauthClientId, oauthCallbackUrlId), new Dictionary<string, string>(), customHeaders);
    
            return FromJson<OauthCallbackUrlApiObject>(responseRaw, OBJECT_TYPE_GET);
        }
    ...
    {FIELD_URL, url},
            ...
            var requestBytes = Encoding.UTF8.GetBytes(BunqJsonConvert.SerializeObject(requestMap));
            var responseRaw = apiClient.Put(string.Format(ENDPOINT_URL_UPDATE, DetermineUserId(), oauthClientId, oauthCallbackUrlId), requestBytes, customHeaders);
        ...
        public static BunqResponse<List<OauthCallbackUrlApiObject>> List(long oauthClientId, IDictionary<string, string> urlParams = null, IDictionary<string, string> customHeaders = null)
        {
            ...
            var apiClient = new ApiClient(GetApiContext());
            var responseRaw = apiClient.Get(string.Format(ENDPOINT_URL_LISTING, DetermineUserId(), oauthClientId), urlParams, customHeaders);
    
            return FromJsonList<OauthCallbackUrlApiObject>(responseRaw, OBJECT_TYPE_GET);
        }
        ...
        public static BunqResponse<object> Delete(long oauthClientId, long oauthCallbackUrlId, IDictionary<string, string> customHeaders = null)
        {
            ...
            var apiClient = new ApiClient(GetApiContext());
            var responseRaw = apiClient.Delete(string.Format(ENDPOINT_URL_DELETE, DetermineUserId(), oauthClientId, oauthCallbackUrlId), customHeaders);
        ...
        /// <summary>
        /// </summary>
        public static OauthCallbackUrlApiObject CreateFromJsonString(string json)
        {
            return BunqModel.CreateFromJsonString<OauthCallbackUrlApiObject>(json);
        }
    }
}
