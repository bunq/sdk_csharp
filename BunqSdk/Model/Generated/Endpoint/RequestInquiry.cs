...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    public class RequestInquiry : BunqModel
    {
        ...
        /// </summary>
        /// <param name="amountInquired">
        ///     The Amount requested to be paid by the person the RequestInquiry is sent to. Must be
        ///     bigger than 0.
        /// </param>
        /// <param name="counterpartyAlias">
        ///     The Alias of the party we are requesting the money from. Can be an Alias of type EMAIL,
        ///     PHONE_NUMBER or IBAN. In case the EMAIL or PHONE_NUMBER Alias does not refer to a bunq monetary account,
        ///     'allow_bunqme' needs to be 'true' in order to trigger the creation of a bunq.me request. Otherwise no request
        ...
        ///     be unique for the same source MonetaryAccount.
        /// </param>
        /// <param name="status">
        ...
        /// </param>
        /// <param name="allowAmountLower">
        ///     [DEPRECATED] Whether or not the accepting user can choose to accept with a lower amount
        ///     than requested. Defaults to false.
        /// </param>
        /// <param name="allowAmountHigher">
        ///     [DEPRECATED] Whether or not the accepting user can choose to accept with a higher
        ///     amount than requested. Defaults to false.
        /// </param>
        ...
        public static BunqResponse<int> Create(Amount amountInquired, Pointer counterpartyAlias, string description,
            bool? allowBunqme, int? monetaryAccountId = null, List<BunqId> attachment = null,
            string merchantReference = null, string status = null, int? minimumAge = null, string requireAddress = null,
            bool? wantTip = null, bool? allowAmountLower = null, bool? allowAmountHigher = null,
            string redirectUrl = null, int? eventId = null, IDictionary<string, string> customHeaders = null)
        {
        ...
        ///     (cancelling) the RequestInquiry by setting REVOKED with a PUT request.
        /// </param>
        public static BunqResponse<RequestInquiry> Update(int requestInquiryId, int? monetaryAccountId = null,
        ...
        ///     is a bunq user.
        /// </summary>
        public static BunqResponse<List<RequestInquiry>> List(int? monetaryAccountId = null,
        ...
        /// </summary>
        public static BunqResponse<RequestInquiry> Get(int requestInquiryId, int? monetaryAccountId = null,
            ...
            var responseRaw =
                apiClient.Get(
                    string.Format(ENDPOINT_URL_READ, DetermineUserId(), DetermineMonetaryAccountId(monetaryAccountId),
                        requestInquiryId), new Dictionary<string, string>(), customHeaders);
        ...
        public override bool IsAllFieldNull()
        {
            ...
            if (TimeResponded != null) return false;

            if (TimeExpiry != null) return false;

            if (MonetaryAccountId != null) return false;

            if (AmountInquired != null) return false;

            if (AmountResponded != null) return false;

            if (UserAliasCreated != null) return false;

            if (UserAliasRevoked != null) return false;
            ...
            if (BunqmeShareUrl != null) return false;

            if (RedirectUrl != null) return false;

            if (AddressShipping != null) return false;

            if (AddressBilling != null) return false;
        ...
        {
            return CreateFromJsonString<RequestInquiry>(json);
        }
    }
}