...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    public class TabUsageMultiple : BunqModel
    {
        ...
        /// Endpoint constants.
        /// </summary>
        protected const string ENDPOINT_URL_CREATE = "user/{0}/monetary-account/{1}/cash-register/{2}/tab-usage-multiple";
        protected const string ENDPOINT_URL_UPDATE = "user/{0}/monetary-account/{1}/cash-register/{2}/tab-usage-multiple/{3}";
        protected const string ENDPOINT_URL_DELETE = "user/{0}/monetary-account/{1}/cash-register/{2}/tab-usage-multiple/{3}";
        protected const string ENDPOINT_URL_READ = "user/{0}/monetary-account/{1}/cash-register/{2}/tab-usage-multiple/{3}";
        protected const string ENDPOINT_URL_LISTING = "user/{0}/monetary-account/{1}/cash-register/{2}/tab-usage-multiple";
        ...
        public static BunqResponse<string> Create(int cashRegisterId, string description, string status, Amount amountTotal, int? monetaryAccountId= null, bool? allowAmountHigher = null, bool? allowAmountLower = null, bool? wantTip = null, int? minimumAge = null, string requireAddress = null, string redirectUrl = null, TabVisibility visibility = null, string expiration = null, List<BunqId> tabAttachment = null, IDictionary<string, string> customHeaders = null)
        {
    ...
    {FIELD_TAB_ATTACHMENT, tabAttachment},
        ...
        /// <param name="expiration">The moment when this Tab expires. Can be at most 365 days into the future.</param>
        /// <param name="tabAttachment">An array of attachments that describe the tab. Uploaded through the POST /user/{userid}/attachment-tab endpoint.</param>
        public static BunqResponse<string> Update(int cashRegisterId, string tabUsageMultipleUuid, int? monetaryAccountId= null, string status = null, Amount amountTotal = null, TabVisibility visibility = null, string expiration = null, List<BunqId> tabAttachment = null, IDictionary<string, string> customHeaders = null)
        {
            if (customHeaders == null) customHeaders = new Dictionary<string, string>();
    ...
    {FIELD_TAB_ATTACHMENT, tabAttachment},
            ...
            var requestBytes = Encoding.UTF8.GetBytes(BunqJsonConvert.SerializeObject(requestMap));
            var responseRaw = apiClient.Put(string.Format(ENDPOINT_URL_UPDATE, DetermineUserId(), DetermineMonetaryAccountId(monetaryAccountId), cashRegisterId, tabUsageMultipleUuid), requestBytes, customHeaders);
        ...
        /// </summary>
        public static BunqResponse<object> Delete(int cashRegisterId, string tabUsageMultipleUuid, int? monetaryAccountId= null, IDictionary<string, string> customHeaders = null)
        {
            if (customHeaders == null) customHeaders = new Dictionary<string, string>();
    
            var apiClient = new ApiClient(GetApiContext());
            var responseRaw = apiClient.Delete(string.Format(ENDPOINT_URL_DELETE, DetermineUserId(), DetermineMonetaryAccountId(monetaryAccountId), cashRegisterId, tabUsageMultipleUuid), customHeaders);
        ...
        /// </summary>
        public static BunqResponse<TabUsageMultiple> Get(int cashRegisterId, string tabUsageMultipleUuid, int? monetaryAccountId= null, IDictionary<string, string> customHeaders = null)
        {
            if (customHeaders == null) customHeaders = new Dictionary<string, string>();
    
            var apiClient = new ApiClient(GetApiContext());
            var responseRaw = apiClient.Get(string.Format(ENDPOINT_URL_READ, DetermineUserId(), DetermineMonetaryAccountId(monetaryAccountId), cashRegisterId, tabUsageMultipleUuid), new Dictionary<string, string>(), customHeaders);
        ...
        /// </summary>
        public static BunqResponse<List<TabUsageMultiple>> List(int cashRegisterId, int? monetaryAccountId= null, IDictionary<string, string> urlParams = null, IDictionary<string, string> customHeaders = null)
        {
