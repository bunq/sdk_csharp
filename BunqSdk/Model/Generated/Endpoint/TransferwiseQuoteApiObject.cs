...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    /// </summary>
    public class TransferwiseQuoteApiObject : BunqModel
    {
        /// <summary>
        /// Endpoint constants.
        /// </summary>
    ...
    {FIELD_AMOUNT_TARGET, amountTarget},
        ...
        public static BunqResponse<TransferwiseQuoteApiObject> Get(long transferwiseQuoteId, IDictionary<string, string> customHeaders = null)
        {
            ...
            return FromJson<TransferwiseQuoteApiObject>(responseRaw, OBJECT_TYPE_GET);
        }
        ...
        /// <summary>
        /// </summary>
        public static TransferwiseQuoteApiObject CreateFromJsonString(string json)
        {
            return BunqModel.CreateFromJsonString<TransferwiseQuoteApiObject>(json);
        }
    }
}
