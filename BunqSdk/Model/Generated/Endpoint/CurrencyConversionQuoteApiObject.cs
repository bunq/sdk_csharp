...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    /// </summary>
    public class CurrencyConversionQuoteApiObject : BunqModel
    {
        /// <summary>
        /// Endpoint constants.
        /// </summary>
    ...
    {FIELD_STATUS, status},
        ...
        public static BunqResponse<CurrencyConversionQuoteApiObject> Get(long currencyConversionQuoteId, long? monetaryAccountId= null, IDictionary<string, string> customHeaders = null)
        {
            ...
            return FromJson<CurrencyConversionQuoteApiObject>(responseRaw, OBJECT_TYPE_GET);
        }
    ...
    {FIELD_STATUS, status},
            ...
            return FromJson<CurrencyConversionQuoteApiObject>(responseRaw, OBJECT_TYPE_PUT);
        }
        ...
        /// <summary>
        /// </summary>
        public static CurrencyConversionQuoteApiObject CreateFromJsonString(string json)
        {
            return BunqModel.CreateFromJsonString<CurrencyConversionQuoteApiObject>(json);
        }
    }
}
