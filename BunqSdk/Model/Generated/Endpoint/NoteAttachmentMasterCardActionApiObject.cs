...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    /// </summary>
    public class NoteAttachmentMasterCardActionApiObject : BunqModel
    {
        /// <summary>
        /// Endpoint constants.
        /// </summary>
        ...
        public static BunqResponse<long> Create(long mastercardActionId, string description, long? attachmentId, long? monetaryAccountId= null, IDictionary<string, string> customHeaders = null)
        {
    ...
    {FIELD_ATTACHMENT_ID, attachmentId},
        ...
        /// </summary>
        /// <param name="description">Optional description of the attachment.</param>
        public static BunqResponse<long> Update(long mastercardActionId, long noteAttachmentMasterCardActionId, long? monetaryAccountId= null, string description = null, IDictionary<string, string> customHeaders = null)
        {
            if (customHeaders == null) customHeaders = new Dictionary<string, string>();
    ...
    {FIELD_DESCRIPTION, description},
        ...
        /// <summary>
        /// </summary>
        public static BunqResponse<object> Delete(long mastercardActionId, long noteAttachmentMasterCardActionId, long? monetaryAccountId= null, IDictionary<string, string> customHeaders = null)
        {
            if (customHeaders == null) customHeaders = new Dictionary<string, string>();
        ...
        /// </summary>
        public static BunqResponse<List<NoteAttachmentMasterCardActionApiObject>> List(long mastercardActionId, long? monetaryAccountId= null, IDictionary<string, string> urlParams = null, IDictionary<string, string> customHeaders = null)
        {
            ...
            return FromJsonList<NoteAttachmentMasterCardActionApiObject>(responseRaw, OBJECT_TYPE_GET);
        }
    
        /// <summary>
        /// </summary>
        public static BunqResponse<NoteAttachmentMasterCardActionApiObject> Get(long mastercardActionId, long noteAttachmentMasterCardActionId, long? monetaryAccountId= null, IDictionary<string, string> customHeaders = null)
        {
            if (customHeaders == null) customHeaders = new Dictionary<string, string>();
            ...
            return FromJson<NoteAttachmentMasterCardActionApiObject>(responseRaw, OBJECT_TYPE_GET);
        }
        ...
        /// <summary>
        /// </summary>
        public static NoteAttachmentMasterCardActionApiObject CreateFromJsonString(string json)
        {
            return BunqModel.CreateFromJsonString<NoteAttachmentMasterCardActionApiObject>(json);
        }
    }
}
