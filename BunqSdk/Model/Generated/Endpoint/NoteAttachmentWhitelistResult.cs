...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    public class NoteAttachmentWhitelistResult : BunqModel
    {
        ...
        protected const string ENDPOINT_URL_CREATE =
            "user/{0}/monetary-account/{1}/whitelist/{2}/whitelist-result/{3}/note-attachment";

        protected const string ENDPOINT_URL_UPDATE =
            "user/{0}/monetary-account/{1}/whitelist/{2}/whitelist-result/{3}/note-attachment/{4}";
        ...
        public static BunqResponse<int> Create(int whitelistId, int whitelistResultId, int? attachmentId,
        ...
        /// <summary>
        /// </summary>
        public static BunqResponse<object> Delete(int whitelistId, int whitelistResultId,
            int noteAttachmentWhitelistResultId, int? monetaryAccountId = null,
            IDictionary<string, string> customHeaders = null)
        {
            if (customHeaders == null) customHeaders = new Dictionary<string, string>();
            ...
            var responseRaw =
                apiClient.Delete(
                    string.Format(ENDPOINT_URL_DELETE, DetermineUserId(), DetermineMonetaryAccountId(monetaryAccountId),
                        whitelistId, whitelistResultId, noteAttachmentWhitelistResultId), customHeaders);
        ...
        /// </summary>
        public static BunqResponse<List<NoteAttachmentWhitelistResult>> List(int whitelistId, int whitelistResultId,
        ...
        /// <summary>
        /// </summary>
        public static BunqResponse<NoteAttachmentWhitelistResult> Get(int whitelistId, int whitelistResultId,
            int noteAttachmentWhitelistResultId, int? monetaryAccountId = null,
            IDictionary<string, string> customHeaders = null)
        {
            if (customHeaders == null) customHeaders = new Dictionary<string, string>();
            ...
            var responseRaw = apiClient.Get(
                string.Format(ENDPOINT_URL_READ, DetermineUserId(), DetermineMonetaryAccountId(monetaryAccountId),
                    whitelistId, whitelistResultId, noteAttachmentWhitelistResultId), new Dictionary<string, string>(),
                customHeaders);
        ...
        {
            return CreateFromJsonString<NoteAttachmentWhitelistResult>(json);
        }
    }
}