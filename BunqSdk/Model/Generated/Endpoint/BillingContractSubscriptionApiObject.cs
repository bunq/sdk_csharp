...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    /// </summary>
    public class BillingContractSubscriptionApiObject : BunqModel
    {
        /// <summary>
        /// Endpoint constants.
        /// </summary>
        ...
        /// </summary>
        public static BunqResponse<List<BillingContractSubscriptionApiObject>> List( IDictionary<string, string> urlParams = null, IDictionary<string, string> customHeaders = null)
        {
            ...
            return FromJsonList<BillingContractSubscriptionApiObject>(responseRaw, OBJECT_TYPE_GET);
        }
        ...
        /// <summary>
        /// </summary>
        public static BillingContractSubscriptionApiObject CreateFromJsonString(string json)
        {
            return BunqModel.CreateFromJsonString<BillingContractSubscriptionApiObject>(json);
        }
    }
}
