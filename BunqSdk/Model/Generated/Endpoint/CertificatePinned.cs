...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    public class CertificatePinned : BunqModel
    {
        ...
        public static BunqResponse<int> Create(List<Certificate> certificateChain, IDictionary<string, string> customHeaders = null)
        {
    ...
    {FIELD_CERTIFICATE_CHAIN, certificateChain},
        ...
        /// </summary>
        public static BunqResponse<List<CertificatePinned>> List( IDictionary<string, string> urlParams = null, IDictionary<string, string> customHeaders = null)
        {
        ...
        /// </summary>
        public static BunqResponse<CertificatePinned> Get(int certificatePinnedId, IDictionary<string, string> customHeaders = null)
        {
            if (customHeaders == null) customHeaders = new Dictionary<string, string>();
