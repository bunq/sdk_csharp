...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    /// </summary>
    public class NotificationFilterUrlMonetaryAccountApiObject : BunqModel
    {
        /// <summary>
        /// Endpoint constants.
        /// </summary>
    ...
    {FIELD_NOTIFICATION_FILTERS, notificationFilters},
        ...
        public static BunqResponse<List<NotificationFilterUrlMonetaryAccountApiObject>> List(long? monetaryAccountId= null, IDictionary<string, string> urlParams = null, IDictionary<string, string> customHeaders = null)
        {
            ...
            return FromJsonList<NotificationFilterUrlMonetaryAccountApiObject>(responseRaw, OBJECT_TYPE_GET);
        }
        ...
        /// <summary>
        /// </summary>
        public static NotificationFilterUrlMonetaryAccountApiObject CreateFromJsonString(string json)
        {
            return BunqModel.CreateFromJsonString<NotificationFilterUrlMonetaryAccountApiObject>(json);
        }
    }
}
