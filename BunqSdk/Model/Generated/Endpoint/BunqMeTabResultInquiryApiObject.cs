...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    /// </summary>
    public class BunqMeTabResultInquiryApiObject : BunqModel
    {
        /// <summary>
        ...
        /// <summary>
        /// </summary>
        public static BunqMeTabResultInquiryApiObject CreateFromJsonString(string json)
        {
            return BunqModel.CreateFromJsonString<BunqMeTabResultInquiryApiObject>(json);
        }
    }
}
