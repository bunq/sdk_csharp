...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    /// </summary>
    public class DeviceServerApiObject : BunqModel
    {
        /// <summary>
        /// Endpoint constants.
        /// </summary>
    ...
    {FIELD_PERMITTED_IPS, permittedIps},
        ...
        public static BunqResponse<DeviceServerApiObject> Get(long deviceServerId, IDictionary<string, string> customHeaders = null)
        {
            ...
            return FromJson<DeviceServerApiObject>(responseRaw, OBJECT_TYPE_GET);
        }
    
        /// <summary>
        /// Get a collection of all the DeviceServers you have created.
        /// </summary>
        public static BunqResponse<List<DeviceServerApiObject>> List( IDictionary<string, string> urlParams = null, IDictionary<string, string> customHeaders = null)
        {
            ...
            return FromJsonList<DeviceServerApiObject>(responseRaw, OBJECT_TYPE_GET);
        }
        ...
        /// <summary>
        /// </summary>
        public static DeviceServerApiObject CreateFromJsonString(string json)
        {
            return BunqModel.CreateFromJsonString<DeviceServerApiObject>(json);
        }
    }
}
