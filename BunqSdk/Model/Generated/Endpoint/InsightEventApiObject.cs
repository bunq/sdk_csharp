...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    /// </summary>
    public class InsightEventApiObject : BunqModel
    {
        /// <summary>
        /// Endpoint constants.
        /// </summary>
        ...
        /// <summary>
        /// </summary>
        public static BunqResponse<List<InsightEventApiObject>> List( IDictionary<string, string> urlParams = null, IDictionary<string, string> customHeaders = null)
        {
            ...
            return FromJsonList<InsightEventApiObject>(responseRaw, OBJECT_TYPE_GET);
        }
        ...
        /// <summary>
        /// </summary>
        public static InsightEventApiObject CreateFromJsonString(string json)
        {
            return BunqModel.CreateFromJsonString<InsightEventApiObject>(json);
        }
    }
}
