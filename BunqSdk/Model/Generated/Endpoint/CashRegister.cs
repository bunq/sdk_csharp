...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    ///     our Quickstart example to learn how you can easily
    ///     <a href="/api/1/page/usecase-tab-payment">
    ///         create Tab
    ///         payments
    ///     </a>
    ///     .<br /><br />Notification filters can be set on a CashRegister to receive callbacks. For more
    ...
    public class CashRegister : BunqModel
    {
        ...
        public override bool IsAllFieldNull()
        {
            ...
            if (TabTextWaitingScreen != null) return false;
