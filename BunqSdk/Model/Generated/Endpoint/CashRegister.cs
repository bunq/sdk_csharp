...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    public class CashRegister : BunqModel
    {
        ...
        public static BunqResponse<int> Create(string name, string status, string avatarUuid, int? monetaryAccountId= null, Geolocation location = null, List<TabTextWaitingScreen> tabTextWaitingScreen = null, IDictionary<string, string> customHeaders = null)
        {
    ...
    {FIELD_TAB_TEXT_WAITING_SCREEN, tabTextWaitingScreen},
        ...
        /// <param name="location">The geolocation of the CashRegister.</param>
        /// <param name="tabTextWaitingScreen">The tab text for waiting screen of CashRegister.</param>
        public static BunqResponse<int> Update(int cashRegisterId, int? monetaryAccountId= null, string name = null, string status = null, string avatarUuid = null, Geolocation location = null, List<TabTextWaitingScreen> tabTextWaitingScreen = null, IDictionary<string, string> customHeaders = null)
        {
            if (customHeaders == null) customHeaders = new Dictionary<string, string>();
