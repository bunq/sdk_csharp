...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    public class CashRegister : BunqModel
    {
        ...
        public static BunqResponse<int> Create(string name, string status, string avatarUuid, int? monetaryAccountId= null, Geolocation location = null, List<NotificationFilter> notificationFilters = null, List<TabTextWaitingScreen> tabTextWaitingScreen = null, IDictionary<string, string> customHeaders = null)
        {
    ...
    {FIELD_TAB_TEXT_WAITING_SCREEN, tabTextWaitingScreen},
        ...
        /// </summary>
        public static BunqResponse<CashRegister> Get(int cashRegisterId, int? monetaryAccountId= null, IDictionary<string, string> customHeaders = null)
        {
            if (customHeaders == null) customHeaders = new Dictionary<string, string>();
    
            var apiClient = new ApiClient(GetApiContext());
            var responseRaw = apiClient.Get(string.Format(ENDPOINT_URL_READ, DetermineUserId(), DetermineMonetaryAccountId(monetaryAccountId), cashRegisterId), new Dictionary<string, string>(), customHeaders);
        ...
        /// <param name="notificationFilters">The types of notifications that will result in a push notification or URL callback for this CashRegister.</param>
        /// <param name="tabTextWaitingScreen">The tab text for waiting screen of CashRegister.</param>
        public static BunqResponse<int> Update(int cashRegisterId, int? monetaryAccountId= null, string name = null, string status = null, string avatarUuid = null, Geolocation location = null, List<NotificationFilter> notificationFilters = null, List<TabTextWaitingScreen> tabTextWaitingScreen = null, IDictionary<string, string> customHeaders = null)
        {
            if (customHeaders == null) customHeaders = new Dictionary<string, string>();
    ...
    {FIELD_TAB_TEXT_WAITING_SCREEN, tabTextWaitingScreen},
            ...
            var requestBytes = Encoding.UTF8.GetBytes(BunqJsonConvert.SerializeObject(requestMap));
            var responseRaw = apiClient.Put(string.Format(ENDPOINT_URL_UPDATE, DetermineUserId(), DetermineMonetaryAccountId(monetaryAccountId), cashRegisterId), requestBytes, customHeaders);
        ...
        /// </summary>
        public static BunqResponse<List<CashRegister>> List(int? monetaryAccountId= null, IDictionary<string, string> urlParams = null, IDictionary<string, string> customHeaders = null)
        {
