...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    /// </summary>
    public class IdealMerchantTransactionApiObject : BunqModel
    {
        /// <summary>
        /// Endpoint constants.
        /// </summary>
    ...
    {FIELD_ISSUER, issuer},
        ...
        public static BunqResponse<IdealMerchantTransactionApiObject> Get(long idealMerchantTransactionId, long? monetaryAccountId= null, IDictionary<string, string> customHeaders = null)
        {
            ...
            return FromJson<IdealMerchantTransactionApiObject>(responseRaw, OBJECT_TYPE_GET);
        }
        ...
        public static BunqResponse<List<IdealMerchantTransactionApiObject>> List(long? monetaryAccountId= null, IDictionary<string, string> urlParams = null, IDictionary<string, string> customHeaders = null)
        {
            ...
            return FromJsonList<IdealMerchantTransactionApiObject>(responseRaw, OBJECT_TYPE_GET);
        }
        ...
        /// <summary>
        /// </summary>
        public static IdealMerchantTransactionApiObject CreateFromJsonString(string json)
        {
            return BunqModel.CreateFromJsonString<IdealMerchantTransactionApiObject>(json);
        }
    }
}
