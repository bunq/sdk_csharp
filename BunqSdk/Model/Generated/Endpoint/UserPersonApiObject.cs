...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    /// </summary>
    public class UserPersonApiObject : BunqModel
    {
        /// <summary>
        /// Endpoint constants.
        /// </summary>
        ...
        /// </summary>
        public static BunqResponse<UserPersonApiObject> Get( IDictionary<string, string> customHeaders = null)
        {
            ...
            return FromJson<UserPersonApiObject>(responseRaw, OBJECT_TYPE_GET);
        }
    ...
    {FIELD_DISPLAY_NAME, displayName},
        ...
        /// <summary>
        /// </summary>
        public static UserPersonApiObject CreateFromJsonString(string json)
        {
            return BunqModel.CreateFromJsonString<UserPersonApiObject>(json);
        }
    }
}
