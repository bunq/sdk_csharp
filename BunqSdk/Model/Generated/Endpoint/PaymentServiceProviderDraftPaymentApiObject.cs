...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    /// </summary>
    public class PaymentServiceProviderDraftPaymentApiObject : BunqModel
    {
        /// <summary>
        /// Endpoint constants.
        /// </summary>
    ...
    {FIELD_STATUS, status},
            ...
            var requestBytes = Encoding.UTF8.GetBytes(BunqJsonConvert.SerializeObject(requestMap));
            var responseRaw = apiClient.Put(string.Format(ENDPOINT_URL_UPDATE, DetermineUserId(), paymentServiceProviderDraftPaymentId), requestBytes, customHeaders);
        ...
        /// <summary>
        /// </summary>
        public static BunqResponse<List<PaymentServiceProviderDraftPaymentApiObject>> List( IDictionary<string, string> urlParams = null, IDictionary<string, string> customHeaders = null)
        {
            ...
            return FromJsonList<PaymentServiceProviderDraftPaymentApiObject>(responseRaw, OBJECT_TYPE_GET);
        }
        ...
        public static BunqResponse<PaymentServiceProviderDraftPaymentApiObject> Get(long paymentServiceProviderDraftPaymentId, IDictionary<string, string> customHeaders = null)
        {
            ...
            var apiClient = new ApiClient(GetApiContext());
            var responseRaw = apiClient.Get(string.Format(ENDPOINT_URL_READ, DetermineUserId(), paymentServiceProviderDraftPaymentId), new Dictionary<string, string>(), customHeaders);
    
            return FromJson<PaymentServiceProviderDraftPaymentApiObject>(responseRaw, OBJECT_TYPE_GET);
        }
        ...
        /// <summary>
        /// </summary>
        public static PaymentServiceProviderDraftPaymentApiObject CreateFromJsonString(string json)
        {
            return BunqModel.CreateFromJsonString<PaymentServiceProviderDraftPaymentApiObject>(json);
        }
    }
}
