...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    {FIELD_SIGNUP_TRACK_TYPE, signupTrackType},
        ...
        /// <summary>
        /// </summary>
        public static BunqResponse<List<Company>> List( IDictionary<string, string> urlParams = null, IDictionary<string, string> customHeaders = null)
        {
    ...
    {FIELD_AVATAR_UUID, avatarUuid},
        ...
        {
            return BunqModel.CreateFromJsonString<Company>(json);
        }
    }
}
