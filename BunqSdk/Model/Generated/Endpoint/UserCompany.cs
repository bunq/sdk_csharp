...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    public class UserCompany : BunqModel
    {
        ...
        /// </summary>
        public static BunqResponse<UserCompany> Get(ApiContext apiContext, int userCompanyId, IDictionary<string, string> customHeaders = null)
        {
        ...
        /// </summary>
        public static BunqResponse<int> Update(ApiContext apiContext, IDictionary<string, object> requestMap, int userCompanyId, IDictionary<string, string> customHeaders = null)
        {
            if (customHeaders == null) customHeaders = new Dictionary<string, string>();
