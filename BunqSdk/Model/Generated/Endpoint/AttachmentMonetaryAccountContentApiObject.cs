...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    /// </summary>
    public class AttachmentMonetaryAccountContentApiObject : BunqModel
    {
        /// <summary>
        /// Endpoint constants.
        /// </summary>
        ...
        /// <summary>
        /// </summary>
        public static AttachmentMonetaryAccountContentApiObject CreateFromJsonString(string json)
        {
            return BunqModel.CreateFromJsonString<AttachmentMonetaryAccountContentApiObject>(json);
        }
    }
}
