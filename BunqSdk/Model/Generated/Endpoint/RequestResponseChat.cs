...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    public class RequestResponseChat : BunqModel
    {
        ...
        /// Endpoint constants.
        /// </summary>
        private const string EndpointUrlCreate = "user/{0}/monetary-account/{1}/request-response/{2}/chat";
        private const string EndpointUrlUpdate = "user/{0}/monetary-account/{1}/request-response/{2}/chat/{3}";
        private const string EndpointUrlListing = "user/{0}/monetary-account/{1}/request-response/{2}/chat";
        ...
        /// Object type.
        /// </summary>
        private const string ObjectType = "RequestResponseChat";
        ...
        public static BunqResponse<int> Create(ApiContext apiContext, IDictionary<string, object> requestMap, int userId, int monetaryAccountId, int requestResponseId, IDictionary<string, string> customHeaders = null)
        {
            ...
            var responseRaw = apiClient.Post(string.Format(EndpointUrlCreate, userId, monetaryAccountId, requestResponseId), requestBytes, customHeaders);
        ...
        public static BunqResponse<RequestResponseChat> Update(ApiContext apiContext, IDictionary<string, object> requestMap, int userId, int monetaryAccountId, int requestResponseId, int requestResponseChatId, IDictionary<string, string> customHeaders = null)
        {
            ...
            var apiClient = new ApiClient(apiContext);
            var requestBytes = Encoding.UTF8.GetBytes(BunqJsonConvert.SerializeObject(requestMap));
            var responseRaw = apiClient.Put(string.Format(EndpointUrlUpdate, userId, monetaryAccountId, requestResponseId, requestResponseChatId), requestBytes, customHeaders);
    
            return FromJson<RequestResponseChat>(responseRaw, ObjectType);
        }
        ...
        public static BunqResponse<List<RequestResponseChat>> List(ApiContext apiContext, int userId, int monetaryAccountId, int requestResponseId, IDictionary<string, string> urlParams = null, IDictionary<string, string> customHeaders = null)
        {
            ...
            var apiClient = new ApiClient(apiContext);
            var responseRaw = apiClient.Get(string.Format(EndpointUrlListing, userId, monetaryAccountId, requestResponseId), urlParams, customHeaders);
    
            return FromJsonList<RequestResponseChat>(responseRaw, ObjectType);
        }
