...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    public class RequestResponseChat : BunqModel
    {
        ...
        /// Endpoint constants.
        /// </summary>
        protected const string ENDPOINT_URL_CREATE = "user/{0}/monetary-account/{1}/request-response/{2}/chat";

        protected const string ENDPOINT_URL_UPDATE = "user/{0}/monetary-account/{1}/request-response/{2}/chat/{3}";
        protected const string ENDPOINT_URL_LISTING = "user/{0}/monetary-account/{1}/request-response/{2}/chat";
        ...
        /// </summary>
        /// <param name="lastReadMessageId">The id of the last read message.</param>
        public static BunqResponse<int> Update(int requestResponseId, int requestResponseChatId,
            ...
            var responseRaw =
                apiClient.Put(
                    string.Format(ENDPOINT_URL_UPDATE, DetermineUserId(), DetermineMonetaryAccountId(monetaryAccountId),
                        requestResponseId, requestResponseChatId), requestBytes, customHeaders);
        ...
        /// </summary>
        public static BunqResponse<List<RequestResponseChat>> List(int requestResponseId, int? monetaryAccountId = null,
