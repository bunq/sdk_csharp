...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    public class ExportRib : BunqModel
    {
        ...
        /// Create a new RIB.
        /// </summary>
        public static BunqResponse<int> Create(int? monetaryAccountId= null, IDictionary<string, string> customHeaders = null)
        {
            ...
            var requestMap = new Dictionary<string, object>
    {
        ...
        /// </summary>
        public static BunqResponse<ExportRib> Get(int exportRibId, int? monetaryAccountId= null, IDictionary<string, string> customHeaders = null)
        {
            if (customHeaders == null) customHeaders = new Dictionary<string, string>();
        ...
        /// <summary>
        /// </summary>
        public static BunqResponse<object> Delete(int exportRibId, int? monetaryAccountId= null, IDictionary<string, string> customHeaders = null)
        {
            if (customHeaders == null) customHeaders = new Dictionary<string, string>();
        ...
        /// </summary>
        public static BunqResponse<List<ExportRib>> List(int? monetaryAccountId= null, IDictionary<string, string> urlParams = null, IDictionary<string, string> customHeaders = null)
        {
        ...
        {
            return BunqModel.CreateFromJsonString<ExportRib>(json);
        }
    }
}
