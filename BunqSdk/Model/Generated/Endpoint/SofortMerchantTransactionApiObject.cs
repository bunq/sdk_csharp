...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    /// </summary>
    public class SofortMerchantTransactionApiObject : BunqModel
    {
        /// <summary>
        /// Endpoint constants.
        /// </summary>
        ...
        public AmountObject AmountRequested { get; set; }
        /// <summary>
        ...
        public AmountObject AmountGuaranteed { get; set; }
        /// <summary>
        /// The URL to visit to 
        /// </summary>
        ...
        public static BunqResponse<SofortMerchantTransactionApiObject> Get(long sofortMerchantTransactionId, long? monetaryAccountId= null, IDictionary<string, string> customHeaders = null)
        {
            ...
            var responseRaw = apiClient.Get(string.Format(ENDPOINT_URL_READ, DetermineUserId(), DetermineMonetaryAccountId(monetaryAccountId), sofortMerchantTransactionId), new Dictionary<string, string>(), customHeaders);
    
            return FromJson<SofortMerchantTransactionApiObject>(responseRaw, OBJECT_TYPE_GET);
        }
        ...
        public static BunqResponse<List<SofortMerchantTransactionApiObject>> List(long? monetaryAccountId= null, IDictionary<string, string> urlParams = null, IDictionary<string, string> customHeaders = null)
        {
            ...
            return FromJsonList<SofortMerchantTransactionApiObject>(responseRaw, OBJECT_TYPE_GET);
        }
        ...
        /// <summary>
        /// </summary>
        public static SofortMerchantTransactionApiObject CreateFromJsonString(string json)
        {
            return BunqModel.CreateFromJsonString<SofortMerchantTransactionApiObject>(json);
        }
    }
}
