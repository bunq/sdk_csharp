...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    public class IdealMerchantTransaction : BunqModel
    {
        ...
        public static BunqResponse<int> Create(Amount amountRequested, string issuer, int? monetaryAccountId= null, IDictionary<string, string> customHeaders = null)
        {
    ...
    {FIELD_ISSUER, issuer},
        ...
        /// <summary>
        /// </summary>
        public static BunqResponse<IdealMerchantTransaction> Get(int idealMerchantTransactionId, int? monetaryAccountId= null, IDictionary<string, string> customHeaders = null)
        {
            if (customHeaders == null) customHeaders = new Dictionary<string, string>();
    
            var apiClient = new ApiClient(GetApiContext());
            var responseRaw = apiClient.Get(string.Format(ENDPOINT_URL_READ, DetermineUserId(), DetermineMonetaryAccountId(monetaryAccountId), idealMerchantTransactionId), new Dictionary<string, string>(), customHeaders);
        ...
        /// <summary>
        /// </summary>
        public static BunqResponse<List<IdealMerchantTransaction>> List(int? monetaryAccountId= null, IDictionary<string, string> urlParams = null, IDictionary<string, string> customHeaders = null)
        {
