...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    public class PaymentServiceProviderCredential : BunqModel
    {
        ...
        /// <param name="clientPaymentServiceProviderCertificateChain">
        ///     Intermediate and root certificate belonging to the provided
        ///     certificate.
        /// </param>
        /// <param name="clientPublicKeySignature">
        ///     The Base64 encoded signature of the public key provided during installation and
        ///     with the installation token appended as a nonce. Signed with the private key belonging to the QSEAL certificate.
        /// </param>
        ...
        {
            return CreateFromJsonString<PaymentServiceProviderCredential>(json);
        }
    }
}