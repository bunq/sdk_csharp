...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    public class AttachmentTabContent : BunqModel
    {
        ...
        /// Endpoint constants.
        /// </summary>
        private const string EndpointUrlListing = "user/{0}/monetary-account/{1}/attachment-tab/{2}/content";
    
        /// <summary>
        /// Object type.
        /// </summary>
        private const string ObjectType = "AttachmentTabContent";
        ...
        public static BunqResponse<byte[]> List(ApiContext apiContext, int userId, int monetaryAccountId, int attachmentTabId, IDictionary<string, string> customHeaders = null)
        {
            ...
            var responseRaw = apiClient.Get(string.Format(EndpointUrlListing, userId, monetaryAccountId, attachmentTabId), new Dictionary<string, string>(), customHeaders);
