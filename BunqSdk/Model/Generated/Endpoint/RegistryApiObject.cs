...
{
    /// <summary>
    /// Initially used to manage Slice groups, now it is used to manage Tricounts
    /// </summary>
    public class RegistryApiObject : BunqModel
    {
        /// <summary>
        /// Field constants.
        /// </summary>
        ...
        public long? LastRegistryEntrySeenId { get; set; }
        /// <summary>
        ...
        public List<RegistryMembershipApiObject> Memberships { get; set; }
        /// <summary>
        /// Previous list of memberships.
        /// </summary>
        [JsonProperty(PropertyName = "memberships_previous")]
        public List<RegistryMembershipApiObject> MembershipsPrevious { get; set; }
        /// <summary>
        ...
        public RegistryMembershipSettingObject MembershipSetting { get; set; }
        /// <summary>
        ...
        public RegistrySettingApiObject Setting { get; set; }
        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "all_registry_entry")]
        public List<RegistryEntryApiObject> AllRegistryEntry { get; set; }
        /// <summary>
        ...
        public AmountObject TotalAmountSpent { get; set; }
        /// <summary>
        ...
        public long? LastSettlementId { get; set; }
        /// <summary>
        ...
        public List<RegistryGalleryAttachmentApiObject> AllRegistryGalleryAttachment { get; set; }
        ...
        /// <summary>
        /// </summary>
        public static RegistryApiObject CreateFromJsonString(string json)
        {
            return BunqModel.CreateFromJsonString<RegistryApiObject>(json);
        }
    }
}
