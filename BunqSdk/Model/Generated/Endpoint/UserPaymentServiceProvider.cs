...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    public class UserPaymentServiceProvider : BunqModel
    {
        ...
        /// <summary>
        /// </summary>
        public static BunqResponse<UserPaymentServiceProvider> Get(int userPaymentServiceProviderId, IDictionary<string, string> customHeaders = null)
        {
        ...
        {
            return BunqModel.CreateFromJsonString<UserPaymentServiceProvider>(json);
        }
    }
}
