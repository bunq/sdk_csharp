...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    public class PaymentBatch : BunqModel
    {
        ...
        public static BunqResponse<int> Create(List<Payment> payments, int? monetaryAccountId= null, IDictionary<string, string> customHeaders = null)
        {
    ...
    {FIELD_PAYMENTS, payments},
        ...
        /// </summary>
        public static BunqResponse<int> Update(int paymentBatchId, int? monetaryAccountId= null, IDictionary<string, string> customHeaders = null)
        {
            if (customHeaders == null) customHeaders = new Dictionary<string, string>();
            ...
            var requestMap = new Dictionary<string, object>
    {
        ...
        /// </summary>
        public static BunqResponse<PaymentBatch> Get(int paymentBatchId, int? monetaryAccountId= null, IDictionary<string, string> customHeaders = null)
        {
            if (customHeaders == null) customHeaders = new Dictionary<string, string>();
        ...
        /// </summary>
        public static BunqResponse<List<PaymentBatch>> List(int? monetaryAccountId= null, IDictionary<string, string> urlParams = null, IDictionary<string, string> customHeaders = null)
        {
