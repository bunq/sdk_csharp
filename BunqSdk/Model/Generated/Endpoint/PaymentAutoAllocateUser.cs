...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    public class PaymentAutoAllocateUser : BunqModel, IAnchorObjectInterface
    {
        ...
        {
            if (PaymentAutoAllocate != null) return PaymentAutoAllocate;
        ...
        {
            if (PaymentAutoAllocate != null) return false;
        ...
        {
            return CreateFromJsonString<PaymentAutoAllocateUser>(json);
        }
    }
}