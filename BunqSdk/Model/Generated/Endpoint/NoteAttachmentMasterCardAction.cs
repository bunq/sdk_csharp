...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    public class NoteAttachmentMasterCardAction : BunqModel
    {
        ...
        protected const string ENDPOINT_URL_CREATE =
            "user/{0}/monetary-account/{1}/mastercard-action/{2}/note-attachment";

        protected const string ENDPOINT_URL_UPDATE =
            "user/{0}/monetary-account/{1}/mastercard-action/{2}/note-attachment/{3}";
        ...
        public static BunqResponse<int> Create(int mastercardActionId, int? attachmentId, int? monetaryAccountId = null,
            ...
            var responseRaw =
                apiClient.Post(
                    string.Format(ENDPOINT_URL_CREATE, DetermineUserId(), DetermineMonetaryAccountId(monetaryAccountId),
                        mastercardActionId), requestBytes, customHeaders);
        ...
        /// </summary>
        /// <param name="description">Optional description of the attachment.</param>
        public static BunqResponse<int> Update(int mastercardActionId, int noteAttachmentMasterCardActionId,
            ...
            var responseRaw =
                apiClient.Put(
                    string.Format(ENDPOINT_URL_UPDATE, DetermineUserId(), DetermineMonetaryAccountId(monetaryAccountId),
                        mastercardActionId, noteAttachmentMasterCardActionId), requestBytes, customHeaders);
        ...
        /// <summary>
        /// </summary>
        public static BunqResponse<object> Delete(int mastercardActionId, int noteAttachmentMasterCardActionId,
            ...
            var responseRaw =
                apiClient.Delete(
                    string.Format(ENDPOINT_URL_DELETE, DetermineUserId(), DetermineMonetaryAccountId(monetaryAccountId),
                        mastercardActionId, noteAttachmentMasterCardActionId), customHeaders);
        ...
        /// </summary>
        public static BunqResponse<List<NoteAttachmentMasterCardAction>> List(int mastercardActionId,
            ...
            var responseRaw =
                apiClient.Get(
                    string.Format(ENDPOINT_URL_LISTING, DetermineUserId(),
                        DetermineMonetaryAccountId(monetaryAccountId), mastercardActionId), urlParams, customHeaders);
        ...
        /// <summary>
        /// </summary>
        public static BunqResponse<NoteAttachmentMasterCardAction> Get(int mastercardActionId,
            int noteAttachmentMasterCardActionId, int? monetaryAccountId = null,
            IDictionary<string, string> customHeaders = null)
        {
            if (customHeaders == null) customHeaders = new Dictionary<string, string>();
            ...
            var responseRaw =
                apiClient.Get(
                    string.Format(ENDPOINT_URL_READ, DetermineUserId(), DetermineMonetaryAccountId(monetaryAccountId),
                        mastercardActionId, noteAttachmentMasterCardActionId), new Dictionary<string, string>(),
                    customHeaders);
        ...
        {
            return CreateFromJsonString<NoteAttachmentMasterCardAction>(json);
        }
    }
}