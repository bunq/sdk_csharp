...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    public class NoteAttachmentPayment : BunqModel
    {
        ...
        public static BunqResponse<int> Create(int paymentId, int? attachmentId, int? monetaryAccountId = null,
        ...
        /// </summary>
        /// <param name="description">Optional description of the attachment.</param>
        public static BunqResponse<int> Update(int paymentId, int noteAttachmentPaymentId,
            ...
            var responseRaw =
                apiClient.Put(
                    string.Format(ENDPOINT_URL_UPDATE, DetermineUserId(), DetermineMonetaryAccountId(monetaryAccountId),
                        paymentId, noteAttachmentPaymentId), requestBytes, customHeaders);
        ...
        /// <summary>
        /// </summary>
        public static BunqResponse<object> Delete(int paymentId, int noteAttachmentPaymentId,
            ...
            var responseRaw =
                apiClient.Delete(
                    string.Format(ENDPOINT_URL_DELETE, DetermineUserId(), DetermineMonetaryAccountId(monetaryAccountId),
                        paymentId, noteAttachmentPaymentId), customHeaders);
        ...
        /// <summary>
        /// </summary>
        public static BunqResponse<NoteAttachmentPayment> Get(int paymentId, int noteAttachmentPaymentId,
            int? monetaryAccountId = null, IDictionary<string, string> customHeaders = null)
        {
            if (customHeaders == null) customHeaders = new Dictionary<string, string>();
            ...
            var responseRaw =
                apiClient.Get(
                    string.Format(ENDPOINT_URL_READ, DetermineUserId(), DetermineMonetaryAccountId(monetaryAccountId),
                        paymentId, noteAttachmentPaymentId), new Dictionary<string, string>(), customHeaders);
