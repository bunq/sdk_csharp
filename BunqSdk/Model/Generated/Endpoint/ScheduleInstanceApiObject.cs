...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    /// </summary>
    public class ScheduleInstanceApiObject : BunqModel
    {
        /// <summary>
        /// Endpoint constants.
        /// </summary>
        ...
        public ScheduleAnchorObjectObject ScheduledObject { get; set; }
        /// <summary>
        /// The result object of this schedule instance. (Payment, PaymentBatch)
        /// </summary>
        [JsonProperty(PropertyName = "result_object")]
        public ScheduleInstanceAnchorObjectObject ResultObject { get; set; }
        /// <summary>
        ...
        public static BunqResponse<ScheduleInstanceApiObject> Get(long scheduleId, long scheduleInstanceId, long? monetaryAccountId= null, IDictionary<string, string> customHeaders = null)
        {
            ...
            var responseRaw = apiClient.Get(string.Format(ENDPOINT_URL_READ, DetermineUserId(), DetermineMonetaryAccountId(monetaryAccountId), scheduleId, scheduleInstanceId), new Dictionary<string, string>(), customHeaders);
    
            return FromJson<ScheduleInstanceApiObject>(responseRaw, OBJECT_TYPE_GET);
        }
    ...
    {FIELD_STATE, state},
            ...
            var responseRaw = apiClient.Put(string.Format(ENDPOINT_URL_UPDATE, DetermineUserId(), DetermineMonetaryAccountId(monetaryAccountId), scheduleId, scheduleInstanceId), requestBytes, customHeaders);
        ...
        public static BunqResponse<List<ScheduleInstanceApiObject>> List(long scheduleId, long? monetaryAccountId= null, IDictionary<string, string> urlParams = null, IDictionary<string, string> customHeaders = null)
        {
            ...
            var apiClient = new ApiClient(GetApiContext());
            var responseRaw = apiClient.Get(string.Format(ENDPOINT_URL_LISTING, DetermineUserId(), DetermineMonetaryAccountId(monetaryAccountId), scheduleId), urlParams, customHeaders);
    
            return FromJsonList<ScheduleInstanceApiObject>(responseRaw, OBJECT_TYPE_GET);
        }
        ...
        /// <summary>
        /// </summary>
        public static ScheduleInstanceApiObject CreateFromJsonString(string json)
        {
            return BunqModel.CreateFromJsonString<ScheduleInstanceApiObject>(json);
        }
    }
}
