...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    /// </summary>
    public class InsightPreferenceDateApiObject : BunqModel
    {
        /// <summary>
        /// Endpoint constants.
        /// </summary>
        ...
        /// <summary>
        /// </summary>
        public static BunqResponse<List<InsightPreferenceDateApiObject>> List( IDictionary<string, string> urlParams = null, IDictionary<string, string> customHeaders = null)
        {
            ...
            return FromJsonList<InsightPreferenceDateApiObject>(responseRaw, OBJECT_TYPE_GET);
        }
        ...
        /// <summary>
        /// </summary>
        public static InsightPreferenceDateApiObject CreateFromJsonString(string json)
        {
            return BunqModel.CreateFromJsonString<InsightPreferenceDateApiObject>(json);
        }
    }
}
