...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    public class NoteAttachmentBankSwitchServiceNetherlandsIncomingPayment : BunqModel
    {
        ...
        protected const string ENDPOINT_URL_CREATE =
            "user/{0}/monetary-account/{1}/switch-service-payment/{2}/note-attachment";

        protected const string ENDPOINT_URL_UPDATE =
            "user/{0}/monetary-account/{1}/switch-service-payment/{2}/note-attachment/{3}";
        ...
        public static BunqResponse<int> Create(int switchServicePaymentId, int? attachmentId,
            ...
            var responseRaw =
                apiClient.Post(
                    string.Format(ENDPOINT_URL_CREATE, DetermineUserId(), DetermineMonetaryAccountId(monetaryAccountId),
                        switchServicePaymentId), requestBytes, customHeaders);
        ...
        /// </summary>
        /// <param name="description">Optional description of the attachment.</param>
        public static BunqResponse<int> Update(int switchServicePaymentId,
            int noteAttachmentBankSwitchServiceNetherlandsIncomingPaymentId, int? monetaryAccountId = null,
            string description = null, IDictionary<string, string> customHeaders = null)
        {
            ...
            var requestBytes = Encoding.UTF8.GetBytes(BunqJsonConvert.SerializeObject(requestMap));
            var responseRaw = apiClient.Put(
                string.Format(ENDPOINT_URL_UPDATE, DetermineUserId(), DetermineMonetaryAccountId(monetaryAccountId),
                    switchServicePaymentId, noteAttachmentBankSwitchServiceNetherlandsIncomingPaymentId), requestBytes,
                customHeaders);
        ...
        /// <summary>
        /// </summary>
        public static BunqResponse<object> Delete(int switchServicePaymentId,
            int noteAttachmentBankSwitchServiceNetherlandsIncomingPaymentId, int? monetaryAccountId = null,
            ...
            var responseRaw =
                apiClient.Delete(
                    string.Format(ENDPOINT_URL_DELETE, DetermineUserId(), DetermineMonetaryAccountId(monetaryAccountId),
                        switchServicePaymentId, noteAttachmentBankSwitchServiceNetherlandsIncomingPaymentId),
                    customHeaders);
        ...
        /// </summary>
        public static BunqResponse<List<NoteAttachmentBankSwitchServiceNetherlandsIncomingPayment>> List(
            ...
            var responseRaw =
                apiClient.Get(
                    string.Format(ENDPOINT_URL_LISTING, DetermineUserId(),
                        DetermineMonetaryAccountId(monetaryAccountId), switchServicePaymentId), urlParams,
                    customHeaders);

            return FromJsonList<NoteAttachmentBankSwitchServiceNetherlandsIncomingPayment>(responseRaw,
                OBJECT_TYPE_GET);
        }

        /// <summary>
        /// </summary>
        public static BunqResponse<NoteAttachmentBankSwitchServiceNetherlandsIncomingPayment> Get(
            int switchServicePaymentId, int noteAttachmentBankSwitchServiceNetherlandsIncomingPaymentId,
