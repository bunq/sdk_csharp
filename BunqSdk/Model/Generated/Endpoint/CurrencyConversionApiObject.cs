...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    /// </summary>
    public class CurrencyConversionApiObject : BunqModel
    {
        /// <summary>
        /// Endpoint constants.
        /// </summary>
        ...
        public AmountObject CounterAmount { get; set; }
        /// <summary>
        ...
        /// <summary>
        /// </summary>
        public static BunqResponse<List<CurrencyConversionApiObject>> List(long? monetaryAccountId= null, IDictionary<string, string> urlParams = null, IDictionary<string, string> customHeaders = null)
        {
            ...
            return FromJsonList<CurrencyConversionApiObject>(responseRaw, OBJECT_TYPE_GET);
        }
    
        /// <summary>
        /// </summary>
        public static BunqResponse<CurrencyConversionApiObject> Get(long currencyConversionId, long? monetaryAccountId= null, IDictionary<string, string> customHeaders = null)
        {
            if (customHeaders == null) customHeaders = new Dictionary<string, string>();
            ...
            return FromJson<CurrencyConversionApiObject>(responseRaw, OBJECT_TYPE_GET);
        }
        ...
        /// <summary>
        /// </summary>
        public static CurrencyConversionApiObject CreateFromJsonString(string json)
        {
            return BunqModel.CreateFromJsonString<CurrencyConversionApiObject>(json);
        }
    }
}
