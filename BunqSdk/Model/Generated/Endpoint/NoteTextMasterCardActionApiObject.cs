...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    /// </summary>
    public class NoteTextMasterCardActionApiObject : BunqModel
    {
        /// <summary>
        /// Endpoint constants.
        /// </summary>
        ...
        public static BunqResponse<long> Create(long mastercardActionId, long? monetaryAccountId= null, string content = null, IDictionary<string, string> customHeaders = null)
        {
    ...
    {FIELD_CONTENT, content},
        ...
        /// </summary>
        /// <param name="content">The content of the note.</param>
        public static BunqResponse<long> Update(long mastercardActionId, long noteTextMasterCardActionId, long? monetaryAccountId= null, string content = null, IDictionary<string, string> customHeaders = null)
        {
            if (customHeaders == null) customHeaders = new Dictionary<string, string>();
    ...
    {FIELD_CONTENT, content},
        ...
        /// <summary>
        /// </summary>
        public static BunqResponse<object> Delete(long mastercardActionId, long noteTextMasterCardActionId, long? monetaryAccountId= null, IDictionary<string, string> customHeaders = null)
        {
            if (customHeaders == null) customHeaders = new Dictionary<string, string>();
        ...
        /// </summary>
        public static BunqResponse<List<NoteTextMasterCardActionApiObject>> List(long mastercardActionId, long? monetaryAccountId= null, IDictionary<string, string> urlParams = null, IDictionary<string, string> customHeaders = null)
        {
            ...
            return FromJsonList<NoteTextMasterCardActionApiObject>(responseRaw, OBJECT_TYPE_GET);
        }
    
        /// <summary>
        /// </summary>
        public static BunqResponse<NoteTextMasterCardActionApiObject> Get(long mastercardActionId, long noteTextMasterCardActionId, long? monetaryAccountId= null, IDictionary<string, string> customHeaders = null)
        {
            if (customHeaders == null) customHeaders = new Dictionary<string, string>();
            ...
            return FromJson<NoteTextMasterCardActionApiObject>(responseRaw, OBJECT_TYPE_GET);
        }
        ...
        /// <summary>
        /// </summary>
        public static NoteTextMasterCardActionApiObject CreateFromJsonString(string json)
        {
            return BunqModel.CreateFromJsonString<NoteTextMasterCardActionApiObject>(json);
        }
    }
}
