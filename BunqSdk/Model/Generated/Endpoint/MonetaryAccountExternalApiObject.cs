...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    /// </summary>
    public class MonetaryAccountExternalApiObject : BunqModel
    {
        /// <summary>
        /// Endpoint constants.
        /// </summary>
    ...
    {FIELD_SETTING, setting},
        ...
        public static BunqResponse<MonetaryAccountExternalApiObject> Get(long monetaryAccountExternalId, IDictionary<string, string> customHeaders = null)
        {
            ...
            return FromJson<MonetaryAccountExternalApiObject>(responseRaw, OBJECT_TYPE_GET);
        }
    ...
    {FIELD_SETTING, setting},
        ...
        /// <summary>
        /// </summary>
        public static BunqResponse<List<MonetaryAccountExternalApiObject>> List( IDictionary<string, string> urlParams = null, IDictionary<string, string> customHeaders = null)
        {
            ...
            return FromJsonList<MonetaryAccountExternalApiObject>(responseRaw, OBJECT_TYPE_GET);
        }
        ...
        /// <summary>
        /// </summary>
        public static MonetaryAccountExternalApiObject CreateFromJsonString(string json)
        {
            return BunqModel.CreateFromJsonString<MonetaryAccountExternalApiObject>(json);
        }
    }
}
