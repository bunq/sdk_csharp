...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    public class Reward : BunqModel
    {
        ...
        public static BunqResponse<Reward> Get(int rewardId, IDictionary<string, string> customHeaders = null)
        {
            ...
            var responseRaw = apiClient.Get(string.Format(ENDPOINT_URL_READ, DetermineUserId(), rewardId),
        ...
        /// <summary>
        /// </summary>
        public static BunqResponse<List<Reward>> List(IDictionary<string, string> urlParams = null,
        ...
        {
            return CreateFromJsonString<Reward>(json);
        }
    }
}