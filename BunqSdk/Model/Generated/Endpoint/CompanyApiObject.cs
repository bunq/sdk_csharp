...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    /// </summary>
    public class CompanyApiObject : BunqModel
    {
        /// <summary>
        /// Endpoint constants.
        /// </summary>
        ...
        public CompanyVatNumberObject VatNumber { get; set; }
        /// <summary>
        /// All the vat numbers of the company
        /// </summary>
        [JsonProperty(PropertyName = "vat_numbers")]
        public List<CompanyVatNumberObject> VatNumbers { get; set; }
        /// <summary>
    ...
    {FIELD_SIGNUP_TRACK_TYPE, signupTrackType},
        ...
        public static BunqResponse<CompanyApiObject> Get(long companyId, IDictionary<string, string> customHeaders = null)
        {
            ...
            var apiClient = new ApiClient(GetApiContext());
            var responseRaw = apiClient.Get(string.Format(ENDPOINT_URL_READ, DetermineUserId(), companyId), new Dictionary<string, string>(), customHeaders);
    
            return FromJson<CompanyApiObject>(responseRaw, OBJECT_TYPE_GET);
        }
    
        /// <summary>
        /// </summary>
        public static BunqResponse<List<CompanyApiObject>> List( IDictionary<string, string> urlParams = null, IDictionary<string, string> customHeaders = null)
        {
            ...
            return FromJsonList<CompanyApiObject>(responseRaw, OBJECT_TYPE_GET);
        }
    ...
    {FIELD_AVATAR_UUID, avatarUuid},
            ...
            var requestBytes = Encoding.UTF8.GetBytes(BunqJsonConvert.SerializeObject(requestMap));
            var responseRaw = apiClient.Put(string.Format(ENDPOINT_URL_UPDATE, DetermineUserId(), companyId), requestBytes, customHeaders);
        ...
        /// <summary>
        /// </summary>
        public static CompanyApiObject CreateFromJsonString(string json)
        {
            return BunqModel.CreateFromJsonString<CompanyApiObject>(json);
        }
    }
}
