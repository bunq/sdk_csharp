...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    public class TabQrCodeContent : BunqModel
    {
        ...
        /// </summary>
        public static BunqResponse<byte[]> List(ApiContext apiContext, int userId, int monetaryAccountId, int cashRegisterId, string tabUuid, IDictionary<string, string> customHeaders = null)
        {
