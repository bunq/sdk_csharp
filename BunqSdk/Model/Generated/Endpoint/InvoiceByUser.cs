...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    public class InvoiceByUser : BunqModel
    {
        ...
        /// <summary>
        /// </summary>
        public static BunqResponse<List<InvoiceByUser>> List( IDictionary<string, string> urlParams = null, IDictionary<string, string> customHeaders = null)
        {
        ...
        /// <summary>
        /// </summary>
        public static BunqResponse<InvoiceByUser> Get(int invoiceByUserId, IDictionary<string, string> customHeaders = null)
        {
            if (customHeaders == null) customHeaders = new Dictionary<string, string>();
