...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    /// authentication.
    /// </summary>
    public class UserCredentialPasswordIpApiObject : BunqModel
    {
        /// <summary>
        /// Endpoint constants.
        /// </summary>
        ...
        public PermittedDeviceObject PermittedDevice { get; set; }
        ...
        public static BunqResponse<UserCredentialPasswordIpApiObject> Get(long userCredentialPasswordIpId, IDictionary<string, string> customHeaders = null)
        {
            ...
            var responseRaw = apiClient.Get(string.Format(ENDPOINT_URL_READ, DetermineUserId(), userCredentialPasswordIpId), new Dictionary<string, string>(), customHeaders);
    
            return FromJson<UserCredentialPasswordIpApiObject>(responseRaw, OBJECT_TYPE_GET);
        }
    
        /// <summary>
        /// </summary>
        public static BunqResponse<List<UserCredentialPasswordIpApiObject>> List( IDictionary<string, string> urlParams = null, IDictionary<string, string> customHeaders = null)
        {
            ...
            return FromJsonList<UserCredentialPasswordIpApiObject>(responseRaw, OBJECT_TYPE_GET);
        }
        ...
        /// <summary>
        /// </summary>
        public static UserCredentialPasswordIpApiObject CreateFromJsonString(string json)
        {
            return BunqModel.CreateFromJsonString<UserCredentialPasswordIpApiObject>(json);
        }
    }
}
