...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    /// PDF file format.
    /// </summary>
    public class ExportStatementApiObject : BunqModel
    {
        /// <summary>
        /// Endpoint constants.
        /// </summary>
    ...
    {FIELD_INCLUDE_ATTACHMENT, includeAttachment},
        ...
        public static BunqResponse<ExportStatementApiObject> Get(long exportStatementId, long? monetaryAccountId= null, IDictionary<string, string> customHeaders = null)
        {
            ...
            var apiClient = new ApiClient(GetApiContext());
            var responseRaw = apiClient.Get(string.Format(ENDPOINT_URL_READ, DetermineUserId(), DetermineMonetaryAccountId(monetaryAccountId), exportStatementId), new Dictionary<string, string>(), customHeaders);
    
            return FromJson<ExportStatementApiObject>(responseRaw, OBJECT_TYPE_GET);
        }
        ...
        public static BunqResponse<List<ExportStatementApiObject>> List(long? monetaryAccountId= null, IDictionary<string, string> urlParams = null, IDictionary<string, string> customHeaders = null)
        {
            ...
            return FromJsonList<ExportStatementApiObject>(responseRaw, OBJECT_TYPE_GET);
        }
        ...
        /// <summary>
        /// </summary>
        public static ExportStatementApiObject CreateFromJsonString(string json)
        {
            return BunqModel.CreateFromJsonString<ExportStatementApiObject>(json);
        }
    }
}
