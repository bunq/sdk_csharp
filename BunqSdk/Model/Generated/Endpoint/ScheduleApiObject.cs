...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    /// </summary>
    public class ScheduleApiObject : BunqModel
    {
        /// <summary>
        /// Endpoint constants.
        /// </summary>
        ...
        public ScheduleAnchorObjectObject Object { get; set; }
        ...
        public static BunqResponse<ScheduleApiObject> Get(long scheduleId, long? monetaryAccountId= null, IDictionary<string, string> customHeaders = null)
        {
            ...
            var responseRaw = apiClient.Get(string.Format(ENDPOINT_URL_READ, DetermineUserId(), DetermineMonetaryAccountId(monetaryAccountId), scheduleId), new Dictionary<string, string>(), customHeaders);
    
            return FromJson<ScheduleApiObject>(responseRaw, OBJECT_TYPE_GET);
        }
        ...
        public static BunqResponse<List<ScheduleApiObject>> List(long? monetaryAccountId= null, IDictionary<string, string> urlParams = null, IDictionary<string, string> customHeaders = null)
        {
            ...
            return FromJsonList<ScheduleApiObject>(responseRaw, OBJECT_TYPE_GET);
        }
        ...
        /// <summary>
        /// </summary>
        public static ScheduleApiObject CreateFromJsonString(string json)
        {
            return BunqModel.CreateFromJsonString<ScheduleApiObject>(json);
        }
    }
}
