...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    /// </summary>
    public class UserApiKeyApiObject : BunqModel
    {
        /// <summary>
        /// The id of the user.
        /// </summary>
        ...
        public UserApiKeyAnchoredUserObject RequestedByUser { get; set; }
        /// <summary>
        /// The user who granted access.
        /// </summary>
        [JsonProperty(PropertyName = "granted_by_user")]
        public UserApiKeyAnchoredUserObject GrantedByUser { get; set; }
        ...
        /// <summary>
        /// </summary>
        public static UserApiKeyApiObject CreateFromJsonString(string json)
        {
            return BunqModel.CreateFromJsonString<UserApiKeyApiObject>(json);
        }
    }
}
