...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    public class TabResultInquiry : BunqModel
    {
        ...
        /// Endpoint constants.
        /// </summary>
        protected const string ENDPOINT_URL_READ = "user/{0}/monetary-account/{1}/cash-register/{2}/tab/{3}/tab-result-inquiry/{4}";
        protected const string ENDPOINT_URL_LISTING = "user/{0}/monetary-account/{1}/cash-register/{2}/tab/{3}/tab-result-inquiry";
        ...
        /// </summary>
        public static BunqResponse<TabResultInquiry> Get(int cashRegisterId, string tabUuid, int tabResultInquiryId, int? monetaryAccountId= null, IDictionary<string, string> customHeaders = null)
        {
            if (customHeaders == null) customHeaders = new Dictionary<string, string>();
    
            var apiClient = new ApiClient(GetApiContext());
            var responseRaw = apiClient.Get(string.Format(ENDPOINT_URL_READ, DetermineUserId(), DetermineMonetaryAccountId(monetaryAccountId), cashRegisterId, tabUuid, tabResultInquiryId), new Dictionary<string, string>(), customHeaders);
        ...
        /// </summary>
        public static BunqResponse<List<TabResultInquiry>> List(int cashRegisterId, string tabUuid, int? monetaryAccountId= null, IDictionary<string, string> urlParams = null, IDictionary<string, string> customHeaders = null)
        {
