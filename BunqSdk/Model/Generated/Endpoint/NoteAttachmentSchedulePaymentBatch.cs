...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    public class NoteAttachmentSchedulePaymentBatch : BunqModel
    {
        ...
        protected const string ENDPOINT_URL_CREATE =
            "user/{0}/monetary-account/{1}/schedule-payment-batch/{2}/note-attachment";

        protected const string ENDPOINT_URL_UPDATE =
            "user/{0}/monetary-account/{1}/schedule-payment-batch/{2}/note-attachment/{3}";
        ...
        public static BunqResponse<int> Create(int schedulePaymentBatchId, int? attachmentId,
            ...
            var responseRaw =
                apiClient.Post(
                    string.Format(ENDPOINT_URL_CREATE, DetermineUserId(), DetermineMonetaryAccountId(monetaryAccountId),
                        schedulePaymentBatchId), requestBytes, customHeaders);
        ...
        /// </summary>
        /// <param name="description">Optional description of the attachment.</param>
        public static BunqResponse<int> Update(int schedulePaymentBatchId, int noteAttachmentSchedulePaymentBatchId,
            int? monetaryAccountId = null, string description = null, IDictionary<string, string> customHeaders = null)
        {
            if (customHeaders == null) customHeaders = new Dictionary<string, string>();
            ...
            var responseRaw =
                apiClient.Put(
                    string.Format(ENDPOINT_URL_UPDATE, DetermineUserId(), DetermineMonetaryAccountId(monetaryAccountId),
                        schedulePaymentBatchId, noteAttachmentSchedulePaymentBatchId), requestBytes, customHeaders);
        ...
        /// <summary>
        /// </summary>
        public static BunqResponse<object> Delete(int schedulePaymentBatchId, int noteAttachmentSchedulePaymentBatchId,
            ...
            var responseRaw =
                apiClient.Delete(
                    string.Format(ENDPOINT_URL_DELETE, DetermineUserId(), DetermineMonetaryAccountId(monetaryAccountId),
                        schedulePaymentBatchId, noteAttachmentSchedulePaymentBatchId), customHeaders);
        ...
        /// </summary>
        public static BunqResponse<List<NoteAttachmentSchedulePaymentBatch>> List(int schedulePaymentBatchId,
            ...
            var responseRaw =
                apiClient.Get(
                    string.Format(ENDPOINT_URL_LISTING, DetermineUserId(),
                        DetermineMonetaryAccountId(monetaryAccountId), schedulePaymentBatchId), urlParams,
                    customHeaders);
        ...
        /// <summary>
        /// </summary>
        public static BunqResponse<NoteAttachmentSchedulePaymentBatch> Get(int schedulePaymentBatchId,
            int noteAttachmentSchedulePaymentBatchId, int? monetaryAccountId = null,
            IDictionary<string, string> customHeaders = null)
        {
            if (customHeaders == null) customHeaders = new Dictionary<string, string>();
            ...
            var responseRaw =
                apiClient.Get(
                    string.Format(ENDPOINT_URL_READ, DetermineUserId(), DetermineMonetaryAccountId(monetaryAccountId),
                        schedulePaymentBatchId, noteAttachmentSchedulePaymentBatchId), new Dictionary<string, string>(),
                    customHeaders);
