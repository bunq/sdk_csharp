...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    /// </summary>
    public class ExportRibContentApiObject : BunqModel
    {
        /// <summary>
        /// Endpoint constants.
        /// </summary>
        ...
        public static BunqResponse<byte[]> List(long exportRibId, long? monetaryAccountId= null, IDictionary<string, string> customHeaders = null)
        {
            ...
            var responseRaw = apiClient.Get(string.Format(ENDPOINT_URL_LISTING, DetermineUserId(), DetermineMonetaryAccountId(monetaryAccountId), exportRibId), new Dictionary<string, string>(), customHeaders);
        ...
        /// <summary>
        /// </summary>
        public static ExportRibContentApiObject CreateFromJsonString(string json)
        {
            return BunqModel.CreateFromJsonString<ExportRibContentApiObject>(json);
        }
    }
}
