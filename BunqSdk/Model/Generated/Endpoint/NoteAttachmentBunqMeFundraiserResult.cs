...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    public class NoteAttachmentBunqMeFundraiserResult : BunqModel
    {
        ...
        protected const string ENDPOINT_URL_CREATE =
            "user/{0}/monetary-account/{1}/bunqme-fundraiser-result/{2}/note-attachment";

        protected const string ENDPOINT_URL_UPDATE =
            "user/{0}/monetary-account/{1}/bunqme-fundraiser-result/{2}/note-attachment/{3}";
        ...
        /// </summary>
        /// <param name="description">Optional description of the attachment.</param>
        public static BunqResponse<int> Update(int bunqmeFundraiserResultId, int noteAttachmentBunqMeFundraiserResultId,
            int? monetaryAccountId = null, string description = null, IDictionary<string, string> customHeaders = null)
        {
            if (customHeaders == null) customHeaders = new Dictionary<string, string>();
            ...
            var responseRaw =
                apiClient.Put(
                    string.Format(ENDPOINT_URL_UPDATE, DetermineUserId(), DetermineMonetaryAccountId(monetaryAccountId),
                        bunqmeFundraiserResultId, noteAttachmentBunqMeFundraiserResultId), requestBytes, customHeaders);
        ...
        /// <summary>
        /// </summary>
        public static BunqResponse<object> Delete(int bunqmeFundraiserResultId,
            int noteAttachmentBunqMeFundraiserResultId, int? monetaryAccountId = null,
            ...
            var responseRaw =
                apiClient.Delete(
                    string.Format(ENDPOINT_URL_DELETE, DetermineUserId(), DetermineMonetaryAccountId(monetaryAccountId),
                        bunqmeFundraiserResultId, noteAttachmentBunqMeFundraiserResultId), customHeaders);
        ...
        /// </summary>
        public static BunqResponse<List<NoteAttachmentBunqMeFundraiserResult>> List(int bunqmeFundraiserResultId,
        ...
        /// <summary>
        /// </summary>
        public static BunqResponse<NoteAttachmentBunqMeFundraiserResult> Get(int bunqmeFundraiserResultId,
            int noteAttachmentBunqMeFundraiserResultId, int? monetaryAccountId = null,
            IDictionary<string, string> customHeaders = null)
        {
            if (customHeaders == null) customHeaders = new Dictionary<string, string>();
            ...
            var responseRaw = apiClient.Get(
                string.Format(ENDPOINT_URL_READ, DetermineUserId(), DetermineMonetaryAccountId(monetaryAccountId),
                    bunqmeFundraiserResultId, noteAttachmentBunqMeFundraiserResultId), new Dictionary<string, string>(),
                customHeaders);
