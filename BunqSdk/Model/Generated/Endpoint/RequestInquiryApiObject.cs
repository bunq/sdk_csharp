...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    /// </summary>
    public class RequestInquiryApiObject : BunqModel
    {
        /// <summary>
        /// Endpoint constants.
        /// </summary>
        ...
        public AmountObject AmountInquired { get; set; }
        /// <summary>
        ...
        public List<BunqIdObject> Attachment { get; set; }
        /// <summary>
        ...
        public AmountObject AmountResponded { get; set; }
        /// <summary>
        ...
        public RequestReferenceSplitTheBillAnchorObjectObject ReferenceSplitTheBill { get; set; }
    ...
    {FIELD_STATUS, status},
            ...
            return FromJson<RequestInquiryApiObject>(responseRaw, OBJECT_TYPE_PUT);
        }
        ...
        public static BunqResponse<List<RequestInquiryApiObject>> List(long? monetaryAccountId= null, IDictionary<string, string> urlParams = null, IDictionary<string, string> customHeaders = null)
        {
            ...
            return FromJsonList<RequestInquiryApiObject>(responseRaw, OBJECT_TYPE_GET);
        }
        ...
        public static BunqResponse<RequestInquiryApiObject> Get(long requestInquiryId, long? monetaryAccountId= null, IDictionary<string, string> customHeaders = null)
        {
            ...
            return FromJson<RequestInquiryApiObject>(responseRaw, OBJECT_TYPE_GET);
        }
        ...
        /// <summary>
        /// </summary>
        public static RequestInquiryApiObject CreateFromJsonString(string json)
        {
            return BunqModel.CreateFromJsonString<RequestInquiryApiObject>(json);
        }
    }
}
