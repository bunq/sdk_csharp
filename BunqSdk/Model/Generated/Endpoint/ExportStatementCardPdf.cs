...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    /// </summary>
    public class ExportStatementCardPdf : BunqModel
    {
        /// <summary>
        /// Endpoint constants.
        /// </summary>
    ...
    {FIELD_DATE_END, dateEnd},
        ...
        /// <summary>
        /// </summary>
        public static BunqResponse<ExportStatementCardPdf> Get(int cardId, int exportStatementCardPdfId, IDictionary<string, string> customHeaders = null)
        {
            if (customHeaders == null) customHeaders = new Dictionary<string, string>();
            ...
            return FromJson<ExportStatementCardPdf>(responseRaw, OBJECT_TYPE_GET);
        }
    
        /// <summary>
        /// </summary>
        public static BunqResponse<List<ExportStatementCardPdf>> List(int cardId, IDictionary<string, string> urlParams = null, IDictionary<string, string> customHeaders = null)
        {
            ...
            return FromJsonList<ExportStatementCardPdf>(responseRaw, OBJECT_TYPE_GET);
        }
        ...
        /// <summary>
        /// </summary>
        public static ExportStatementCardPdf CreateFromJsonString(string json)
        {
            return BunqModel.CreateFromJsonString<ExportStatementCardPdf>(json);
        }
    }
}
