...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    /// </summary>
    public class CurrencyCloudPaymentQuoteApiObject : BunqModel
    {
        /// <summary>
        /// Endpoint constants.
        /// </summary>
        ...
        public List<PointerObject> Pointers { get; set; }
        /// <summary>
        ...
        public static BunqResponse<long> Create(List<PointerObject> pointers, long? monetaryAccountId= null, IDictionary<string, string> customHeaders = null)
        {
    ...
    {FIELD_POINTERS, pointers},
        ...
        /// <summary>
        /// </summary>
        public static CurrencyCloudPaymentQuoteApiObject CreateFromJsonString(string json)
        {
            return BunqModel.CreateFromJsonString<CurrencyCloudPaymentQuoteApiObject>(json);
        }
    }
}
