...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    public class InsightEvent : BunqModel
    {
        ...
        /// <summary>
        /// </summary>
        public static BunqResponse<List<InsightEvent>> List( IDictionary<string, string> urlParams = null, IDictionary<string, string> customHeaders = null)
        {
        ...
        {
            return BunqModel.CreateFromJsonString<InsightEvent>(json);
        }
    }
}
