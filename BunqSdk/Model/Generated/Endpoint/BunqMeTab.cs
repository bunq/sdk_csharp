...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    public class BunqMeTab : BunqModel
    {
        ...
        /// <summary>
        /// </summary>
        public static BunqResponse<List<BunqMeTab>> List(int? monetaryAccountId = null,
        ...
        /// <summary>
        /// </summary>
        public static BunqResponse<BunqMeTab> Get(int bunqMeTabId, int? monetaryAccountId = null,
            IDictionary<string, string> customHeaders = null)
        {
            if (customHeaders == null) customHeaders = new Dictionary<string, string>();
            ...
            var responseRaw =
                apiClient.Get(
                    string.Format(ENDPOINT_URL_READ, DetermineUserId(), DetermineMonetaryAccountId(monetaryAccountId),
                        bunqMeTabId), new Dictionary<string, string>(), customHeaders);
