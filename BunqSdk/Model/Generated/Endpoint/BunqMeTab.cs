...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    public class BunqMeTab : BunqModel
    {
        ...
        /// Endpoint constants.
        /// </summary>
        private const string EndpointUrlCreate = "user/{0}/monetary-account/{1}/bunqme-tab";
        private const string EndpointUrlUpdate = "user/{0}/monetary-account/{1}/bunqme-tab/{2}";
        private const string EndpointUrlListing = "user/{0}/monetary-account/{1}/bunqme-tab";
        private const string EndpointUrlRead = "user/{0}/monetary-account/{1}/bunqme-tab/{2}";
    
        /// <summary>
        /// Field constants.
        /// </summary>
        public const string FieldBunqmeTabEntry = "bunqme_tab_entry";
        ...
        public static BunqResponse<BunqMeTab> Update(ApiContext apiContext, IDictionary<string, object> requestMap, int userId, int monetaryAccountId, int bunqMeTabId, IDictionary<string, string> customHeaders = null)
        {
            ...
            var apiClient = new ApiClient(apiContext);
            var requestBytes = Encoding.UTF8.GetBytes(BunqJsonConvert.SerializeObject(requestMap));
            var responseRaw = apiClient.Put(string.Format(EndpointUrlUpdate, userId, monetaryAccountId, bunqMeTabId), requestBytes, customHeaders);
    
            return FromJson<BunqMeTab>(responseRaw, ObjectType);
        }
        ...
        public static BunqResponse<List<BunqMeTab>> List(ApiContext apiContext, int userId, int monetaryAccountId, IDictionary<string, string> urlParams = null, IDictionary<string, string> customHeaders = null)
        {
            ...
            return FromJsonList<BunqMeTab>(responseRaw, ObjectType);
        }
        ...
        public static BunqResponse<BunqMeTab> Get(ApiContext apiContext, int userId, int monetaryAccountId, int bunqMeTabId, IDictionary<string, string> customHeaders = null)
        {
            ...
            var apiClient = new ApiClient(apiContext);
            var responseRaw = apiClient.Get(string.Format(EndpointUrlRead, userId, monetaryAccountId, bunqMeTabId), new Dictionary<string, string>(), customHeaders);
