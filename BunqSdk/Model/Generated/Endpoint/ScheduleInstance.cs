...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    public class ScheduleInstance : BunqModel
    {
        ...
        /// <summary>
        /// </summary>
        public static BunqResponse<ScheduleInstance> Get(int scheduleId, int scheduleInstanceId, int? monetaryAccountId= null, IDictionary<string, string> customHeaders = null)
        {
    ...
    {FIELD_STATE, state},
        ...
        /// <summary>
        /// </summary>
        public static BunqResponse<List<ScheduleInstance>> List(int scheduleId, int? monetaryAccountId= null, IDictionary<string, string> urlParams = null, IDictionary<string, string> customHeaders = null)
        {
