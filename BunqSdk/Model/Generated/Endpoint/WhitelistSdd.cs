...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    public class WhitelistSdd : BunqModel
    {
        ...
        /// </summary>
        public static BunqResponse<WhitelistSdd> Get(int whitelistSddId, IDictionary<string, string> customHeaders = null)
        {
        ...
        /// </summary>
        public static BunqResponse<List<WhitelistSdd>> List( IDictionary<string, string> urlParams = null, IDictionary<string, string> customHeaders = null)
        {
            ...
            return FromJsonList<WhitelistSdd>(responseRaw);
        }
