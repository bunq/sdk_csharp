...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    /// </summary>
    public class RequestInquiryBatchApiObject : BunqModel
    {
        /// <summary>
        /// Endpoint constants.
        /// </summary>
        ...
        public List<RequestInquiryApiObject> RequestInquiries { get; set; }
        /// <summary>
        ...
        public AmountObject TotalAmountInquired { get; set; }
        /// <summary>
    ...
    {FIELD_STATUS, status},
        ...
        public static BunqResponse<RequestInquiryBatchApiObject> Get(long requestInquiryBatchId, long? monetaryAccountId= null, IDictionary<string, string> customHeaders = null)
        {
            ...
            return FromJson<RequestInquiryBatchApiObject>(responseRaw, OBJECT_TYPE_GET);
        }
        ...
        public static BunqResponse<List<RequestInquiryBatchApiObject>> List(long? monetaryAccountId= null, IDictionary<string, string> urlParams = null, IDictionary<string, string> customHeaders = null)
        {
            ...
            return FromJsonList<RequestInquiryBatchApiObject>(responseRaw, OBJECT_TYPE_GET);
        }
        ...
        /// <summary>
        /// </summary>
        public static RequestInquiryBatchApiObject CreateFromJsonString(string json)
        {
            return BunqModel.CreateFromJsonString<RequestInquiryBatchApiObject>(json);
        }
    }
}
