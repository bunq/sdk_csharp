...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    public class TabItemShop : BunqModel
    {
        ...
        protected const string ENDPOINT_URL_LISTING =
            "user/{0}/monetary-account/{1}/cash-register/{2}/tab/{3}/tab-item";
        ...
        public static BunqResponse<int> Create(int cashRegisterId, string tabUuid, string description,
            ...
            List<int?> tabAttachment = null, string quantity = null, Amount amount = null,
        ...
        public static BunqResponse<int> Update(int cashRegisterId, string tabUuid, int tabItemShopId,
            ...
            string avatarAttachmentUuid = null, List<int?> tabAttachment = null, string quantity = null,
            Amount amount = null, IDictionary<string, string> customHeaders = null)
        {
            if (customHeaders == null) customHeaders = new Dictionary<string, string>();
            ...
            var responseRaw =
                apiClient.Put(
                    string.Format(ENDPOINT_URL_UPDATE, DetermineUserId(), DetermineMonetaryAccountId(monetaryAccountId),
                        cashRegisterId, tabUuid, tabItemShopId), requestBytes, customHeaders);
            ...
            var responseRaw =
                apiClient.Delete(
                    string.Format(ENDPOINT_URL_DELETE, DetermineUserId(), DetermineMonetaryAccountId(monetaryAccountId),
                        cashRegisterId, tabUuid, tabItemShopId), customHeaders);
            ...
            var responseRaw =
                apiClient.Get(
                    string.Format(ENDPOINT_URL_READ, DetermineUserId(), DetermineMonetaryAccountId(monetaryAccountId),
                        cashRegisterId, tabUuid, tabItemShopId), new Dictionary<string, string>(), customHeaders);
