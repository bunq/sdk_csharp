...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    public class CashRegisterQrCodeContent : BunqModel
    {
        ...
        /// Endpoint constants.
        /// </summary>
        protected const string ENDPOINT_URL_LISTING = "user/{0}/monetary-account/{1}/cash-register/{2}/qr-code/{3}/content";
        ...
        /// </summary>
        public static BunqResponse<byte[]> List(int cashRegisterId, int qrCodeId, int? monetaryAccountId= null, IDictionary<string, string> customHeaders = null)
        {
            if (customHeaders == null) customHeaders = new Dictionary<string, string>();
    
            var apiClient = new ApiClient(GetApiContext());
            var responseRaw = apiClient.Get(string.Format(ENDPOINT_URL_LISTING, DetermineUserId(), DetermineMonetaryAccountId(monetaryAccountId), cashRegisterId, qrCodeId), new Dictionary<string, string>(), customHeaders);
