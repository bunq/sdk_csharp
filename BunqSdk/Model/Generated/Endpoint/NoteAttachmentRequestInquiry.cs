...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    public class NoteAttachmentRequestInquiry : BunqModel
    {
        ...
        protected const string ENDPOINT_URL_CREATE =
            "user/{0}/monetary-account/{1}/request-inquiry/{2}/note-attachment";

        protected const string ENDPOINT_URL_UPDATE =
            "user/{0}/monetary-account/{1}/request-inquiry/{2}/note-attachment/{3}";
        ...
        public static BunqResponse<int> Create(int requestInquiryId, int? attachmentId, int? monetaryAccountId = null,
        ...
        /// </summary>
        /// <param name="description">Optional description of the attachment.</param>
        public static BunqResponse<int> Update(int requestInquiryId, int noteAttachmentRequestInquiryId,
            ...
            var responseRaw =
                apiClient.Put(
                    string.Format(ENDPOINT_URL_UPDATE, DetermineUserId(), DetermineMonetaryAccountId(monetaryAccountId),
                        requestInquiryId, noteAttachmentRequestInquiryId), requestBytes, customHeaders);
        ...
        /// <summary>
        /// </summary>
        public static BunqResponse<object> Delete(int requestInquiryId, int noteAttachmentRequestInquiryId,
            ...
            var responseRaw =
                apiClient.Delete(
                    string.Format(ENDPOINT_URL_DELETE, DetermineUserId(), DetermineMonetaryAccountId(monetaryAccountId),
                        requestInquiryId, noteAttachmentRequestInquiryId), customHeaders);
        ...
        /// </summary>
        public static BunqResponse<List<NoteAttachmentRequestInquiry>> List(int requestInquiryId,
        ...
        /// <summary>
        /// </summary>
        public static BunqResponse<NoteAttachmentRequestInquiry> Get(int requestInquiryId,
            int noteAttachmentRequestInquiryId, int? monetaryAccountId = null,
            IDictionary<string, string> customHeaders = null)
        {
            if (customHeaders == null) customHeaders = new Dictionary<string, string>();
            ...
            var responseRaw =
                apiClient.Get(
                    string.Format(ENDPOINT_URL_READ, DetermineUserId(), DetermineMonetaryAccountId(monetaryAccountId),
                        requestInquiryId, noteAttachmentRequestInquiryId), new Dictionary<string, string>(),
                    customHeaders);
