...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    public class ExportStatementPayment : BunqModel
    {
        ...
        /// <summary>
        /// </summary>
        public static BunqResponse<int> Create(int eventId, int? monetaryAccountId= null, IDictionary<string, string> customHeaders = null)
        {
            ...
            var requestMap = new Dictionary<string, object>
    {
        ...
        /// <summary>
        /// </summary>
        public static BunqResponse<ExportStatementPayment> Get(int eventId, int exportStatementPaymentId, int? monetaryAccountId= null, IDictionary<string, string> customHeaders = null)
        {
            if (customHeaders == null) customHeaders = new Dictionary<string, string>();
