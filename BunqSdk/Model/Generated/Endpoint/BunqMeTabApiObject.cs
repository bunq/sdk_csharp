...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    /// </summary>
    public class BunqMeTabApiObject : BunqModel
    {
        /// <summary>
        /// Endpoint constants.
        /// </summary>
        ...
        public BunqMeTabEntryApiObject BunqmeTabEntry { get; set; }
        /// <summary>
        ...
        public List<BunqMeTabEntryApiObject> BunqmeTabEntries { get; set; }
        /// <summary>
        /// The list of bunq.me result Inquiries successfully made and paid.
        /// </summary>
        [JsonProperty(PropertyName = "result_inquiries")]
        public List<BunqMeTabResultInquiryApiObject> ResultInquiries { get; set; }
    ...
    {FIELD_STATUS, status},
        ...
        public static BunqResponse<List<BunqMeTabApiObject>> List(long? monetaryAccountId= null, IDictionary<string, string> urlParams = null, IDictionary<string, string> customHeaders = null)
        {
            ...
            return FromJsonList<BunqMeTabApiObject>(responseRaw, OBJECT_TYPE_GET);
        }
        ...
        public static BunqResponse<BunqMeTabApiObject> Get(long bunqMeTabId, long? monetaryAccountId= null, IDictionary<string, string> customHeaders = null)
        {
            ...
            return FromJson<BunqMeTabApiObject>(responseRaw, OBJECT_TYPE_GET);
        }
        ...
        /// <summary>
        /// </summary>
        public static BunqMeTabApiObject CreateFromJsonString(string json)
        {
            return BunqModel.CreateFromJsonString<BunqMeTabApiObject>(json);
        }
    }
}
