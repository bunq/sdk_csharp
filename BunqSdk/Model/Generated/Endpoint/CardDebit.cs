...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    public class CardDebit : BunqModel
    {
        ...
        /// </summary>
        public static BunqResponse<CardDebit> Create(ApiContext apiContext, IDictionary<string, object> requestMap, int userId, IDictionary<string, string> customHeaders = null)
        {
