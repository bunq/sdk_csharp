...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    public class CardDebit : BunqModel
    {
        ...
        public static BunqResponse<CardDebit> Create(string secondLine, string nameOnCard, string type, Pointer alias = null, List<CardPinAssignment> pinCodeAssignment = null, int? monetaryAccountIdFallback = null, IDictionary<string, string> customHeaders = null)
        {
