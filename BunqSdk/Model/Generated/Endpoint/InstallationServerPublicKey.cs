...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    public class InstallationServerPublicKey : BunqModel
    {
        ...
        /// </summary>
        public static BunqResponse<List<InstallationServerPublicKey>> List(int installationId, IDictionary<string, string> urlParams = null, IDictionary<string, string> customHeaders = null)
        {
