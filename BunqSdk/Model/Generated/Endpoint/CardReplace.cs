...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    public class CardReplace : BunqModel
    {
        ...
        public static BunqResponse<int> Create(int cardId, string nameOnCard = null, string preferredNameOnCard = null, List<CardPinAssignment> pinCodeAssignment = null, string secondLine = null, IDictionary<string, string> customHeaders = null)
        {
