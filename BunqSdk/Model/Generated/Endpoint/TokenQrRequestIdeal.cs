...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    public class TokenQrRequestIdeal : BunqModel
    {
        ...
        /// </summary>
        public static BunqResponse<TokenQrRequestIdeal> Create(ApiContext apiContext, IDictionary<string, object> requestMap, int userId, IDictionary<string, string> customHeaders = null)
        {
