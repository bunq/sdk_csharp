...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    public class MonetaryAccountJoint : BunqModel
    {
        ...
        ///     CANCELLED or PENDING_REOPEN in PUT requests to cancel (close) or reopen the MonetaryAccountJoint. When updating the
        ...
        ///     MonetaryAccountJoint. Can be any user provided message. Should only be specified if updating the status to
        ///     CANCELLED.
        /// </param>
        ...
        {
            return CreateFromJsonString<MonetaryAccountJoint>(json);
        }
    }
}