...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    public class MonetaryAccount : BunqModel, IAnchorObjectInterface
    {
        ...
        /// Endpoint constants.
        /// </summary>
        private const string EndpointUrlRead = "user/{0}/monetary-account/{1}";
        private const string EndpointUrlListing = "user/{0}/monetary-account";
    
        /// <summary>
        /// Object type.
        /// </summary>
        private const string ObjectType = "MonetaryAccount";
        ...
        public static BunqResponse<MonetaryAccount> Get(ApiContext apiContext, int userId, int monetaryAccountId, IDictionary<string, string> customHeaders = null)
        {
            ...
            var responseRaw = apiClient.Get(string.Format(EndpointUrlRead, userId, monetaryAccountId), new Dictionary<string, string>(), customHeaders);
