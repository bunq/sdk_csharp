...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    ///     account level to receive callbacks. For more information check the
    ///     <a href="/api/2/page/callbacks">
    ///         dedicated
    ///         callbacks page
    ///     </a>
    ///     .
    ...
    public class MonetaryAccount : BunqModel, IAnchorObjectInterface
    {
        ...
        {
            if (MonetaryAccountBank != null) return MonetaryAccountBank;

            if (MonetaryAccountJoint != null) return MonetaryAccountJoint;

            if (MonetaryAccountLight != null) return MonetaryAccountLight;

            if (MonetaryAccountSavings != null) return MonetaryAccountSavings;
        ...
        {
            if (MonetaryAccountBank != null) return false;

            if (MonetaryAccountJoint != null) return false;

            if (MonetaryAccountLight != null) return false;

            if (MonetaryAccountSavings != null) return false;
