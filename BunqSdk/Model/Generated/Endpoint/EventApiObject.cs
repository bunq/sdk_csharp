...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    /// </summary>
    public class EventApiObject : BunqModel
    {
        /// <summary>
        /// Endpoint constants.
        /// </summary>
        ...
        public EventObjectObject Object { get; set; }
        /// <summary>
        ...
        public EventObjectObject ObjectDataAtEvent { get; set; }
        /// <summary>
        ...
        public static BunqResponse<EventApiObject> Get(long eventId, IDictionary<string, string> customHeaders = null)
        {
            ...
            var responseRaw = apiClient.Get(string.Format(ENDPOINT_URL_READ, DetermineUserId(), eventId), new Dictionary<string, string>(), customHeaders);
    
            return FromJson<EventApiObject>(responseRaw, OBJECT_TYPE_GET);
        }
        ...
        /// </summary>
        public static BunqResponse<List<EventApiObject>> List( IDictionary<string, string> urlParams = null, IDictionary<string, string> customHeaders = null)
        {
            ...
            return FromJsonList<EventApiObject>(responseRaw, OBJECT_TYPE_GET);
        }
        ...
        /// <summary>
        /// </summary>
        public static EventApiObject CreateFromJsonString(string json)
        {
            return BunqModel.CreateFromJsonString<EventApiObject>(json);
        }
    }
}
