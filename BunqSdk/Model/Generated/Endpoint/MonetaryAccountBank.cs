...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    {FIELD_SETTING, setting},
        ...
        /// </summary>
        public static BunqResponse<MonetaryAccountBank> Get(int monetaryAccountBankId, IDictionary<string, string> customHeaders = null)
        {
            if (customHeaders == null) customHeaders = new Dictionary<string, string>();
        ...
        /// <param name="notificationFilters">The types of notifications that will result in a push notification or URL callback for this MonetaryAccountBank.</param>
        /// <param name="setting">The settings of the MonetaryAccountBank.</param>
        public static BunqResponse<int> Update(int monetaryAccountBankId, string description = null, Amount dailyLimit = null, string avatarUuid = null, string status = null, string subStatus = null, string reason = null, string reasonDescription = null, List<NotificationFilter> notificationFilters = null, MonetaryAccountSetting setting = null, IDictionary<string, string> customHeaders = null)
        {
            if (customHeaders == null) customHeaders = new Dictionary<string, string>();
    ...
    {FIELD_SETTING, setting},
        ...
        /// </summary>
        public static BunqResponse<List<MonetaryAccountBank>> List( IDictionary<string, string> urlParams = null, IDictionary<string, string> customHeaders = null)
        {
