...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    public class NoteAttachmentRequestResponse : BunqModel
    {
        ...
        protected const string ENDPOINT_URL_CREATE =
            "user/{0}/monetary-account/{1}/request-response/{2}/note-attachment";

        protected const string ENDPOINT_URL_UPDATE =
            "user/{0}/monetary-account/{1}/request-response/{2}/note-attachment/{3}";
        ...
        public static BunqResponse<int> Create(int requestResponseId, int? attachmentId, int? monetaryAccountId = null,
        ...
        /// </summary>
        /// <param name="description">Optional description of the attachment.</param>
        public static BunqResponse<int> Update(int requestResponseId, int noteAttachmentRequestResponseId,
            ...
            var responseRaw =
                apiClient.Put(
                    string.Format(ENDPOINT_URL_UPDATE, DetermineUserId(), DetermineMonetaryAccountId(monetaryAccountId),
                        requestResponseId, noteAttachmentRequestResponseId), requestBytes, customHeaders);
        ...
        /// <summary>
        /// </summary>
        public static BunqResponse<object> Delete(int requestResponseId, int noteAttachmentRequestResponseId,
            ...
            var responseRaw =
                apiClient.Delete(
                    string.Format(ENDPOINT_URL_DELETE, DetermineUserId(), DetermineMonetaryAccountId(monetaryAccountId),
                        requestResponseId, noteAttachmentRequestResponseId), customHeaders);
        ...
        /// </summary>
        public static BunqResponse<List<NoteAttachmentRequestResponse>> List(int requestResponseId,
        ...
        /// <summary>
        /// </summary>
        public static BunqResponse<NoteAttachmentRequestResponse> Get(int requestResponseId,
            int noteAttachmentRequestResponseId, int? monetaryAccountId = null,
            IDictionary<string, string> customHeaders = null)
        {
            if (customHeaders == null) customHeaders = new Dictionary<string, string>();
            ...
            var responseRaw =
                apiClient.Get(
                    string.Format(ENDPOINT_URL_READ, DetermineUserId(), DetermineMonetaryAccountId(monetaryAccountId),
                        requestResponseId, noteAttachmentRequestResponseId), new Dictionary<string, string>(),
                    customHeaders);
