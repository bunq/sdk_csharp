...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    public class RequestInquiryBatch : BunqModel
    {
        ...
        public static BunqResponse<int> Create(List<RequestInquiry> requestInquiries, Amount totalAmountInquired,
            int? monetaryAccountId = null, string status = null, int? eventId = null,
            ...
            var responseRaw =
                apiClient.Get(
                    string.Format(ENDPOINT_URL_READ, DetermineUserId(), DetermineMonetaryAccountId(monetaryAccountId),
                        requestInquiryBatchId), new Dictionary<string, string>(), customHeaders);
        ...
        {
            return CreateFromJsonString<RequestInquiryBatch>(json);
        }
    }
}