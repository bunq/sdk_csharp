...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    /// </summary>
    public class BunqMeFundraiserProfileUserApiObject : BunqModel
    {
        /// <summary>
        /// Endpoint constants.
        /// </summary>
        ...
        public AttachmentPublicObject Attachment { get; set; }
        ...
        public static BunqResponse<BunqMeFundraiserProfileUserApiObject> Get(long bunqMeFundraiserProfileUserId, IDictionary<string, string> customHeaders = null)
        {
            ...
            return FromJson<BunqMeFundraiserProfileUserApiObject>(responseRaw, OBJECT_TYPE_GET);
        }
    
        /// <summary>
        /// </summary>
        public static BunqResponse<List<BunqMeFundraiserProfileUserApiObject>> List( IDictionary<string, string> urlParams = null, IDictionary<string, string> customHeaders = null)
        {
            ...
            return FromJsonList<BunqMeFundraiserProfileUserApiObject>(responseRaw, OBJECT_TYPE_GET);
        }
        ...
        /// <summary>
        /// </summary>
        public static BunqMeFundraiserProfileUserApiObject CreateFromJsonString(string json)
        {
            return BunqModel.CreateFromJsonString<BunqMeFundraiserProfileUserApiObject>(json);
        }
    }
}
