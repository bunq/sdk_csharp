...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    /// </summary>
    public class NoteTextScheduleRequestBatchApiObject : BunqModel
    {
        /// <summary>
        /// Endpoint constants.
        /// </summary>
        ...
        public static BunqResponse<long> Create(long scheduleRequestInquiryBatchId, long? monetaryAccountId= null, string content = null, IDictionary<string, string> customHeaders = null)
        {
    ...
    {FIELD_CONTENT, content},
        ...
        /// </summary>
        /// <param name="content">The content of the note.</param>
        public static BunqResponse<long> Update(long scheduleRequestInquiryBatchId, long noteTextScheduleRequestBatchId, long? monetaryAccountId= null, string content = null, IDictionary<string, string> customHeaders = null)
        {
            if (customHeaders == null) customHeaders = new Dictionary<string, string>();
    ...
    {FIELD_CONTENT, content},
        ...
        /// <summary>
        /// </summary>
        public static BunqResponse<object> Delete(long scheduleRequestInquiryBatchId, long noteTextScheduleRequestBatchId, long? monetaryAccountId= null, IDictionary<string, string> customHeaders = null)
        {
            if (customHeaders == null) customHeaders = new Dictionary<string, string>();
        ...
        /// </summary>
        public static BunqResponse<List<NoteTextScheduleRequestBatchApiObject>> List(long scheduleRequestInquiryBatchId, long? monetaryAccountId= null, IDictionary<string, string> urlParams = null, IDictionary<string, string> customHeaders = null)
        {
            ...
            return FromJsonList<NoteTextScheduleRequestBatchApiObject>(responseRaw, OBJECT_TYPE_GET);
        }
    
        /// <summary>
        /// </summary>
        public static BunqResponse<NoteTextScheduleRequestBatchApiObject> Get(long scheduleRequestInquiryBatchId, long noteTextScheduleRequestBatchId, long? monetaryAccountId= null, IDictionary<string, string> customHeaders = null)
        {
            if (customHeaders == null) customHeaders = new Dictionary<string, string>();
            ...
            return FromJson<NoteTextScheduleRequestBatchApiObject>(responseRaw, OBJECT_TYPE_GET);
        }
        ...
        /// <summary>
        /// </summary>
        public static NoteTextScheduleRequestBatchApiObject CreateFromJsonString(string json)
        {
            return BunqModel.CreateFromJsonString<NoteTextScheduleRequestBatchApiObject>(json);
        }
    }
}
