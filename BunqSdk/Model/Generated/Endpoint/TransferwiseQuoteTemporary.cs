...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    {FIELD_AMOUNT_TARGET, amountTarget},
        ...
        /// <summary>
        /// </summary>
        public static BunqResponse<TransferwiseQuoteTemporary> Get(int transferwiseQuoteTemporaryId, IDictionary<string, string> customHeaders = null)
        {
            if (customHeaders == null) customHeaders = new Dictionary<string, string>();
        ...
        {
            return BunqModel.CreateFromJsonString<TransferwiseQuoteTemporary>(json);
        }
    }
}
