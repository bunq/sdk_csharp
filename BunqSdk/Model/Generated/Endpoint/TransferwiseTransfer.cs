...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    {FIELD_RECIPIENT_ID, recipientId},
        ...
        /// <summary>
        /// </summary>
        public static BunqResponse<TransferwiseTransfer> Get(int transferwiseQuoteId, int transferwiseTransferId, IDictionary<string, string> customHeaders = null)
        {
            if (customHeaders == null) customHeaders = new Dictionary<string, string>();
        ...
        /// <summary>
        /// </summary>
        public static BunqResponse<List<TransferwiseTransfer>> List(int transferwiseQuoteId, IDictionary<string, string> urlParams = null, IDictionary<string, string> customHeaders = null)
        {
