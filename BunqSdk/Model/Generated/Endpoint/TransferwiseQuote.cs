...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    public class TransferwiseQuote : BunqModel
    {
        ...
        /// <summary>
        /// </summary>
        public static BunqResponse<TransferwiseQuote> Get(int transferwiseQuoteId,
            IDictionary<string, string> customHeaders = null)
        {
            if (customHeaders == null) customHeaders = new Dictionary<string, string>();

            var apiClient = new ApiClient(GetApiContext());
            var responseRaw = apiClient.Get(string.Format(ENDPOINT_URL_READ, DetermineUserId(), transferwiseQuoteId),
        ...
        {
            return CreateFromJsonString<TransferwiseQuote>(json);
        }
    }
}