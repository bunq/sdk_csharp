...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    /// </summary>
    public class AttachmentUserContentApiObject : BunqModel
    {
        /// <summary>
        /// Endpoint constants.
        /// </summary>
        ...
        public static BunqResponse<byte[]> List(long attachmentId, IDictionary<string, string> customHeaders = null)
        {
            ...
            var responseRaw = apiClient.Get(string.Format(ENDPOINT_URL_LISTING, DetermineUserId(), attachmentId), new Dictionary<string, string>(), customHeaders);
        ...
        /// <summary>
        /// </summary>
        public static AttachmentUserContentApiObject CreateFromJsonString(string json)
        {
            return BunqModel.CreateFromJsonString<AttachmentUserContentApiObject>(json);
        }
    }
}
