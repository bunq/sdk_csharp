...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    public class PaymentServiceProviderDraftPayment : BunqModel
    {
        ...
        public static BunqResponse<int> Create(string senderIban, string counterpartyIban, string counterpartyName, string description, Amount amount, string senderName = null, string status = null, IDictionary<string, string> customHeaders = null)
        {
    ...
    {FIELD_STATUS, status},
        ...
        /// <summary>
        /// </summary>
        public static BunqResponse<List<PaymentServiceProviderDraftPayment>> List( IDictionary<string, string> urlParams = null, IDictionary<string, string> customHeaders = null)
        {
        ...
        /// <summary>
        /// </summary>
        public static BunqResponse<PaymentServiceProviderDraftPayment> Get(int paymentServiceProviderDraftPaymentId, IDictionary<string, string> customHeaders = null)
        {
            if (customHeaders == null) customHeaders = new Dictionary<string, string>();
