...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    public class NoteTextMasterCardAction : BunqModel
    {
        ...
        protected const string ENDPOINT_URL_UPDATE =
            "user/{0}/monetary-account/{1}/mastercard-action/{2}/note-text/{3}";
        ...
        public static BunqResponse<int> Create(int mastercardActionId, int? monetaryAccountId = null,
        ...
        /// </summary>
        /// <param name="content">The content of the note.</param>
        public static BunqResponse<int> Update(int mastercardActionId, int noteTextMasterCardActionId,
            ...
            var responseRaw =
                apiClient.Put(
                    string.Format(ENDPOINT_URL_UPDATE, DetermineUserId(), DetermineMonetaryAccountId(monetaryAccountId),
                        mastercardActionId, noteTextMasterCardActionId), requestBytes, customHeaders);
        ...
        /// <summary>
        /// </summary>
        public static BunqResponse<object> Delete(int mastercardActionId, int noteTextMasterCardActionId,
            ...
            var responseRaw =
                apiClient.Delete(
                    string.Format(ENDPOINT_URL_DELETE, DetermineUserId(), DetermineMonetaryAccountId(monetaryAccountId),
                        mastercardActionId, noteTextMasterCardActionId), customHeaders);
        ...
        /// </summary>
        public static BunqResponse<List<NoteTextMasterCardAction>> List(int mastercardActionId,
        ...
        /// <summary>
        /// </summary>
        public static BunqResponse<NoteTextMasterCardAction> Get(int mastercardActionId, int noteTextMasterCardActionId,
            int? monetaryAccountId = null, IDictionary<string, string> customHeaders = null)
        {
            if (customHeaders == null) customHeaders = new Dictionary<string, string>();
            ...
            var responseRaw =
                apiClient.Get(
                    string.Format(ENDPOINT_URL_READ, DetermineUserId(), DetermineMonetaryAccountId(monetaryAccountId),
                        mastercardActionId, noteTextMasterCardActionId), new Dictionary<string, string>(),
                    customHeaders);
        ...
        {
            return CreateFromJsonString<NoteTextMasterCardAction>(json);
        }
    }
}