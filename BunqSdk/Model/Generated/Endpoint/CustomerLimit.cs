...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    public class CustomerLimit : BunqModel
    {
        ...
        {
            if (LimitMonetaryAccount != null) return false;

            if (LimitMonetaryAccountRemaining != null) return false;

            if (LimitCardDebitMaestro != null) return false;

            if (LimitCardDebitMastercard != null) return false;

            if (LimitCardDebitWildcard != null) return false;

            if (LimitCardWildcard != null) return false;

            if (LimitCardReplacement != null) return false;

            if (LimitAmountMonthly != null) return false;

            if (SpentAmountMonthly != null) return false;
        ...
        {
            return CreateFromJsonString<CustomerLimit>(json);
        }
    }
}