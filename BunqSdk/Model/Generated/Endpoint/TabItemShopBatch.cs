...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    public class TabItemShopBatch : BunqModel
    {
        ...
        /// Endpoint constants.
        /// </summary>
        protected const string ENDPOINT_URL_CREATE = "user/{0}/monetary-account/{1}/cash-register/{2}/tab/{3}/tab-item-batch";
        ...
        public static BunqResponse<int> Create(int cashRegisterId, string tabUuid, List<TabItemShop> tabItems, int? monetaryAccountId= null, IDictionary<string, string> customHeaders = null)
        {
