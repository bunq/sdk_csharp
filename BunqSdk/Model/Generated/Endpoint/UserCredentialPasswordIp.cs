...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    public class UserCredentialPasswordIp : BunqModel
    {
        ...
        /// <summary>
        /// </summary>
        public static BunqResponse<UserCredentialPasswordIp> Get(int userCredentialPasswordIpId, IDictionary<string, string> customHeaders = null)
        {
        ...
        /// <summary>
        /// </summary>
        public static BunqResponse<List<UserCredentialPasswordIp>> List( IDictionary<string, string> urlParams = null, IDictionary<string, string> customHeaders = null)
        {
