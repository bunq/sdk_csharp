...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    public class NoteAttachmentSofortMerchantTransaction : BunqModel
    {
        ...
        protected const string ENDPOINT_URL_CREATE =
            "user/{0}/monetary-account/{1}/sofort-merchant-transaction/{2}/note-attachment";

        protected const string ENDPOINT_URL_UPDATE =
            "user/{0}/monetary-account/{1}/sofort-merchant-transaction/{2}/note-attachment/{3}";
        ...
        public static BunqResponse<int> Create(int sofortMerchantTransactionId, int? attachmentId,
        ...
        /// </summary>
        /// <param name="description">Optional description of the attachment.</param>
        public static BunqResponse<int> Update(int sofortMerchantTransactionId,
            int noteAttachmentSofortMerchantTransactionId, int? monetaryAccountId = null, string description = null,
            ...
            var responseRaw =
                apiClient.Put(
                    string.Format(ENDPOINT_URL_UPDATE, DetermineUserId(), DetermineMonetaryAccountId(monetaryAccountId),
                        sofortMerchantTransactionId, noteAttachmentSofortMerchantTransactionId), requestBytes,
                    customHeaders);
        ...
        public static BunqResponse<object> Delete(int sofortMerchantTransactionId,
            int noteAttachmentSofortMerchantTransactionId, int? monetaryAccountId = null,
            IDictionary<string, string> customHeaders = null)
        {
            if (customHeaders == null) customHeaders = new Dictionary<string, string>();
            ...
            var responseRaw =
                apiClient.Delete(
                    string.Format(ENDPOINT_URL_DELETE, DetermineUserId(), DetermineMonetaryAccountId(monetaryAccountId),
                        sofortMerchantTransactionId, noteAttachmentSofortMerchantTransactionId), customHeaders);
        ...
        /// </summary>
        public static BunqResponse<List<NoteAttachmentSofortMerchantTransaction>> List(int sofortMerchantTransactionId,
        ...
        /// <summary>
        /// </summary>
        public static BunqResponse<NoteAttachmentSofortMerchantTransaction> Get(int sofortMerchantTransactionId,
            int noteAttachmentSofortMerchantTransactionId, int? monetaryAccountId = null,
            IDictionary<string, string> customHeaders = null)
        {
            if (customHeaders == null) customHeaders = new Dictionary<string, string>();
            ...
            var responseRaw = apiClient.Get(
                string.Format(ENDPOINT_URL_READ, DetermineUserId(), DetermineMonetaryAccountId(monetaryAccountId),
                    sofortMerchantTransactionId, noteAttachmentSofortMerchantTransactionId),
