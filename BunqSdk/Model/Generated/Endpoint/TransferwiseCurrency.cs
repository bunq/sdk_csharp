...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    public class TransferwiseCurrency : BunqModel
    {
        ...
        /// <summary>
        /// </summary>
        public static BunqResponse<List<TransferwiseCurrency>> List(IDictionary<string, string> urlParams = null,
        ...
        {
            return CreateFromJsonString<TransferwiseCurrency>(json);
        }
    }
}