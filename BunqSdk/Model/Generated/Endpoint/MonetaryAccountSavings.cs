...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    public class MonetaryAccountSavings : BunqModel
    {
        ...
        public static BunqResponse<int> Create(string currency, string description = null, Amount dailyLimit = null, string avatarUuid = null, string status = null, string subStatus = null, string reason = null, string reasonDescription = null, List<CoOwner> allCoOwner = null, List<NotificationFilter> notificationFilters = null, MonetaryAccountSetting setting = null, Amount savingsGoal = null, IDictionary<string, string> customHeaders = null)
        {
    ...
    {FIELD_SAVINGS_GOAL, savingsGoal},
        ...
        /// </summary>
        public static BunqResponse<MonetaryAccountSavings> Get(int monetaryAccountSavingsId, IDictionary<string, string> customHeaders = null)
        {
            if (customHeaders == null) customHeaders = new Dictionary<string, string>();
        ...
        /// <param name="setting">The settings of the MonetaryAccountSavings.</param>
        /// <param name="savingsGoal">The Savings Goal set for this MonetaryAccountSavings.</param>
        public static BunqResponse<int> Update(int monetaryAccountSavingsId, string description = null, Amount dailyLimit = null, string avatarUuid = null, string status = null, string subStatus = null, string reason = null, string reasonDescription = null, List<NotificationFilter> notificationFilters = null, MonetaryAccountSetting setting = null, Amount savingsGoal = null, IDictionary<string, string> customHeaders = null)
        {
            if (customHeaders == null) customHeaders = new Dictionary<string, string>();
    ...
    {FIELD_SAVINGS_GOAL, savingsGoal},
        ...
        /// </summary>
        public static BunqResponse<List<MonetaryAccountSavings>> List( IDictionary<string, string> urlParams = null, IDictionary<string, string> customHeaders = null)
        {
