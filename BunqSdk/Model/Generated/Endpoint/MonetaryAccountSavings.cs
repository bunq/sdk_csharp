...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    public class MonetaryAccountSavings : BunqModel
    {
        ...
        /// <param name="status">
        ///     The status of the MonetaryAccountSavings. Ignored in POST requests (always set to ACTIVE) can be
        ///     CANCELLED or PENDING_REOPEN in PUT requests to cancel (close) or reopen the MonetaryAccountSavings. When updating
        ///     the status and/or sub_status no other fields can be updated in the same request (and vice versa).
        /// </param>
        ...
        ///     MonetaryAccountSavings. Can be any user provided message. Should only be specified if updating the status to
        ///     CANCELLED.
        /// </param>
        ...
        public override bool IsAllFieldNull()
        {
            ...
            if (AllCoOwner != null) return false;
            ...
            if (SavingsGoal != null) return false;

            if (SavingsGoalProgress != null) return false;
        ...
        {
            return CreateFromJsonString<MonetaryAccountSavings>(json);
        }
    }
}