...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    public class CashRegisterQrCode : BunqModel
    {
        ...
        public static BunqResponse<int> Create(int cashRegisterId, string status, int? monetaryAccountId= null, IDictionary<string, string> customHeaders = null)
        {
    ...
    {FIELD_STATUS, status},
        ...
        /// </summary>
        /// <param name="status">The status of the QR code. ACTIVE or INACTIVE. Only one QR code can be ACTIVE for a CashRegister at any time. Setting a QR code to ACTIVE will deactivate any other CashRegister QR codes.</param>
        public static BunqResponse<int> Update(int cashRegisterId, int cashRegisterQrCodeId, int? monetaryAccountId= null, string status = null, IDictionary<string, string> customHeaders = null)
        {
            if (customHeaders == null) customHeaders = new Dictionary<string, string>();
    ...
    {FIELD_STATUS, status},
            ...
            var requestBytes = Encoding.UTF8.GetBytes(BunqJsonConvert.SerializeObject(requestMap));
            var responseRaw = apiClient.Put(string.Format(ENDPOINT_URL_UPDATE, DetermineUserId(), DetermineMonetaryAccountId(monetaryAccountId), cashRegisterId, cashRegisterQrCodeId), requestBytes, customHeaders);
        ...
        /// </summary>
        public static BunqResponse<CashRegisterQrCode> Get(int cashRegisterId, int cashRegisterQrCodeId, int? monetaryAccountId= null, IDictionary<string, string> customHeaders = null)
        {
            if (customHeaders == null) customHeaders = new Dictionary<string, string>();
    
            var apiClient = new ApiClient(GetApiContext());
            var responseRaw = apiClient.Get(string.Format(ENDPOINT_URL_READ, DetermineUserId(), DetermineMonetaryAccountId(monetaryAccountId), cashRegisterId, cashRegisterQrCodeId), new Dictionary<string, string>(), customHeaders);
        ...
        /// </summary>
        public static BunqResponse<List<CashRegisterQrCode>> List(int cashRegisterId, int? monetaryAccountId= null, IDictionary<string, string> urlParams = null, IDictionary<string, string> customHeaders = null)
        {
