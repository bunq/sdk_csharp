...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    /// </summary>
    public class NotificationFilterUrlApiObject : BunqModel
    {
        /// <summary>
        /// Endpoint constants.
        /// </summary>
        ...
        public List<NotificationFilterUrlObject> NotificationFilters { get; set; }
    ...
    {FIELD_NOTIFICATION_FILTERS, notificationFilters},
        ...
        /// <summary>
        /// </summary>
        public static BunqResponse<List<NotificationFilterUrlApiObject>> List( IDictionary<string, string> urlParams = null, IDictionary<string, string> customHeaders = null)
        {
            ...
            return FromJsonList<NotificationFilterUrlApiObject>(responseRaw, OBJECT_TYPE_GET);
        }
        ...
        /// <summary>
        /// </summary>
        public static NotificationFilterUrlApiObject CreateFromJsonString(string json)
        {
            return BunqModel.CreateFromJsonString<NotificationFilterUrlApiObject>(json);
        }
    }
}
