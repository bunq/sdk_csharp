...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    /// </summary>
    public class ServerErrorApiObject : BunqModel
    {
        /// <summary>
        /// Endpoint constants.
        /// </summary>
            ...
            var requestMap = new Dictionary<string, object>
    {
        ...
        /// <summary>
        /// </summary>
        public static ServerErrorApiObject CreateFromJsonString(string json)
        {
            return BunqModel.CreateFromJsonString<ServerErrorApiObject>(json);
        }
    }
}
