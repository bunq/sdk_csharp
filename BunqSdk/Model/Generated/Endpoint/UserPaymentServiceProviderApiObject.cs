...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    /// </summary>
    public class UserPaymentServiceProviderApiObject : BunqModel
    {
        /// <summary>
        /// Endpoint constants.
        /// </summary>
        ...
        public static BunqResponse<UserPaymentServiceProviderApiObject> Get(long userPaymentServiceProviderId, IDictionary<string, string> customHeaders = null)
        {
            ...
            var responseRaw = apiClient.Get(string.Format(ENDPOINT_URL_READ, userPaymentServiceProviderId), new Dictionary<string, string>(), customHeaders);
    
            return FromJson<UserPaymentServiceProviderApiObject>(responseRaw, OBJECT_TYPE_GET);
        }
        ...
        /// <summary>
        /// </summary>
        public static UserPaymentServiceProviderApiObject CreateFromJsonString(string json)
        {
            return BunqModel.CreateFromJsonString<UserPaymentServiceProviderApiObject>(json);
        }
    }
}
