...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    /// </summary>
    public class RequestResponseApiObject : BunqModel
    {
        /// <summary>
        /// Endpoint constants.
        /// </summary>
        ...
        public List<AttachmentObject> Attachment { get; set; }
        /// <summary>
    ...
    {FIELD_CURRENCY_CONVERSION_QUOTE_ID, currencyConversionQuoteId},
            ...
            return FromJson<RequestResponseApiObject>(responseRaw, OBJECT_TYPE_PUT);
        }
        ...
        public static BunqResponse<List<RequestResponseApiObject>> List(long? monetaryAccountId= null, IDictionary<string, string> urlParams = null, IDictionary<string, string> customHeaders = null)
        {
            ...
            return FromJsonList<RequestResponseApiObject>(responseRaw, OBJECT_TYPE_GET);
        }
        ...
        public static BunqResponse<RequestResponseApiObject> Get(long requestResponseId, long? monetaryAccountId= null, IDictionary<string, string> customHeaders = null)
        {
            ...
            return FromJson<RequestResponseApiObject>(responseRaw, OBJECT_TYPE_GET);
        }
        ...
        /// <summary>
        /// </summary>
        public static RequestResponseApiObject CreateFromJsonString(string json)
        {
            return BunqModel.CreateFromJsonString<RequestResponseApiObject>(json);
        }
    }
}
