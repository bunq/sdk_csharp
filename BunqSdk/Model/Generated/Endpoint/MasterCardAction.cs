...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    public class MasterCardAction : BunqModel
    {
        ...
        public override bool IsAllFieldNull()
        {
            ...
            if (AmountLocal != null) return false;

            if (AmountConverted != null) return false;

            if (AmountBilling != null) return false;

            if (AmountOriginalLocal != null) return false;

            if (AmountOriginalBilling != null) return false;

            if (AmountFee != null) return false;

            if (CardAuthorisationIdResponse != null) return false;

            if (Decision != null) return false;

            if (PaymentStatus != null) return false;

            if (DecisionDescription != null) return false;

            if (DecisionDescriptionTranslated != null) return false;

            if (Description != null) return false;

            if (AuthorisationStatus != null) return false;

            if (AuthorisationType != null) return false;

            if (PanEntryModeUser != null) return false;

            if (SettlementStatus != null) return false;

            if (ClearingStatus != null) return false;
            ...
            if (LabelCard != null) return false;

            if (TokenStatus != null) return false;

            if (ReservationExpiryTime != null) return false;

            if (ClearingExpiryTime != null) return false;

            if (AppliedLimit != null) return false;

            if (SecureCodeId != null) return false;

            if (WalletProviderId != null) return false;
        ...
        {
            return CreateFromJsonString<MasterCardAction>(json);
        }
    }
}