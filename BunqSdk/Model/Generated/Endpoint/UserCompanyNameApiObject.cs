...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    /// </summary>
    public class UserCompanyNameApiObject : BunqModel
    {
        /// <summary>
        /// Endpoint constants.
        /// </summary>
        ...
        public static BunqResponse<List<UserCompanyNameApiObject>> List(long userCompanyId, IDictionary<string, string> urlParams = null, IDictionary<string, string> customHeaders = null)
        {
            ...
            return FromJsonList<UserCompanyNameApiObject>(responseRaw, OBJECT_TYPE_GET);
        }
        ...
        /// <summary>
        /// </summary>
        public static UserCompanyNameApiObject CreateFromJsonString(string json)
        {
            return BunqModel.CreateFromJsonString<UserCompanyNameApiObject>(json);
        }
    }
}
