...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    public class Tab : BunqModel, IAnchorObjectInterface
    {
        ...
        /// </summary>
        public static BunqResponse<Tab> Get(int cashRegisterId, string tabUuid, int? monetaryAccountId= null, IDictionary<string, string> customHeaders = null)
        {
            if (customHeaders == null) customHeaders = new Dictionary<string, string>();
    
            var apiClient = new ApiClient(GetApiContext());
            var responseRaw = apiClient.Get(string.Format(ENDPOINT_URL_READ, DetermineUserId(), DetermineMonetaryAccountId(monetaryAccountId), cashRegisterId, tabUuid), new Dictionary<string, string>(), customHeaders);
        ...
        /// </summary>
        public static BunqResponse<List<Tab>> List(int cashRegisterId, int? monetaryAccountId= null, IDictionary<string, string> urlParams = null, IDictionary<string, string> customHeaders = null)
        {
