...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    /// </summary>
    public class PaymentAutoAllocateApiObject : BunqModel
    {
        /// <summary>
        /// Endpoint constants.
        /// </summary>
        ...
        public List<PaymentAutoAllocateDefinitionApiObject> Definition { get; set; }
        /// <summary>
        ...
        public AmountObject TriggerAmount { get; set; }
        /// <summary>
    ...
    {FIELD_DEFINITION, definition},
        ...
        public static BunqResponse<PaymentAutoAllocateApiObject> Get(long paymentAutoAllocateId, long? monetaryAccountId= null, IDictionary<string, string> customHeaders = null)
        {
            ...
            return FromJson<PaymentAutoAllocateApiObject>(responseRaw, OBJECT_TYPE_GET);
        }
        ...
        public static BunqResponse<List<PaymentAutoAllocateApiObject>> List(long? monetaryAccountId= null, IDictionary<string, string> urlParams = null, IDictionary<string, string> customHeaders = null)
        {
            ...
            return FromJsonList<PaymentAutoAllocateApiObject>(responseRaw, OBJECT_TYPE_GET);
        }
    ...
    {FIELD_DEFINITION, definition},
        ...
        /// <summary>
        /// </summary>
        public static PaymentAutoAllocateApiObject CreateFromJsonString(string json)
        {
            return BunqModel.CreateFromJsonString<PaymentAutoAllocateApiObject>(json);
        }
    }
}
