...
namespace Bunq.Sdk.Model.Generated.Endpoint
{
    ...
    public class AttachmentUser : BunqModel
    {
        ...
        /// </summary>
        public static BunqResponse<AttachmentUser> Get(int attachmentUserId, IDictionary<string, string> customHeaders = null)
        {
        ...
        {
            return BunqModel.CreateFromJsonString<AttachmentUser>(json);
        }
    }
}
