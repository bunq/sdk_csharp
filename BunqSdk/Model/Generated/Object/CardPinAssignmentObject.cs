...
namespace Bunq.Sdk.Model.Generated.Object
{
    /// <summary>
    /// </summary>
    public class CardPinAssignmentObject : BunqModel
    {
        /// <summary>
        ...
        public CardPinAssignmentObject(string type)
        {
            Type = type;
        }
        ...
        /// <summary>
        /// </summary>
        public static CardPinAssignmentObject CreateFromJsonString(string json)
        {
            return BunqModel.CreateFromJsonString<CardPinAssignmentObject>(json);
        }
    }
}
