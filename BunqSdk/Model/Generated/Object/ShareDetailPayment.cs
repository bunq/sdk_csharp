...
namespace Bunq.Sdk.Model.Generated.Object
{
    ...
    public class ShareDetailPayment : BunqModel
    {
        ...
        {
            if (MakePayments != null) return false;

            if (MakeDraftPayments != null) return false;
        ...
        /// <summary>
        /// </summary>
        public static ShareDetailPayment CreateFromJsonString(string json)
        {
            return CreateFromJsonString<ShareDetailPayment>(json);
        }
    }
}