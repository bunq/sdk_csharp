...
namespace Bunq.Sdk.Model.Generated.Object
{
    /// <summary>
    /// </summary>
    public class RegistryMembershipSettingObject : BunqModel
    {
        /// <summary>
        ...
        public List<LabelCardObject> CardLabels { get; set; }
        ...
        /// <summary>
        /// </summary>
        public static RegistryMembershipSettingObject CreateFromJsonString(string json)
        {
            return BunqModel.CreateFromJsonString<RegistryMembershipSettingObject>(json);
        }
    }
}
