...
namespace Bunq.Sdk.Model.Generated.Object
{
    ...
    public class LabelMonetaryAccount : BunqModel
    {
        ...
        public override bool IsAllFieldNull()
        {
            ...
            if (BunqMe != null) return false;

            if (IsLight != null) return false;

            if (SwiftBic != null) return false;

            if (SwiftAccountNumber != null) return false;

            if (TransferwiseAccountNumber != null) return false;

            if (TransferwiseBankCode != null) return false;

            if (MerchantCategoryCode != null) return false;
        ...
        {
            return CreateFromJsonString<LabelMonetaryAccount>(json);
        }
    }
}